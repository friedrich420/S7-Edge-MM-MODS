...
.field public static final SettingsTile:[I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->AppBarLayout:[I

    new-array v0, v3, [I

    fill-array-data v0, :array_5

    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->AppBarLayout_LayoutParams:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->BatteryHistoryChart:[I

    new-array v0, v6, [I

    fill-array-data v0, :array_8

    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->ChartGridView:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->ChartNetworkSeriesView:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->ChartSweepView:[I

    new-array v0, v3, [I

    fill-array-data v0, :array_b

    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->ChartView:[I

    new-array v0, v3, [I

    fill-array-data v0, :array_c

    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->CollapsingAppBarLayout_LayoutParams:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->CollapsingToolbarLayout:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->CoordinatorLayout_LayoutParams:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->DropDownPreference:[I

    new-array v0, v3, [I

    fill-array-data v0, :array_13

    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->FingerprintEffectView:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->FloatingActionButton:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->IconPreferenceScreen:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->NavigationView:[I

    new-array v0, v3, [I

    fill-array-data v0, :array_1c

    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->PercentageBarChart:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->ProfileDefaultRingtonePreference:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->ScrimInsetsFrameLayout:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->ScrollingViewBehavior_Params:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->SettingsTile:[I
    ...
    sput-object v0, Landroid/support/v7/appcompat/R$styleable;->SetupWizardIllustration:[I
