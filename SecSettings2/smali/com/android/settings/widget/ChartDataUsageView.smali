...
.field private mSavedDetailSeries:Lcom/android/settings/widget/ChartNetworkSeriesView;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Lcom/android/settings/widget/ChartDataUsageView;->mIsSupportDataCompression:Z

    .line 73
    iput-boolean v0, p0, Lcom/android/settings/widget/ChartDataUsageView;->mIsNeedShowSavedDetail:Z

    .line 436
    new-instance v1, Lcom/android/settings/widget/ChartDataUsageView$4;

    invoke-direct {v1, p0}, Lcom/android/settings/widget/ChartDataUsageView$4;-><init>(Lcom/android/settings/widget/ChartDataUsageView;)V

    iput-object v1, p0, Lcom/android/settings/widget/ChartDataUsageView;->mHorizListener:Lcom/android/settings/widget/ChartSweepView$OnSweepListener;

    .line 454
    new-instance v1, Lcom/android/settings/widget/ChartDataUsageView$5;

    invoke-direct {v1, p0}, Lcom/android/settings/widget/ChartDataUsageView$5;-><init>(Lcom/android/settings/widget/ChartDataUsageView;)V

    iput-object v1, p0, Lcom/android/settings/widget/ChartDataUsageView;->mVertListener:Lcom/android/settings/widget/ChartSweepView$OnSweepListener;

    .line 119
    iput-object p1, p0, Lcom/android/settings/widget/ChartDataUsageView;->mContext:Landroid/content/Context;

    .line 120
    iget-boolean v1, p0, Lcom/android/settings/widget/ChartDataUsageView;->mIsSupportDataCompression:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/widget/ChartDataUsageView;->mContext:Landroid/content/Context;
...
.method private updateVertAxisBounds(Lcom/android/settings/widget/ChartSweepView;)V
    ...
    iget-boolean v0, v0, Lcom/android/settings/widget/ChartDataUsageView;->mIsNeedShowSavedDetail:Z
    ...
    iget-object v0, v0, Lcom/android/settings/widget/ChartDataUsageView;->mSavedDetailSeries:Lcom/android/settings/widget/ChartNetworkSeriesView;
...
.method public bindNetworkPolicy(Landroid/net/NetworkPolicy;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/widget/ChartSweepView;->setVisibility(I)V

    .line 300
    iget-object v0, p0, Lcom/android/settings/widget/ChartDataUsageView;->mSweepLimit:Lcom/android/settings/widget/ChartSweepView;

    invoke-virtual {v0, v6, v7}, Lcom/android/settings/widget/ChartSweepView;->setValue(J)V
    ...
    invoke-virtual {v0, v8}, Lcom/android/settings/widget/ChartGridView;->setFocus(Z)V

    .line 304
    invoke-direct {p0, v5}, Lcom/android/settings/widget/ChartDataUsageView;->updateVertAxisBounds(Lcom/android/settings/widget/ChartSweepView;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/settings/widget/ChartGridView;->setFocus(Z)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/settings/widget/ChartSweepView;->setEnabled(Z)V
    ...
    invoke-virtual {v0, v5, v5}, Lcom/android/settings/widget/ChartSweepView;->setValidRangeDynamic(Lcom/android/settings/widget/ChartSweepView;Lcom/android/settings/widget/ChartSweepView;)V
...
.method public bindSavedDetailData(Landroid/net/NetworkStatsHistory;Lcom/android/settings/datasaving/DataSavingHelper;)V
    .locals 4
    .param p1, "stats"    # Landroid/net/NetworkStatsHistory;
    ...
    .prologue
    .line 288
    iget-object v0, p0, Lcom/android/settings/widget/ChartDataUsageView;->mSavedDetailSeries:Lcom/android/settings/widget/ChartNetworkSeriesView;

    invoke-virtual {v0, p1, p2}, Lcom/android/settings/widget/ChartNetworkSeriesView;->bindDataSavingHelper(Landroid/net/NetworkStatsHistory;Lcom/android/settings/datasaving/DataSavingHelper;)V
...
.method protected onFinishInflate()V
    ...
    invoke-virtual {v0, v5}, Lcom/android/settings/widget/ChartNetworkSeriesView;->setVisibility(I)V
    ...
    iput-object v0, p0, Lcom/android/settings/widget/ChartDataUsageView;->mSavedDetailSeries:Lcom/android/settings/widget/ChartNetworkSeriesView;
    ...
    new-instance v1, Lcom/android/settings/widget/ChartDataUsageView$3;

    invoke-direct {v1, p0}, Lcom/android/settings/widget/ChartDataUsageView$3;-><init>(Lcom/android/settings/widget/ChartDataUsageView;)V
    ...
    invoke-virtual {v0, v6, v1}, Lcom/android/settings/widget/ChartSweepView;->setValidRangeDynamic(Lcom/android/settings/widget/ChartSweepView;Lcom/android/settings/widget/ChartSweepView;)V
    ...
    .line 233
    iget-boolean v0, p0, Lcom/android/settings/widget/ChartDataUsageView;->mIsNeedShowSavedDetail:Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/widget/ChartNetworkSeriesView;->setVisibility(I)V
...
.method public setCurrentUid(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings/widget/ChartNetworkSeriesView;->setCurrentUid(I)V
...
.method public setIsAppDetailMode(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings/widget/ChartNetworkSeriesView;->setIsAppDetailMode(Z)V

    .line 281
    return-void
.end method

.method public setListView(Lcom/android/settings/widget/DataUsageListView;)V
    .locals 0
    .param p1, "listView"    # Lcom/android/settings/widget/DataUsageListView;

    .prologue
    .line 137
    iput-object p1, p0, Lcom/android/settings/widget/ChartDataUsageView;->mListView:Lcom/android/settings/widget/DataUsageListView;
...
.method public setVisibleRange(JJ)V
    ...
    iget-boolean v5, v0, Lcom/android/settings/widget/ChartDataUsageView;->mIsNeedShowSavedDetail:Z
    ...
    iget-object v5, v0, Lcom/android/settings/widget/ChartDataUsageView;->mSavedDetailSeries:Lcom/android/settings/widget/ChartNetworkSeriesView;
