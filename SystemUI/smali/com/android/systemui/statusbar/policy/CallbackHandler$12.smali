...
.method constructor <init>(Lcom/android/systemui/statusbar/policy/CallbackHandler;II)V
    ...
    iput p2, p0, Lcom/android/systemui/statusbar/policy/CallbackHandler$12;->val$rssiTypeIconId:I

    iput p3, p0, Lcom/android/systemui/statusbar/policy/CallbackHandler$12;->val$subId:I
...
.method public run()V
    ...
    iget v2, p0, Lcom/android/systemui/statusbar/policy/CallbackHandler$12;->val$rssiTypeIconId:I

    iget v3, p0, Lcom/android/systemui/statusbar/policy/CallbackHandler$12;->val$subId:I

    invoke-interface {v1, v2, v3}, Lcom/android/systemui/statusbar/policy/NetworkController$SignalCallback;->setRssiTypeIcon(II)V
