...
.method public inverse()Z
    ...
    .line 431
    iget-object v6, v3, mMat:[F

    mul-int/lit8 v7, v1, 0x4

    add-int/2addr v7, v2

    invoke-direct {p0, v1, v2}, computeCofactor(II)F
    ...
    .end local v2    # "j":I
    :cond_1f
    iget-object v6, p0, mMat:[F

    aget v6, v6, v4

    iget-object v7, v3, mMat:[F

    aget v7, v7, v4

    mul-float/2addr v6, v7

    iget-object v7, p0, mMat:[F

    aget v7, v7, v9

    iget-object v8, v3, mMat:[F
...
.method public loadMultiply(Landroid/renderscript/Matrix4f;Landroid/renderscript/Matrix4f;)V
    ...
    .line 235
    invoke-virtual {p1, v1, v10}, get(II)F
    ...
    .line 236
    invoke-virtual {p1, v1, v11}, get(II)F
    ...
    :cond_2e
    invoke-virtual {p0, v0, v8, v3}, set(IIF)V

    .line 239
    invoke-virtual {p0, v0, v9, v4}, set(IIF)V

    .line 240
    invoke-virtual {p0, v0, v10, v5}, set(IIF)V

    .line 241
    invoke-virtual {p0, v0, v11, v6}, set(IIF)V
...
.method public loadOrthoWindow(II)V
    ...
    invoke-virtual/range {v0 .. v6}, loadOrtho(FFFFFF)V
...
.method public loadPerspective(FFFF)V
    ...
    .line 315
    invoke-virtual/range {v0 .. v6}, loadFrustum(FFFFFF)V
...
.method public loadProjectionNormalized(II)V
    ...
    invoke-virtual {v10, v1, v3, v4, v5}, loadRotate(FFFF)V

    .line 340
    invoke-virtual {v0, v0, v10}, loadMultiply(Landroid/renderscript/Matrix4f;Landroid/renderscript/Matrix4f;)V
    ...
    invoke-virtual {v10, v1, v3, v4}, loadScale(FFF)V
    ...
    invoke-virtual {v10, v1, v3, v4}, loadTranslate(FFF)V

    .line 346
    invoke-virtual {v0, v0, v10}, loadMultiply(Landroid/renderscript/Matrix4f;Landroid/renderscript/Matrix4f;)V

    .line 348
    invoke-virtual {p0, v0}, load(Landroid/renderscript/Matrix4f;)V
    ...
    invoke-virtual/range {v3 .. v9}, loadFrustum(FFFFFF)V
...
.method public multiply(Landroid/renderscript/Matrix4f;)V
    ...
    invoke-virtual {v0, p0, p1}, loadMultiply(Landroid/renderscript/Matrix4f;Landroid/renderscript/Matrix4f;)V
...
.method public rotate(FFFF)V
    ...
    .line 373
    invoke-virtual {p0, v0}, multiply(Landroid/renderscript/Matrix4f;)V
...
.method public translate(FFF)V
    ...
    .line 400
    .local v0, "tmp":Landroid/renderscript/Matrix4f;
    invoke-virtual {v0, p1, p2, p3}, loadTranslate(FFF)V
