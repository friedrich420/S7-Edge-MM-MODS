...
.method static constructor <clinit>()V
    ...
    sput-object v0, ZERO:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, ONE:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, DST_COLOR:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, ONE_MINUS_DST_COLOR:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, SRC_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, ONE_MINUS_SRC_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, DST_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, ONE_MINUS_DST_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sput-object v0, SRC_ALPHA_SATURATE:Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    sget-object v1, ZERO:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v1, v0, v4

    sget-object v1, ONE:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v1, v0, v5

    sget-object v1, DST_COLOR:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v1, v0, v6

    sget-object v1, ONE_MINUS_DST_COLOR:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v1, v0, v7

    sget-object v1, SRC_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v1, v0, v8

    const/4 v1, 0x5

    sget-object v2, ONE_MINUS_SRC_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, DST_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, ONE_MINUS_DST_ALPHA:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v2, v0, v1

    const/16 v1, 0x8

    sget-object v2, SRC_ALPHA_SATURATE:Landroid/renderscript/ProgramStore$BlendSrcFunc;

    aput-object v2, v0, v1

    sput-object v0, $VALUES:[Landroid/renderscript/ProgramStore$BlendSrcFunc;
...
.method public static values()[Landroid/renderscript/ProgramStore$BlendSrcFunc;
    ...
    .prologue
    .line 94
    sget-object v0, $VALUES:[Landroid/renderscript/ProgramStore$BlendSrcFunc;
