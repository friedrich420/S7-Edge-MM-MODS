...
.method public constructor <init>(Landroid/renderscript/RenderScript;)V
    ...
    iput-object v0, p0, mLines:Ljava/util/ArrayList;
...
.method private findNode(Landroid/renderscript/Script$KernelID;)Landroid/renderscript/ScriptGroup$Node;
    ...
    .local v0, "ct":I
    :goto_1
    iget-object v3, p0, mNodes:Ljava/util/ArrayList;
...
.method private findNode(Landroid/renderscript/Script;)Landroid/renderscript/ScriptGroup$Node;
    ...
    .local v0, "ct":I
    :goto_1
    iget-object v1, p0, mNodes:Ljava/util/ArrayList;
...
.method private validateCycle(Landroid/renderscript/ScriptGroup$Node;Landroid/renderscript/ScriptGroup$Node;)V
    ...
    invoke-direct {p0, v3}, findNode(Landroid/renderscript/Script;)Landroid/renderscript/ScriptGroup$Node;
    ...
    .line 555
    :cond_2b
    invoke-direct {p0, v2, p2}, validateCycle(Landroid/renderscript/ScriptGroup$Node;Landroid/renderscript/ScriptGroup$Node;)V
...
.method private validateDAG()V
    ...
    .local v0, "ct":I
    :goto_1
    iget-object v4, p0, mNodes:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v4}, validateDAGRecurse(Landroid/renderscript/ScriptGroup$Node;I)V
...
.method private validateDAGRecurse(Landroid/renderscript/ScriptGroup$Node;I)V
    ...
    invoke-direct {p0, v3, p2}, mergeDAGs(II)V
    ...
    .line 586
    .local v2, "tn":Landroid/renderscript/ScriptGroup$Node;
    invoke-direct {p0, v2, p2}, validateDAGRecurse(Landroid/renderscript/ScriptGroup$Node;I)V
...
.method public addConnection(Landroid/renderscript/Type;Landroid/renderscript/Script$KernelID;Landroid/renderscript/Script$FieldID;)Landroid/renderscript/ScriptGroup$Builder;
    ...
    .prologue
    .line 680
    invoke-direct {p0, p2}, findNode(Landroid/renderscript/Script$KernelID;)Landroid/renderscript/ScriptGroup$Node;
    ...
    .line 691
    .local v0, "cl":Landroid/renderscript/ScriptGroup$ConnectLine;
    iget-object v3, p0, mLines:Ljava/util/ArrayList;
    ...
    .line 696
    invoke-direct {p0, v1, v1}, validateCycle(Landroid/renderscript/ScriptGroup$Node;Landroid/renderscript/ScriptGroup$Node;)V
...
.method public addConnection(Landroid/renderscript/Type;Landroid/renderscript/Script$KernelID;Landroid/renderscript/Script$KernelID;)Landroid/renderscript/ScriptGroup$Builder;
    ...
    .line 720
    :cond_e
    invoke-direct {p0, p3}, findNode(Landroid/renderscript/Script$KernelID;)Landroid/renderscript/ScriptGroup$Node;
...
.method public addKernel(Landroid/renderscript/Script$KernelID;)Landroid/renderscript/ScriptGroup$Builder;
    ...
    .prologue
    .line 644
    iget-object v1, p0, mLines:Ljava/util/ArrayList;
    ...
    .line 650
    :cond_10
    invoke-direct {p0, p1}, findNode(Landroid/renderscript/Script$KernelID;)Landroid/renderscript/ScriptGroup$Node;
    ...
    .line 654
    :cond_17
    iget v1, p0, mKernelCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, mKernelCount:I

    .line 655
    iget-object v1, p1, Landroid/renderscript/Script$KernelID;->mScript:Landroid/renderscript/Script;

    invoke-direct {p0, v1}, findNode(Landroid/renderscript/Script;)Landroid/renderscript/ScriptGroup$Node;
...
.method public create()Landroid/renderscript/ScriptGroup;
    ...
    iget-object v2, v0, mNodes:Ljava/util/ArrayList;
    ...
    .line 753
    :cond_32
    invoke-direct/range {p0 .. p0}, validateDAG()V
    ...
    iget-object v2, v0, mLines:Ljava/util/ArrayList;
