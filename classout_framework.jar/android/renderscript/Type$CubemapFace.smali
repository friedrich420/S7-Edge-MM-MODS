...
.method static constructor <clinit>()V
    ...
    sput-object v0, POSITIVE_X:Landroid/renderscript/Type$CubemapFace;
    ...
    sput-object v0, NEGATIVE_X:Landroid/renderscript/Type$CubemapFace;
    ...
    sput-object v0, POSITIVE_Y:Landroid/renderscript/Type$CubemapFace;
    ...
    sput-object v0, NEGATIVE_Y:Landroid/renderscript/Type$CubemapFace;
    ...
    sput-object v0, POSITIVE_Z:Landroid/renderscript/Type$CubemapFace;
    ...
    sput-object v0, NEGATIVE_Z:Landroid/renderscript/Type$CubemapFace;
    ...
    sput-object v0, POSITVE_X:Landroid/renderscript/Type$CubemapFace;
    ...
    invoke-direct {v0, v1, v2, v5}, <init>(Ljava/lang/String;II)V

    sput-object v0, POSITVE_Y:Landroid/renderscript/Type$CubemapFace;
    ...
    invoke-direct {v0, v1, v2, v6}, <init>(Ljava/lang/String;II)V

    sput-object v0, POSITVE_Z:Landroid/renderscript/Type$CubemapFace;
    ...
    sget-object v1, POSITIVE_X:Landroid/renderscript/Type$CubemapFace;

    aput-object v1, v0, v4

    sget-object v1, NEGATIVE_X:Landroid/renderscript/Type$CubemapFace;

    aput-object v1, v0, v7

    sget-object v1, POSITIVE_Y:Landroid/renderscript/Type$CubemapFace;

    aput-object v1, v0, v5

    sget-object v1, NEGATIVE_Y:Landroid/renderscript/Type$CubemapFace;

    aput-object v1, v0, v8

    sget-object v1, POSITIVE_Z:Landroid/renderscript/Type$CubemapFace;

    aput-object v1, v0, v6

    const/4 v1, 0x5

    sget-object v2, NEGATIVE_Z:Landroid/renderscript/Type$CubemapFace;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, POSITVE_X:Landroid/renderscript/Type$CubemapFace;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, POSITVE_Y:Landroid/renderscript/Type$CubemapFace;

    aput-object v2, v0, v1

    const/16 v1, 0x8

    sget-object v2, POSITVE_Z:Landroid/renderscript/Type$CubemapFace;

    aput-object v2, v0, v1

    sput-object v0, $VALUES:[Landroid/renderscript/Type$CubemapFace;
...
.method public static values()[Landroid/renderscript/Type$CubemapFace;
    ...
    .prologue
    .line 59
    sget-object v0, $VALUES:[Landroid/renderscript/Type$CubemapFace;
