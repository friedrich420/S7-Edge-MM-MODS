...
.method public constructor <init>(Landroid/speech/tts/TextToSpeech$Connection;Landroid/content/ComponentName;)V
    ...
    .line 2210
    iput-object p2, p0, mName:Landroid/content/ComponentName;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Integer;
    ...
    .prologue
    .line 2215
    iget-object v3, p0, this$1:Landroid/speech/tts/TextToSpeech$Connection;
    ...
    invoke-static {v3}, Landroid/speech/tts/TextToSpeech;->access$1400(Landroid/speech/tts/TextToSpeech;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Landroid/speech/tts/TextToSpeech$Connection;->access$1600(Landroid/speech/tts/TextToSpeech$Connection;)Landroid/speech/tts/ITextToSpeechService;

    move-result-object v3

    iget-object v5, p0, this$1:Landroid/speech/tts/TextToSpeech$Connection;

    invoke-virtual {v5}, Landroid/speech/tts/TextToSpeech$Connection;->getCallerIdentity()Landroid/os/IBinder;

    move-result-object v5

    iget-object v6, p0, this$1:Landroid/speech/tts/TextToSpeech$Connection;

    # getter for: Landroid/speech/tts/TextToSpeech$Connection;->mCallback:Landroid/speech/tts/ITextToSpeechCallback$Stub;
    invoke-static {v6}, Landroid/speech/tts/TextToSpeech$Connection;->access$1500(Landroid/speech/tts/TextToSpeech$Connection;)Landroid/speech/tts/ITextToSpeechCallback$Stub;
    ...
    invoke-static {v3}, Landroid/speech/tts/TextToSpeech;->access$1200(Landroid/speech/tts/TextToSpeech;)Landroid/os/Bundle;
    ...
    iget-object v6, p0, mName:Landroid/content/ComponentName;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, doInBackground([Ljava/lang/Void;)Ljava/lang/Integer;
...
.method protected onPostExecute(Ljava/lang/Integer;)V
    ...
    .prologue
    .line 2246
    iget-object v0, p0, this$1:Landroid/speech/tts/TextToSpeech$Connection;
    ...
    invoke-static {v0}, Landroid/speech/tts/TextToSpeech$Connection;->access$1700(Landroid/speech/tts/TextToSpeech$Connection;)Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;
    ...
    invoke-static {v0, v2}, Landroid/speech/tts/TextToSpeech$Connection;->access$1702(Landroid/speech/tts/TextToSpeech$Connection;Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;)Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;
    ...
    invoke-static {v0, v2}, Landroid/speech/tts/TextToSpeech$Connection;->access$1802(Landroid/speech/tts/TextToSpeech$Connection;Z)Z
    ...
    invoke-static {v0, v2}, Landroid/speech/tts/TextToSpeech;->access$1900(Landroid/speech/tts/TextToSpeech;I)V
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    .end local p1    # "x0":Ljava/lang/Object;
    invoke-virtual {p0, p1}, onPostExecute(Ljava/lang/Integer;)V
