...
.method private constructor <init>(Landroid/speech/tts/TextToSpeech;)V
    ...
    iput-object v0, p0, mCallback:Landroid/speech/tts/ITextToSpeechCallback$Stub;
...
.method synthetic constructor <init>(Landroid/speech/tts/TextToSpeech;Landroid/speech/tts/TextToSpeech$1;)V
    ...
    .prologue
    .line 2166
    invoke-direct {p0, p1}, <init>(Landroid/speech/tts/TextToSpeech;)V

    return-void
.end method

.method static synthetic access$1500(Landroid/speech/tts/TextToSpeech$Connection;)Landroid/speech/tts/ITextToSpeechCallback$Stub;
    .registers 2
    .param p0, "x0"    # Landroid/speech/tts/TextToSpeech$Connection;

    .prologue
    .line 2166
    iget-object v0, p0, mCallback:Landroid/speech/tts/ITextToSpeechCallback$Stub;

    return-object v0
.end method

.method static synthetic access$1600(Landroid/speech/tts/TextToSpeech$Connection;)Landroid/speech/tts/ITextToSpeechService;
    .registers 2
    .param p0, "x0"    # Landroid/speech/tts/TextToSpeech$Connection;

    .prologue
    .line 2166
    iget-object v0, p0, mService:Landroid/speech/tts/ITextToSpeechService;

    return-object v0
.end method

.method static synthetic access$1700(Landroid/speech/tts/TextToSpeech$Connection;)Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;
    .registers 2
    .param p0, "x0"    # Landroid/speech/tts/TextToSpeech$Connection;

    .prologue
    .line 2166
    iget-object v0, p0, mOnSetupConnectionAsyncTask:Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;

    return-object v0
.end method

.method static synthetic access$1702(Landroid/speech/tts/TextToSpeech$Connection;Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;)Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;
    .registers 2
    .param p0, "x0"    # Landroid/speech/tts/TextToSpeech$Connection;
    ...
    .prologue
    .line 2166
    iput-object p1, p0, mOnSetupConnectionAsyncTask:Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;

    return-object p1
.end method

.method static synthetic access$1802(Landroid/speech/tts/TextToSpeech$Connection;Z)Z
    .registers 2
    .param p0, "x0"    # Landroid/speech/tts/TextToSpeech$Connection;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 2166
    iput-boolean p1, p0, mEstablished:Z
...
.method private clearServiceConnection()Z
    ...
    .prologue
    .line 2286
    iget-object v1, p0, this$0:Landroid/speech/tts/TextToSpeech;

    # getter for: Landroid/speech/tts/TextToSpeech;->mStartLock:Ljava/lang/Object;
    invoke-static {v1}, Landroid/speech/tts/TextToSpeech;->access$1400(Landroid/speech/tts/TextToSpeech;)Ljava/lang/Object;
    ...
    .local v0, "result":Z
    :try_start_8
    iget-object v1, p0, mOnSetupConnectionAsyncTask:Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;
    ...
    iput-object v1, p0, mOnSetupConnectionAsyncTask:Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;

    .line 2293
    :cond_16
    const/4 v1, 0x0

    iput-object v1, p0, mService:Landroid/speech/tts/ITextToSpeechService;
...
.method public disconnect()V
    ...
    invoke-static {v0}, Landroid/speech/tts/TextToSpeech;->access$2100(Landroid/speech/tts/TextToSpeech;)Landroid/content/Context;
    ...
    .line 2318
    invoke-direct {p0}, clearServiceConnection()Z
...
.method public isEstablished()Z
    ...
    iget-boolean v0, p0, mEstablished:Z
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    # getter for: Landroid/speech/tts/TextToSpeech;->mStartLock:Ljava/lang/Object;
    invoke-static {v0}, Landroid/speech/tts/TextToSpeech;->access$1400(Landroid/speech/tts/TextToSpeech;)Ljava/lang/Object;
    ...
    iput-object v0, p0, mService:Landroid/speech/tts/ITextToSpeechService;
    ...
    iput-boolean v0, p0, mEstablished:Z
    ...
    iput-object v0, p0, mOnSetupConnectionAsyncTask:Landroid/speech/tts/TextToSpeech$Connection$SetupConnectionAsyncTask;
...
.method public runAction(Landroid/speech/tts/TextToSpeech$Action;Ljava/lang/Object;Ljava/lang/String;ZZ)Ljava/lang/Object;
    ...
    .line 2329
    :try_start_7
    iget-object v1, p0, mService:Landroid/speech/tts/ITextToSpeechService;
    ...
    :try_start_27
    invoke-virtual {p0}, isEstablished()Z
