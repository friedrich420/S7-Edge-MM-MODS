...
.method constructor <init>(Landroid/telecom/ConnectionService$2;Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    .prologue
    .line 255
    iput-object p1, p0, this$1:Landroid/telecom/ConnectionService$2;

    iput-object p2, p0, val$connectionManagerPhoneAccount:Landroid/telecom/PhoneAccountHandle;

    iput-object p3, p0, val$id:Ljava/lang/String;

    iput-object p4, p0, val$request:Landroid/telecom/ConnectionRequest;

    iput-boolean p5, p0, val$isIncoming:Z

    iput-boolean p6, p0, val$isUnknown:Z
...
.method public run()V
    ...
    .prologue
    .line 258
    iget-object v0, p0, this$1:Landroid/telecom/ConnectionService$2;

    iget-object v0, v0, Landroid/telecom/ConnectionService$2;->this$0:Landroid/telecom/ConnectionService;

    iget-object v1, p0, val$connectionManagerPhoneAccount:Landroid/telecom/PhoneAccountHandle;

    iget-object v2, p0, val$id:Ljava/lang/String;

    iget-object v3, p0, val$request:Landroid/telecom/ConnectionRequest;

    iget-boolean v4, p0, val$isIncoming:Z

    iget-boolean v5, p0, val$isUnknown:Z
