...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    .line 1071
    invoke-static {p1}, lookupZoneInfo(Ljava/lang/String;)Llibcore/util/ZoneInfo;

    move-result-object v0

    iput-object v0, p0, zoneInfo:Llibcore/util/ZoneInfo;
    ...
    iput-object v0, p0, wallTime:Llibcore/util/ZoneInfo$WallTime;
...
.method public static compare(Landroid/text/format/Time$TimeCalculator;Landroid/text/format/Time$TimeCalculator;)I
    ...
    .line 1208
    iget-object v7, p0, timezone:Ljava/lang/String;

    iget-object v8, p1, timezone:Ljava/lang/String;
    ...
    .line 1210
    iget-object v7, p0, wallTime:Llibcore/util/ZoneInfo$WallTime;

    invoke-virtual {v7}, Llibcore/util/ZoneInfo$WallTime;->getYear()I

    move-result v7

    iget-object v8, p1, wallTime:Llibcore/util/ZoneInfo$WallTime;
    ...
    .end local v4    # "diff":I
    :cond_70
    invoke-virtual {p0, v6}, toMillis(Z)J

    move-result-wide v0

    .line 1246
    .local v0, "am":J
    invoke-virtual {p1, v6}, toMillis(Z)J
...
.method private updateZoneInfoFromTimeZone()V
    ...
    .prologue
    .line 1104
    iget-object v0, p0, zoneInfo:Llibcore/util/ZoneInfo;
    ...
    .line 1105
    iget-object v0, p0, timezone:Ljava/lang/String;

    invoke-static {v0}, lookupZoneInfo(Ljava/lang/String;)Llibcore/util/ZoneInfo;
...
.method public copyFieldsFromTime(Landroid/text/format/Time;)V
    ...
    .prologue
    .line 1272
    iget-object v0, p0, wallTime:Llibcore/util/ZoneInfo$WallTime;
    ...
    .line 1288
    invoke-direct {p0}, updateZoneInfoFromTimeZone()V
...
.method public format(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, wallTime:Llibcore/util/ZoneInfo$WallTime;

    iget-object v2, p0, zoneInfo:Llibcore/util/ZoneInfo;
...
.method public format2445(Z)Ljava/lang/String;
    ...
    .line 1134
    .local v0, "buf":[C
    iget-object v2, p0, wallTime:Llibcore/util/ZoneInfo$WallTime;
    ...
    invoke-direct {p0, v2}, toChar(I)C
    ...
    invoke-direct {p0, v5}, toChar(I)C
    ...
    invoke-direct {p0, v1}, toChar(I)C
    ...
    invoke-direct {p0, v4}, toChar(I)C
    ...
    iget-object v4, p0, timezone:Ljava/lang/String;
...
.method public toStringInternal()Ljava/lang/String;
    ...
    iget-object v3, p0, wallTime:Llibcore/util/ZoneInfo$WallTime;
    ...
    iget-object v3, p0, timezone:Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, toMillis(Z)J
