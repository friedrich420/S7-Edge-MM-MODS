...
.method private getBottomLine(Landroid/widget/TextView;)I
    ...
    invoke-direct {p0, p1}, getInnerHeight(Landroid/widget/TextView;)I
...
.method private getScrollBoundsLeft(Landroid/widget/TextView;)I
    ...
    invoke-direct {p0, p1}, getTopLine(Landroid/widget/TextView;)I

    move-result v5

    .line 425
    .local v5, "topLine":I
    invoke-direct {p0, p1}, getBottomLine(Landroid/widget/TextView;)I
...
.method protected handleMovementKey(Landroid/widget/TextView;Landroid/text/Spannable;IILandroid/view/KeyEvent;)Z
    ...
    .line 165
    invoke-virtual {p0, p1, p2}, left(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 168
    invoke-virtual {p0, p1, p2}, leftWord(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 171
    invoke-virtual {p0, p1, p2}, lineStart(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 177
    invoke-virtual {p0, p1, p2}, right(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 180
    invoke-virtual {p0, p1, p2}, rightWord(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 183
    invoke-virtual {p0, p1, p2}, lineEnd(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 189
    invoke-virtual {p0, p1, p2}, up(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 192
    invoke-virtual {p0, p1, p2}, top(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 198
    invoke-virtual {p0, p1, p2}, down(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 201
    invoke-virtual {p0, p1, p2}, bottom(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 207
    invoke-virtual {p0, p1, p2}, pageUp(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 216
    invoke-virtual {p0, p1, p2}, pageDown(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 225
    invoke-virtual {p0, p1, p2}, home(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .line 234
    invoke-virtual {p0, p1, p2}, end(Landroid/widget/TextView;Landroid/text/Spannable;)Z
...
.method public onGenericMotionEvent(Landroid/widget/TextView;Landroid/text/Spannable;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, p1, p2, v3}, scrollLeft(Landroid/widget/TextView;Landroid/text/Spannable;I)Z
    ...
    invoke-virtual {p0, p1, p2, v3}, scrollUp(Landroid/widget/TextView;Landroid/text/Spannable;I)Z
    ...
    invoke-virtual {p0, p1, p2, v3}, scrollRight(Landroid/widget/TextView;Landroid/text/Spannable;I)Z
    ...
    invoke-virtual {p0, p1, p2, v3}, scrollDown(Landroid/widget/TextView;Landroid/text/Spannable;I)Z
...
.method public onKeyDown(Landroid/widget/TextView;Landroid/text/Spannable;ILandroid/view/KeyEvent;)Z
    ...
    .prologue
    .line 41
    invoke-virtual {p0, p2, p4}, getMovementMetaState(Landroid/text/Spannable;Landroid/view/KeyEvent;)I
    ...
    .line 42
    invoke-virtual/range {v0 .. v5}, handleMovementKey(Landroid/widget/TextView;Landroid/text/Spannable;IILandroid/view/KeyEvent;)Z
...
.method public onKeyOther(Landroid/widget/TextView;Landroid/text/Spannable;Landroid/view/KeyEvent;)Z
    ...
    .prologue
    .line 52
    invoke-virtual {p0, p2, p3}, getMovementMetaState(Landroid/text/Spannable;Landroid/view/KeyEvent;)I
...
.method protected scrollLeft(Landroid/widget/TextView;Landroid/text/Spannable;I)Z
    ...
    .prologue
    .line 467
    invoke-direct {p0, p1}, getScrollBoundsLeft(Landroid/widget/TextView;)I
    ...
    .line 470
    invoke-direct {p0, p1}, getCharacterWidth(Landroid/widget/TextView;)I
...
.method protected scrollLineEnd(Landroid/widget/TextView;Landroid/text/Spannable;)Z
    ...
    .prologue
    .line 665
    invoke-direct {p0, p1}, getScrollBoundsRight(Landroid/widget/TextView;)I

    move-result v2

    invoke-direct {p0, p1}, getInnerWidth(Landroid/widget/TextView;)I
