...
.method static constructor <clinit>()V
    ...
    sput-object v0, sConstructorSignature:[Ljava/lang/Class;
    ...
    sput-object v0, sConstructors:Landroid/util/ArrayMap;
...
.method private createCustom(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_22
    :try_start_22
    sget-object v5, sConstructors:Landroid/util/ArrayMap;

    monitor-enter v5
    :try_end_25
    .catch Ljava/lang/InstantiationException; {:try_start_22 .. :try_end_25} :catch_62
    .catch Ljava/lang/ClassNotFoundException; {:try_start_22 .. :try_end_25} :catch_86
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_22 .. :try_end_25} :catch_aa
    .catch Ljava/lang/NoSuchMethodException; {:try_start_22 .. :try_end_25} :catch_ce
    .catch Ljava/lang/IllegalAccessException; {:try_start_22 .. :try_end_25} :catch_f2

    .line 208
    :try_start_25
    sget-object v4, sConstructors:Landroid/util/ArrayMap;
    ...
    .line 213
    sget-object v4, sConstructorSignature:[Ljava/lang/Class;
    ...
    throw v4
    :try_end_62
    .catch Ljava/lang/InstantiationException; {:try_start_61 .. :try_end_62} :catch_62
    .catch Ljava/lang/ClassNotFoundException; {:try_start_61 .. :try_end_62} :catch_86
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_61 .. :try_end_62} :catch_aa
    .catch Ljava/lang/NoSuchMethodException; {:try_start_61 .. :try_end_62} :catch_ce
    .catch Ljava/lang/IllegalAccessException; {:try_start_61 .. :try_end_62} :catch_f2
...
.method private createTransitionFromXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/transition/Transition;)Landroid/transition/Transition;
    ...
    .line 185
    invoke-direct {p0, p1, p2, v2}, createTransitionFromXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/transition/Transition;)Landroid/transition/Transition;
    ...
    invoke-direct {p0, p2, v5, v6}, createCustom(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 173
    invoke-direct {p0, p1, p2, p3}, getTargetIds(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/transition/Transition;)V
...
.method private createTransitionManagerFromXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/transition/TransitionManager;
    ...
    .line 311
    invoke-direct {p0, p2, p3, v2}, loadTransition(Landroid/util/AttributeSet;Landroid/view/ViewGroup;Landroid/transition/TransitionManager;)V
...
.method private loadTransition(Landroid/util/AttributeSet;Landroid/view/ViewGroup;Landroid/transition/TransitionManager;)V
    ...
    .line 330
    invoke-virtual {p0, v6}, inflateTransition(I)Landroid/transition/Transition;
...
.method public inflateTransition(I)Landroid/transition/Transition;
    ...
    invoke-direct {p0, v2, v3, v4}, createTransitionFromXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/transition/Transition;)Landroid/transition/Transition;
    :try_end_12
...
.method public inflateTransitionManager(ILandroid/view/ViewGroup;)Landroid/transition/TransitionManager;
    ...
    invoke-direct {p0, v2, v3, p2}, createTransitionManagerFromXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/transition/TransitionManager;
    :try_end_11
