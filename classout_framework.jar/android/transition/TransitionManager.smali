...
.method static constructor <clinit>()V
    ...
    sput-object v0, sDefaultTransition:Landroid/transition/Transition;
    ...
    sput-object v0, EMPTY_STRINGS:[Ljava/lang/String;
    ...
    sput-object v0, sRunningTransitions:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, sPendingTransitions:Ljava/util/ArrayList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mSceneTransitions:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, mScenePairTransitions:Landroid/util/ArrayMap;
...
.method static synthetic access$000()Ljava/util/ArrayList;
    ...
    .prologue
    .line 63
    sget-object v0, sPendingTransitions:Ljava/util/ArrayList;
...
.method static synthetic access$100()Landroid/util/ArrayMap;
    ...
    .prologue
    .line 63
    invoke-static {}, getRunningTransitions()Landroid/util/ArrayMap;
...
.method public static beginDelayedTransition(Landroid/view/ViewGroup;)V
    ...
    invoke-static {p0, v0}, beginDelayedTransition(Landroid/view/ViewGroup;Landroid/transition/Transition;)V
...
.method public static beginDelayedTransition(Landroid/view/ViewGroup;Landroid/transition/Transition;)V
    ...
    .prologue
    .line 413
    sget-object v1, sPendingTransitions:Ljava/util/ArrayList;
    ...
    .line 420
    sget-object p1, sDefaultTransition:Landroid/transition/Transition;
    ...
    invoke-static {p0, v0}, sceneChangeSetup(Landroid/view/ViewGroup;Landroid/transition/Transition;)V
    ...
    .line 425
    invoke-static {p0, v0}, sceneChangeRunTransition(Landroid/view/ViewGroup;Landroid/transition/Transition;)V
...
.method private static changeScene(Landroid/transition/Scene;Landroid/transition/Transition;)V
    ...
    sget-object v3, sPendingTransitions:Ljava/util/ArrayList;
    ...
    .line 199
    :cond_2d
    invoke-static {v1, v2}, sceneChangeSetup(Landroid/view/ViewGroup;Landroid/transition/Transition;)V

    .line 201
    invoke-virtual {p0}, Landroid/transition/Scene;->enter()V

    .line 203
    invoke-static {v1, v2}, sceneChangeRunTransition(Landroid/view/ViewGroup;Landroid/transition/Transition;)V
...
.method public static endTransitions(Landroid/view/ViewGroup;)V
    ...
    .prologue
    .line 435
    sget-object v4, sPendingTransitions:Ljava/util/ArrayList;
...
.method public static getDefaultTransition()Landroid/transition/Transition;
    ...
    .prologue
    .line 104
    sget-object v0, sDefaultTransition:Landroid/transition/Transition;
...
.method private static getRunningTransitions()Landroid/util/ArrayMap;
    ...
    .prologue
    .line 208
    sget-object v2, sRunningTransitions:Ljava/lang/ThreadLocal;
...
.method private getTransition(Landroid/transition/Scene;)Landroid/transition/Transition;
    ...
    .line 158
    iget-object v4, p0, mScenePairTransitions:Landroid/util/ArrayMap;
    ...
    .line 167
    :cond_21
    iget-object v4, p0, mSceneTransitions:Landroid/util/ArrayMap;
    ...
    :cond_2d
    sget-object v4, sDefaultTransition:Landroid/transition/Transition;
...
.method public static go(Landroid/transition/Scene;)V
    ...
    invoke-static {p0, v0}, changeScene(Landroid/transition/Scene;Landroid/transition/Transition;)V
...
.method public static go(Landroid/transition/Scene;Landroid/transition/Transition;)V
    ...
    .prologue
    .line 373
    invoke-static {p0, p1}, changeScene(Landroid/transition/Scene;Landroid/transition/Transition;)V
...
.method public setDefaultTransition(Landroid/transition/Transition;)V
    ...
    .prologue
    .line 91
    sput-object p1, sDefaultTransition:Landroid/transition/Transition;
...
.method public setTransition(Landroid/transition/Scene;Landroid/transition/Scene;Landroid/transition/Transition;)V
    ...
    .prologue
    .line 133
    iget-object v1, p0, mScenePairTransitions:Landroid/util/ArrayMap;
...
.method public setTransition(Landroid/transition/Scene;Landroid/transition/Transition;)V
    ...
    .prologue
    .line 117
    iget-object v0, p0, mSceneTransitions:Landroid/util/ArrayMap;
...
.method public transitionTo(Landroid/transition/Scene;)V
    ...
    .prologue
    .line 345
    invoke-direct {p0, p1}, getTransition(Landroid/transition/Scene;)Landroid/transition/Transition;

    move-result-object v0

    invoke-static {p1, v0}, changeScene(Landroid/transition/Scene;Landroid/transition/Transition;)V
