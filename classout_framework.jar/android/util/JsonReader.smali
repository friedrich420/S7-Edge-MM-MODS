...
.method public constructor <init>(Ljava/io/Reader;)V
    ...
    iput-object v0, p0, stringPool:Llibcore/internal/StringPool;

    .line 187
    iput-boolean v1, p0, lenient:Z
    ...
    .line 202
    iput v2, p0, bufferStartLine:I

    .line 203
    iput v2, p0, bufferStartColumn:I
    ...
    iput-object v0, p0, stack:Ljava/util/List;

    .line 207
    sget-object v0, Landroid/util/JsonScope;->EMPTY_DOCUMENT:Landroid/util/JsonScope;

    invoke-direct {p0, v0}, push(Landroid/util/JsonScope;)V

    .line 228
    iput-boolean v1, p0, skipping:Z
    ...
    .line 237
    :cond_34
    iput-object p1, p0, in:Ljava/io/Reader;
...
.method private advance()Landroid/util/JsonToken;
    ...
    .line 371
    invoke-virtual {p0}, peek()Landroid/util/JsonToken;

    .line 373
    iget-object v0, p0, token:Landroid/util/JsonToken;

    .line 374
    .local v0, "result":Landroid/util/JsonToken;
    iput-object v1, p0, token:Landroid/util/JsonToken;

    .line 375
    iput-object v1, p0, value:Ljava/lang/String;
...
.method private checkLenient()V
    ...
    invoke-direct {p0, v0}, syntaxError(Ljava/lang/String;)Ljava/io/IOException;
...
.method private decodeLiteral()Landroid/util/JsonToken;
    ...
    .line 1072
    :cond_11
    iget v0, p0, valueLength:I

    if-ne v0, v5, :cond_6f

    const/16 v0, 0x6e

    iget-object v1, p0, buffer:[C

    iget v2, p0, valuePos:I
    ...
    iget-object v0, p0, buffer:[C

    iget v1, p0, valuePos:I
    ...
    .line 1095
    :cond_14f
    iget-object v0, p0, stringPool:Llibcore/internal/StringPool;

    iget-object v1, p0, buffer:[C

    iget v2, p0, valuePos:I

    iget v3, p0, valueLength:I
    ...
    iget v2, p0, valueLength:I

    invoke-direct {p0, v0, v1, v2}, decodeNumber([CII)Landroid/util/JsonToken;
...
.method private expect(Landroid/util/JsonToken;)V
    ...
    .line 312
    :cond_2e
    invoke-direct {p0}, advance()Landroid/util/JsonToken;
...
.method private fillBuffer(I)Z
    ...
    .line 726
    iget v4, p0, bufferStartLine:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, bufferStartLine:I
    ...
    .line 729
    :cond_1a
    iget v4, p0, bufferStartColumn:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, bufferStartColumn:I
    ...
    .line 742
    :cond_3b
    iget-object v4, p0, in:Ljava/io/Reader;

    iget-object v5, p0, buffer:[C

    iget v6, p0, limit:I

    iget-object v7, p0, buffer:[C
...
.method private getColumnNumber()I
    ...
    .prologue
    .line 770
    iget v1, p0, bufferStartColumn:I
...
.method private nextInArray(Z)Landroid/util/JsonToken;
    ...
    invoke-direct {p0, v0}, replaceTop(Landroid/util/JsonScope;)V

    .line 603
    :goto_7
    :sswitch_7
    invoke-direct {p0}, nextNonWhitespace()I
    ...
    .line 619
    invoke-direct {p0}, nextValue()Landroid/util/JsonToken;
    ...
    .line 592
    :sswitch_27
    invoke-direct {p0}, pop()Landroid/util/JsonScope;

    .line 593
    sget-object v0, Landroid/util/JsonToken;->END_ARRAY:Landroid/util/JsonToken;

    iput-object v0, p0, token:Landroid/util/JsonToken;

    goto :goto_18

    .line 595
    :sswitch_2f
    invoke-direct {p0}, checkLenient()V
...
.method private nextInObject(Z)Landroid/util/JsonToken;
    ...
    invoke-direct {p0, v1}, nextLiteral(Z)Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, syntaxError(Ljava/lang/String;)Ljava/io/IOException;
    ...
    invoke-direct {p0, v1}, nextString(C)Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, replaceTop(Landroid/util/JsonScope;)V
...
.method private nextLiteral(Z)Ljava/lang/String;
    ...
    iput v3, p0, valuePos:I

    .line 927
    iput v5, p0, valueLength:I
    ...
    invoke-direct {p0, v3}, fillBuffer(I)Z
    ...
    .line 989
    iget-object v3, p0, stringPool:Llibcore/internal/StringPool;
...
.method private nextNonWhitespace()I
    ...
    invoke-direct {p0, v5}, fillBuffer(I)Z
    ...
    invoke-direct {p0, v2}, skipTo(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v2}, syntaxError(Ljava/lang/String;)Ljava/io/IOException;
    ...
    .line 811
    invoke-direct {p0}, skipToEndOfLine()V
...
.method private nextString(C)Ljava/lang/String;
    ...
    .line 902
    invoke-direct {p0}, readEscapeCharacter()C
    ...
    invoke-direct {p0, v3}, syntaxError(Ljava/lang/String;)Ljava/io/IOException;
...
.method private nextValue()Landroid/util/JsonToken;
    ...
    .line 713
    invoke-direct {p0}, readLiteral()Landroid/util/JsonToken;
    ...
    invoke-direct {p0, v1}, push(Landroid/util/JsonScope;)V
...
.method private objectValue()Landroid/util/JsonToken;
    ...
    invoke-direct {p0, v0}, fillBuffer(I)Z
...
.method private peekStack()Landroid/util/JsonScope;
    ...
    .prologue
    .line 567
    iget-object v0, p0, stack:Ljava/util/List;

    iget-object v1, p0, stack:Ljava/util/List;
...
.method private readEscapeCharacter()C
    ...
    invoke-direct {p0, v2}, fillBuffer(I)Z
    ...
    .line 1023
    :cond_38
    iget-object v2, p0, stringPool:Llibcore/internal/StringPool;
...
.method private readLiteral()Landroid/util/JsonToken;
    ...
    invoke-direct {p0, v0}, nextLiteral(Z)Ljava/lang/String;
    ...
    .line 1058
    :cond_12
    invoke-direct {p0}, decodeLiteral()Landroid/util/JsonToken;
...
.method private skipTo(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1}, fillBuffer(I)Z
...
.method private syntaxError(Ljava/lang/String;)Ljava/io/IOException;
    ...
    invoke-direct {p0}, getLineNumber()I
    ...
    invoke-direct {p0}, getColumnNumber()I
...
.method public beginArray()V
    ...
    invoke-direct {p0, v0}, expect(Landroid/util/JsonToken;)V
...
.method public close()V
    ...
    .line 538
    iget-object v0, p0, in:Ljava/io/Reader;
...
.method public nextBoolean()Z
    ...
    .line 425
    iget-object v1, p0, token:Landroid/util/JsonToken;
    ...
    iget-object v3, p0, token:Landroid/util/JsonToken;
...
.method public nextDouble()D
    ...
    .line 459
    iget-object v2, p0, token:Landroid/util/JsonToken;
    ...
    iget-object v4, p0, token:Landroid/util/JsonToken;
    ...
    .line 463
    :cond_2a
    iget-object v2, p0, value:Ljava/lang/String;
...
.method public nextInt()I
    ...
    iget-object v6, p0, token:Landroid/util/JsonToken;
    ...
    :cond_2a
    :try_start_2a
    iget-object v4, p0, value:Ljava/lang/String;
...
.method public nextLong()J
    ...
    iget-object v7, p0, token:Landroid/util/JsonToken;
    ...
    :cond_2a
    :try_start_2a
    iget-object v3, p0, value:Ljava/lang/String;
    ...
    iget-object v6, p0, value:Ljava/lang/String;
...
.method public peek()Landroid/util/JsonToken;
    ...
    invoke-direct {p0}, peekStack()Landroid/util/JsonScope;
    ...
    invoke-direct {p0, v3}, replaceTop(Landroid/util/JsonScope;)V
    ...
    iget-object v5, p0, token:Landroid/util/JsonToken;
    ...
    :pswitch_52
    invoke-direct {p0, v6}, nextInArray(Z)Landroid/util/JsonToken;
    ...
    .line 343
    :pswitch_57
    invoke-direct {p0, v5}, nextInArray(Z)Landroid/util/JsonToken;
    ...
    .line 345
    :pswitch_5c
    invoke-direct {p0, v6}, nextInObject(Z)Landroid/util/JsonToken;
    ...
    .line 347
    :pswitch_61
    invoke-direct {p0}, objectValue()Landroid/util/JsonToken;
    ...
    .line 349
    :pswitch_66
    invoke-direct {p0, v5}, nextInObject(Z)Landroid/util/JsonToken;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-direct {p0}, getSnippet()Ljava/lang/CharSequence;
