...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v2}, <init>(II)V

    sput-object v0, NaN:Landroid/util/Rational;

    .line 48
    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v3, v2}, <init>(II)V

    sput-object v0, POSITIVE_INFINITY:Landroid/util/Rational;
    ...
    sput-object v0, NEGATIVE_INFINITY:Landroid/util/Rational;

    .line 64
    new-instance v0, Landroid/util/Rational;

    invoke-direct {v0, v2, v3}, <init>(II)V

    sput-object v0, ZERO:Landroid/util/Rational;
...
.method public constructor <init>(II)V
    ...
    .line 110
    iput v1, p0, mNumerator:I

    .line 111
    iput v2, p0, mDenominator:I
    ...
    .line 120
    iput v1, p0, mDenominator:I

    goto :goto_11

    .line 122
    :cond_2c
    invoke-static {p1, p2}, gcd(II)I
...
.method private equals(Landroid/util/Rational;)Z
    ...
    .prologue
    .line 244
    iget v0, p0, mNumerator:I

    iget v1, p1, mNumerator:I

    if-ne v0, v1, :cond_e

    iget v0, p0, mDenominator:I

    iget v1, p1, mDenominator:I
...
.method public static parseRational(Ljava/lang/String;)Landroid/util/Rational;
    ...
    .line 581
    sget-object v2, NaN:Landroid/util/Rational;
    ...
    .line 583
    sget-object v2, POSITIVE_INFINITY:Landroid/util/Rational;
    ...
    .line 585
    sget-object v2, NEGATIVE_INFINITY:Landroid/util/Rational;
    ...
    .line 593
    invoke-static {p0}, invalidRational(Ljava/lang/String;)Ljava/lang/NumberFormatException;
    ...
    invoke-direct {v2, v3, v4}, <init>(II)V
    :try_end_54
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    iget v1, p0, mDenominator:I

    invoke-static {v0, v1}, gcd(II)I
...
.method public compareTo(Landroid/util/Rational;)I
    ...
    .line 469
    invoke-direct {p0, p1}, equals(Landroid/util/Rational;)Z
    ...
    .line 475
    :cond_1f
    invoke-direct {p0}, isPosInf()Z

    move-result v7

    if-nez v7, :cond_2b

    invoke-direct {p1}, isNegInf()Z
    ...
    .line 477
    :cond_2d
    invoke-direct {p0}, isNegInf()Z

    move-result v7

    if-nez v7, :cond_39

    invoke-direct {p1}, isPosInf()Z
    ...
    .line 484
    :cond_3b
    iget v7, p0, mNumerator:I

    int-to-long v8, v7

    iget v7, p1, mDenominator:I
    ...
    iget v7, p1, mNumerator:I

    int-to-long v8, v7

    iget v7, p0, mDenominator:I
...
.method public bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, compareTo(Landroid/util/Rational;)I
...
.method public doubleValue()D
    ...
    .prologue
    .line 338
    iget v4, p0, mNumerator:I

    int-to-double v2, v4

    .line 339
    .local v2, "num":D
    iget v4, p0, mDenominator:I
...
.method public floatValue()F
    ...
    .prologue
    .line 355
    iget v2, p0, mNumerator:I

    int-to-float v1, v2

    .line 356
    .local v1, "num":F
    iget v2, p0, mDenominator:I
...
.method public toFloat()F
    ...
    .prologue
    .line 281
    invoke-virtual {p0}, floatValue()F
