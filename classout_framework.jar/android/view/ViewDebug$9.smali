...
.method constructor <init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/reflect/Method;Landroid/view/View;[Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/CountDownLatch;)V
    ...
    .prologue
    .line 1697
    iput-object p1, p0, val$result:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p2, p0, val$method:Ljava/lang/reflect/Method;

    iput-object p3, p0, val$view:Landroid/view/View;

    iput-object p4, p0, val$args:[Ljava/lang/Object;

    iput-object p5, p0, val$exception:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p6, p0, val$latch:Ljava/util/concurrent/CountDownLatch;
...
.method public run()V
    ...
    .line 1701
    :try_start_0
    iget-object v1, p0, val$result:Ljava/util/concurrent/atomic/AtomicReference;

    iget-object v2, p0, val$method:Ljava/lang/reflect/Method;

    iget-object v3, p0, val$view:Landroid/view/View;

    iget-object v4, p0, val$args:[Ljava/lang/Object;
    ...
    .line 1708
    :goto_f
    iget-object v1, p0, val$latch:Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object v1, p0, val$exception:Ljava/util/concurrent/atomic/AtomicReference;
