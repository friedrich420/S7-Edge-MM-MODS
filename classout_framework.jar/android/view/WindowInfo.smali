...
.method private constructor <init>()V
    ...
    iput-object v0, p0, boundsInScreen:Landroid/graphics/Rect;
...
.method private clear()V
    ...
    .line 143
    iput-object v1, p0, parentToken:Landroid/os/IBinder;

    .line 144
    iput-boolean v0, p0, focused:Z

    .line 145
    iget-object v0, p0, boundsInScreen:Landroid/graphics/Rect;

    invoke-virtual {v0}, Landroid/graphics/Rect;->setEmpty()V

    .line 146
    iget-object v0, p0, childTokens:Ljava/util/List;
...
.method private initFromParcel(Landroid/os/Parcel;)V
    ...
    :goto_21
    iput-boolean v1, p0, focused:Z

    .line 128
    iget-object v1, p0, boundsInScreen:Landroid/graphics/Rect;
    ...
    .line 132
    iget-object v1, p0, childTokens:Ljava/util/List;
    ...
    iput-object v1, p0, childTokens:Ljava/util/List;
...
.method public static obtain(Landroid/view/WindowInfo;)Landroid/view/WindowInfo;
    ...
    .prologue
    .line 61
    invoke-static {}, obtain()Landroid/view/WindowInfo;
    ...
    iput-object v1, v0, token:Landroid/os/IBinder;

    .line 65
    iget-object v1, p0, parentToken:Landroid/os/IBinder;

    iput-object v1, v0, parentToken:Landroid/os/IBinder;

    .line 66
    iget-boolean v1, p0, focused:Z

    iput-boolean v1, v0, focused:Z

    .line 67
    iget-object v1, v0, boundsInScreen:Landroid/graphics/Rect;

    iget-object v2, p0, boundsInScreen:Landroid/graphics/Rect;
    ...
    .line 70
    iget-object v1, v0, childTokens:Ljava/util/List;
    ...
    iget-object v2, p0, childTokens:Ljava/util/List;

    invoke-direct {v1, v2}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iput-object v1, v0, childTokens:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, parentToken:Landroid/os/IBinder;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 95
    iget-object v0, p0, parentToken:Landroid/os/IBinder;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeStrongBinder(Landroid/os/IBinder;)V

    .line 96
    iget-boolean v0, p0, focused:Z
