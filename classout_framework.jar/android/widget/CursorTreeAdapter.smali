...
.method public constructor <init>(Landroid/database/Cursor;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, p2, v0}, init(Landroid/database/Cursor;Landroid/content/Context;Z)V
...
.method public constructor <init>(Landroid/database/Cursor;Landroid/content/Context;Z)V
    ...
    .line 77
    invoke-direct {p0, p1, p2, p3}, init(Landroid/database/Cursor;Landroid/content/Context;Z)V
...
.method private init(Landroid/database/Cursor;Landroid/content/Context;Z)V
    ...
    .line 83
    iput-boolean p3, p0, mAutoRequery:Z
    ...
    iput-object v0, p0, mGroupCursorHelper:Landroid/widget/CursorTreeAdapter$MyCursorHelper;
    ...
    iput-object v0, p0, mChildrenCursorHelpers:Landroid/util/SparseArray;
...
.method private declared-synchronized releaseCursorHelpers()V
    ...
    :try_start_1
    iget-object v1, p0, mChildrenCursorHelpers:Landroid/util/SparseArray;
...
.method public changeCursor(Landroid/database/Cursor;)V
    ...
    .prologue
    .line 383
    iget-object v0, p0, mGroupCursorHelper:Landroid/widget/CursorTreeAdapter$MyCursorHelper;
...
.method public bridge synthetic convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 38
    invoke-virtual {p0, p1}, convertToString(Landroid/database/Cursor;)Ljava/lang/String;
...
.method declared-synchronized deactivateChildrenCursorHelper(I)V
    ...
    :try_start_2
    invoke-virtual {p0, p1, v1}, getChildrenCursorHelper(IZ)Landroid/widget/CursorTreeAdapter$MyCursorHelper;
...
.method public getChild(II)Landroid/database/Cursor;
    ...
    invoke-virtual {p0, p1, v0}, getChildrenCursorHelper(IZ)Landroid/widget/CursorTreeAdapter$MyCursorHelper;
...
.method public bridge synthetic getChild(II)Ljava/lang/Object;
    ...
    .prologue
    .line 38
    invoke-virtual {p0, p1, p2}, getChild(II)Landroid/database/Cursor;
...
.method public getChildView(IIZLandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, v3}, getChildrenCursorHelper(IZ)Landroid/widget/CursorTreeAdapter$MyCursorHelper;
    ...
    invoke-virtual {p0, v3, v0, p3, p5}, newChildView(Landroid/content/Context;Landroid/database/Cursor;ZLandroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v2, v3, v0, p3}, bindChildView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Z)V
...
.method public getChildrenCount(I)I
    ...
    iget-object v1, p0, mGroupCursorHelper:Landroid/widget/CursorTreeAdapter$MyCursorHelper;
...
.method declared-synchronized getChildrenCursorHelper(IZ)Landroid/widget/CursorTreeAdapter$MyCursorHelper;
    ...
    :try_start_1
    iget-object v2, p0, mChildrenCursorHelpers:Landroid/util/SparseArray;
    ...
    .line 103
    iget-object v2, p0, mGroupCursorHelper:Landroid/widget/CursorTreeAdapter$MyCursorHelper;
    ...
    invoke-virtual {p0, v2}, getChildrenCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
...
.method public bridge synthetic getGroup(I)Ljava/lang/Object;
    ...
    .prologue
    .line 38
    invoke-virtual {p0, p1}, getGroup(I)Landroid/database/Cursor;
...
.method public getGroupView(IZLandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v2, v0, p2, p4}, newGroupView(Landroid/content/Context;Landroid/database/Cursor;ZLandroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v2, v0, p2}, bindGroupView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Z)V
...
.method public notifyDataSetChanged()V
    ...
    invoke-virtual {p0, v0}, notifyDataSetChanged(Z)V
...
.method public notifyDataSetChanged(Z)V
    ...
    .line 311
    invoke-direct {p0}, releaseCursorHelpers()V
...
.method public onGroupCollapsed(I)V
    ...
    .prologue
    .line 325
    invoke-virtual {p0, p1}, deactivateChildrenCursorHelper(I)V
