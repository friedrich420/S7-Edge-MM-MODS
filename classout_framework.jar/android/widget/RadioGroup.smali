...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, mCheckedId:I

    .line 59
    const/4 v0, 0x0

    iput-boolean v0, p0, mProtectFromCheckedChange:Z

    .line 68
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, setOrientation(I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 55
    iput v5, p0, mCheckedId:I

    .line 59
    iput-boolean v6, p0, mProtectFromCheckedChange:Z
...
.method static synthetic access$300(Landroid/widget/RadioGroup;)Z
    ...
    .prologue
    .line 53
    iget-boolean v0, p0, mProtectFromCheckedChange:Z
...
.method static synthetic access$302(Landroid/widget/RadioGroup;Z)Z
    ...
    .prologue
    .line 53
    iput-boolean p1, p0, mProtectFromCheckedChange:Z
...
.method static synthetic access$500(Landroid/widget/RadioGroup;IZ)V
    ...
    .prologue
    .line 53
    invoke-direct {p0, p1, p2}, setCheckedStateForView(IZ)V
...
.method static synthetic access$600(Landroid/widget/RadioGroup;I)V
    ...
    .prologue
    .line 53
    invoke-direct {p0, p1}, setCheckedId(I)V
...
.method static synthetic access$700(Landroid/widget/RadioGroup;)Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    .prologue
    .line 53
    iget-object v0, p0, mChildOnCheckedChangeListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
...
.method private init()V
    ...
    iput-object v0, p0, mChildOnCheckedChangeListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iput-object v0, p0, mPassThroughListener:Landroid/widget/RadioGroup$PassThroughHierarchyChangeListener;

    .line 98
    iget-object v0, p0, mPassThroughListener:Landroid/widget/RadioGroup$PassThroughHierarchyChangeListener;
...
.method private setCheckedId(I)V
    ...
    .prologue
    .line 171
    iput p1, p0, mCheckedId:I

    .line 172
    iget-object v0, p0, mOnCheckedChangeListener:Landroid/widget/RadioGroup$OnCheckedChangeListener;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-boolean v1, p0, mProtectFromCheckedChange:Z
    ...
    invoke-direct {p0, v1, v3}, setCheckedStateForView(IZ)V

    .line 135
    :cond_1b
    iput-boolean v3, p0, mProtectFromCheckedChange:Z
    ...
    invoke-direct {p0, v1}, setCheckedId(I)V
...
.method public check(I)V
    ...
    invoke-direct {p0, v0, v1}, setCheckedStateForView(IZ)V
    ...
    invoke-direct {p0, p1, v0}, setCheckedStateForView(IZ)V
...
.method public clearCheck()V
    ...
    invoke-virtual {p0, v0}, check(I)V
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .prologue
    .line 53
    invoke-virtual {p0, p1}, generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/RadioGroup$LayoutParams;
...
.method protected onFinishInflate()V
    ...
    .line 119
    iput-boolean v2, p0, mProtectFromCheckedChange:Z

    .line 120
    iget v0, p0, mCheckedId:I

    invoke-direct {p0, v0, v2}, setCheckedStateForView(IZ)V
    ...
    invoke-direct {p0, v0}, setCheckedId(I)V
...
.method public setOnCheckedChangeListener(Landroid/widget/RadioGroup$OnCheckedChangeListener;)V
    ...
    .prologue
    .line 219
    iput-object p1, p0, mOnCheckedChangeListener:Landroid/widget/RadioGroup$OnCheckedChangeListener;
