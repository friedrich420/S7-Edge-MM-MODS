...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;II[Ljava/lang/String;[III[Ljava/lang/String;[I)V
    ...
    invoke-direct {p0, p5, p6, v0, v1}, init([Ljava/lang/String;[I[Ljava/lang/String;[I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;II[Ljava/lang/String;[II[Ljava/lang/String;[I)V
    ...
    .line 143
    invoke-direct {p0, p5, p6, p8, p9}, init([Ljava/lang/String;[I[Ljava/lang/String;[I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;I[Ljava/lang/String;[II[Ljava/lang/String;[I)V
    ...
    .line 176
    invoke-direct {p0, p4, p5, p7, p8}, init([Ljava/lang/String;[I[Ljava/lang/String;[I)V
...
.method private bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;[I[I)V
    ...
    .prologue
    .line 213
    iget-object v0, p0, mViewBinder:Landroid/widget/SimpleCursorTreeAdapter$ViewBinder;
    ...
    invoke-virtual {p0, v4, v3}, setViewText(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    .end local v4    # "v":Landroid/view/View;
    invoke-virtual {p0, v4, v3}, setViewImage(Landroid/widget/ImageView;Ljava/lang/String;)V
...
.method private init([Ljava/lang/String;[I[Ljava/lang/String;[I)V
    ...
    .prologue
    .line 182
    iput-object p1, p0, mGroupFromNames:[Ljava/lang/String;

    .line 183
    iput-object p2, p0, mGroupTo:[I

    .line 185
    iput-object p3, p0, mChildFromNames:[Ljava/lang/String;

    .line 186
    iput-object p4, p0, mChildTo:[I
...
.method protected bindChildView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    .prologue
    .line 249
    iget-object v0, p0, mChildFrom:[I

    if-nez v0, :cond_12

    .line 250
    iget-object v0, p0, mChildFromNames:[Ljava/lang/String;

    array-length v0, v0

    new-array v0, v0, [I

    iput-object v0, p0, mChildFrom:[I

    .line 251
    iget-object v0, p0, mChildFromNames:[Ljava/lang/String;

    iget-object v1, p0, mChildFrom:[I

    invoke-direct {p0, p3, v0, v1}, initFromColumns(Landroid/database/Cursor;[Ljava/lang/String;[I)V

    .line 254
    :cond_12
    iget-object v4, p0, mChildFrom:[I

    iget-object v5, p0, mChildTo:[I
    ...
    invoke-direct/range {v0 .. v5}, bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;[I[I)V
...
.method protected bindGroupView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    .prologue
    .line 259
    iget-object v0, p0, mGroupFrom:[I

    if-nez v0, :cond_12

    .line 260
    iget-object v0, p0, mGroupFromNames:[Ljava/lang/String;

    array-length v0, v0

    new-array v0, v0, [I

    iput-object v0, p0, mGroupFrom:[I

    .line 261
    iget-object v0, p0, mGroupFromNames:[Ljava/lang/String;

    iget-object v1, p0, mGroupFrom:[I

    invoke-direct {p0, p3, v0, v1}, initFromColumns(Landroid/database/Cursor;[Ljava/lang/String;[I)V

    .line 264
    :cond_12
    iget-object v4, p0, mGroupFrom:[I

    iget-object v5, p0, mGroupTo:[I
...
.method public setViewBinder(Landroid/widget/SimpleCursorTreeAdapter$ViewBinder;)V
    ...
    .prologue
    .line 209
    iput-object p1, p0, mViewBinder:Landroid/widget/SimpleCursorTreeAdapter$ViewBinder;
