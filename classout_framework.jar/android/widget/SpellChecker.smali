...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v1, p0, mSpellParsers:[Landroid/widget/SpellChecker$SpellParser;

    .line 88
    iput v2, p0, mSpanSequenceCounter:I
    ...
    iput-object v1, p0, mSuggestionSpanCache:Landroid/util/LruCache;
    ...
    iput-object v1, p0, mIds:[I

    .line 110
    iget-object v1, p0, mIds:[I

    array-length v1, v1

    new-array v1, v1, [Landroid/text/style/SpellCheckSpan;

    iput-object v1, p0, mSpellCheckSpans:[Landroid/text/style/SpellCheckSpan;
    ...
    invoke-direct {p0, v1}, setLocale(Ljava/util/Locale;)V
...
.method static synthetic access$100(Landroid/widget/SpellChecker;)[Landroid/widget/SpellChecker$SpellParser;
    ...
    .prologue
    .line 48
    iget-object v0, p0, mSpellParsers:[Landroid/widget/SpellChecker$SpellParser;
...
.method static synthetic access$400(Landroid/widget/SpellChecker;)Z
    ...
    .prologue
    .line 48
    iget-boolean v0, p0, mIsSentenceSpellCheckSupported:Z
...
.method static synthetic access$700(Landroid/widget/SpellChecker;)[Landroid/text/style/SpellCheckSpan;
    ...
    .prologue
    .line 48
    iget-object v0, p0, mSpellCheckSpans:[Landroid/text/style/SpellCheckSpan;
...
.method static synthetic access$900(Landroid/widget/SpellChecker;Landroid/text/Editable;II)V
    ...
    .prologue
    .line 48
    invoke-direct {p0, p1, p2, p3}, addSpellCheckSpan(Landroid/text/Editable;II)V
...
.method private addSpellCheckSpan(Landroid/text/Editable;II)V
    ...
    .prologue
    .line 195
    invoke-direct {p0}, nextSpellCheckSpanIndex()I

    move-result v0

    .line 196
    .local v0, "index":I
    iget-object v2, p0, mSpellCheckSpans:[Landroid/text/style/SpellCheckSpan;
    ...
    .line 199
    iget-object v2, p0, mIds:[I

    iget v3, p0, mSpanSequenceCounter:I

    add-int/lit8 v4, v3, 0x1

    iput v4, p0, mSpanSequenceCounter:I
...
.method private createMisspelledSuggestionSpan(Landroid/text/Editable;Landroid/view/textservice/SuggestionsInfo;Landroid/text/style/SpellCheckSpan;II)V
    ...
    iget-boolean v12, p0, mIsSentenceSpellCheckSupported:Z
    ...
    iget-object v12, p0, mSuggestionSpanCache:Landroid/util/LruCache;
...
.method private isSessionActive()Z
    ...
    .prologue
    .line 164
    iget-object v0, p0, mSpellCheckerSession:Landroid/view/textservice/SpellCheckerSession;
...
.method private nextSpellCheckSpanIndex()I
    ...
    .line 188
    iget-object v1, p0, mSpellCheckSpans:[Landroid/text/style/SpellCheckSpan;
...
.method private onGetSuggestionsInternal(Landroid/view/textservice/SuggestionsInfo;II)Landroid/text/style/SpellCheckSpan;
    ...
    iget-object v2, v0, mTextView:Landroid/widget/TextView;
    ...
    iget v2, v0, mLength:I

    if-ge v11, v2, :cond_a5

    .line 331
    move-object/from16 v0, p0

    iget-object v2, v0, mIds:[I
    ...
    iget-object v2, v0, mSpellCheckSpans:[Landroid/text/style/SpellCheckSpan;
    ...
    .line 342
    invoke-direct/range {v2 .. v7}, createMisspelledSuggestionSpan(Landroid/text/Editable;Landroid/view/textservice/SuggestionsInfo;Landroid/text/style/SpellCheckSpan;II)V
    ...
    iget-boolean v2, v0, mIsSentenceSpellCheckSupported:Z
    ...
    iget-object v2, v0, mSuggestionSpanCache:Landroid/util/LruCache;
...
.method private resetSession()V
    ...
    .line 118
    invoke-virtual {p0}, closeSession()V
    ...
    iput-object v1, p0, mTextServicesManager:Landroid/view/textservice/TextServicesManager;

    .line 122
    iget-object v1, p0, mTextServicesManager:Landroid/view/textservice/TextServicesManager;
    ...
    .line 125
    :cond_2b
    iput-object v5, p0, mSpellCheckerSession:Landroid/view/textservice/SpellCheckerSession;
    ...
    iput-object v1, p0, mSpellCheckerSession:Landroid/view/textservice/SpellCheckerSession;

    .line 131
    iput-boolean v4, p0, mIsSentenceSpellCheckSupported:Z
    ...
    .line 142
    iget-object v1, p0, mSuggestionSpanCache:Landroid/util/LruCache;
...
.method private scheduleNewSpellCheck()V
    ...
    .prologue
    .line 432
    iget-object v0, p0, mSpellRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mSpellRunnable:Ljava/lang/Runnable;

    .line 450
    :goto_b
    iget-object v0, p0, mTextView:Landroid/widget/TextView;

    iget-object v1, p0, mSpellRunnable:Ljava/lang/Runnable;
...
.method private setLocale(Ljava/util/Locale;)V
    ...
    .line 148
    invoke-direct {p0}, resetSession()V
...
.method private spellCheck()V
    ...
    iget-object v5, v0, mSpellCheckerSession:Landroid/view/textservice/SpellCheckerSession;
    ...
    iget-object v5, v0, mTextView:Landroid/widget/TextView;
    ...
    iget-object v5, v0, mSpellCheckSpans:[Landroid/text/style/SpellCheckSpan;
    ...
    iget-boolean v5, v0, mIsSentenceSpellCheckSupported:Z
    ...
    if-le v10, v3, :cond_5f

    if-le v11, v4, :cond_82
    ...
    iget v5, v0, mCookie:I

    move-object/from16 v0, p0

    iget-object v6, v0, mIds:[I
    ...
    if-lt v10, v3, :cond_8a

    if-le v11, v4, :cond_8c
...
.method public closeSession()V
    ...
    .prologue
    .line 168
    iget-object v2, p0, mSpellCheckerSession:Landroid/view/textservice/SpellCheckerSession;
    ...
    .line 172
    :cond_9
    iget-object v2, p0, mSpellParsers:[Landroid/widget/SpellChecker$SpellParser;
    ...
    .line 177
    :cond_19
    iget-object v2, p0, mSpellRunnable:Ljava/lang/Runnable;
    ...
    iget-object v3, p0, mSpellRunnable:Ljava/lang/Runnable;
...
.method public onGetSentenceSuggestions([Landroid/view/textservice/SentenceSuggestionsInfo;)V
    ...
    .line 412
    .local v3, "length":I
    invoke-direct {p0, v8, v4, v3}, onGetSuggestionsInternal(Landroid/view/textservice/SuggestionsInfo;II)Landroid/text/style/SpellCheckSpan;
    ...
    :cond_3c
    invoke-direct {p0}, scheduleNewSpellCheck()V
...
.method public onGetSuggestions([Landroid/view/textservice/SuggestionsInfo;)V
    ...
    invoke-direct {p0, v3, v4, v4}, onGetSuggestionsInternal(Landroid/view/textservice/SuggestionsInfo;II)Landroid/text/style/SpellCheckSpan;
...
.method public spellCheck(II)V
    ...
    invoke-direct {p0}, isSessionActive()Z
    ...
    iget-object v7, p0, mCurrentLocale:Ljava/util/Locale;
    ...
    .line 223
    :cond_19
    invoke-direct {p0, v3}, setLocale(Ljava/util/Locale;)V
    ...
    .line 228
    :cond_2a
    iget-object v7, p0, mTextServicesManager:Landroid/view/textservice/TextServicesManager;
    ...
    :cond_36
    iget-object v7, p0, mSpellParsers:[Landroid/widget/SpellChecker$SpellParser;
    ...
    .line 253
    iput-object v4, p0, mSpellParsers:[Landroid/widget/SpellChecker$SpellParser;
