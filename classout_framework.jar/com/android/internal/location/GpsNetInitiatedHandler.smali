...
.method public constructor <init>(Landroid/content/Context;Landroid/location/INetInitiatedListener;Z)V
    ...
    .line 104
    iput-boolean v2, p0, mPlaySounds:Z

    .line 105
    const/4 v1, 0x1

    iput-boolean v1, p0, mPopupImmediately:Z

    .line 114
    iput-boolean v2, p0, mIsLocationEnabled:Z
    ...
    iput-object v1, p0, mBroadcastReciever:Landroid/content/BroadcastReceiver;
    ...
    .line 185
    :cond_1f
    iput-object p2, p0, mNetInitiatedListener:Landroid/location/INetInitiatedListener;

    .line 188
    invoke-virtual {p0, p3}, setSuplEsEnabled(Z)V
    ...
    iput-object v1, p0, mLocationManager:Landroid/location/LocationManager;

    .line 190
    invoke-virtual {p0}, updateLocationMode()V
    ...
    iget-object v2, p0, mBroadcastReciever:Landroid/content/BroadcastReceiver;
...
.method private static decodeString(Ljava/lang/String;ZI)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, stringToByteArray(Ljava/lang/String;Z)[B
    ...
    .line 545
    :pswitch_2d
    invoke-static {v1}, decodeGSMPackedString([B)Ljava/lang/String;
    ...
    .line 549
    :pswitch_32
    invoke-static {v1}, decodeUTF8String([B)Ljava/lang/String;
    ...
    .line 553
    :pswitch_37
    invoke-static {v1}, decodeUCS2String([B)Ljava/lang/String;
...
.method private static getDialogMessage(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 601
    invoke-static {p0, p1}, getNotifMessage(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
...
.method public static getDialogTitle(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 595
    invoke-static {p0, p1}, getNotifTitle(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
...
.method private getDlgIntent(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)Landroid/content/Intent;
    ...
    invoke-static {p1, v3}, getDialogTitle(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p1, v3}, getDialogMessage(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
...
.method private handleNi(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
    ...
    iget-boolean v3, p0, mPopupImmediately:Z
    ...
    invoke-virtual {p0}, getInEmergency()Z
    ...
    .line 291
    invoke-virtual {p0}, getLocationEnabled()Z
    ...
    :try_end_60
    .catch Landroid/os/RemoteException; {:try_start_58 .. :try_end_60} :catch_80
    ...
    iget-boolean v1, p0, mPopupImmediately:Z

    if-eqz v1, :cond_89

    .line 306
    invoke-direct {p0, p1}, openNiDialog(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
    ...
    invoke-interface {v1, v2, v3}, Landroid/location/INetInitiatedListener;->sendNiResponse(II)Z
    :try_end_7f
    .catch Landroid/os/RemoteException; {:try_start_77 .. :try_end_7f} :catch_8d
    ...
    :cond_89
    invoke-direct {p0, p1}, setNiNotification(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
...
.method private handleNiInEs(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
    ...
    :try_end_3a
    .catch Landroid/os/RemoteException; {:try_start_32 .. :try_end_3a} :catch_3d
    ...
    .end local v0    # "e":Landroid/os/RemoteException;
    :cond_46
    invoke-direct {p0, p1}, handleNi(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
...
.method private openNiDialog(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
    ...
    .prologue
    .line 402
    invoke-direct {p0, p1}, getDlgIntent(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)Landroid/content/Intent;
...
.method private declared-synchronized setNiNotification(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
    ...
    invoke-static {p1, v5}, getNotifTitle(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p1, v5}, getNotifMessage(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 371
    iget-object v5, p0, mNiNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iput-object v5, p0, mNiNotificationBuilder:Landroid/app/Notification$Builder;

    .line 381
    :cond_80
    iget-boolean v5, p0, mPlaySounds:Z
    ...
    .line 388
    :goto_8a
    iget-boolean v5, p0, mPopupImmediately:Z
    ...
    invoke-static {p1, v6}, getNotifTicker(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v7, p0, mNiNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    :try_end_bf
    .catchall {:try_start_10 .. :try_end_bf} :catchall_c1
    ...
    invoke-direct {v0}, Landroid/content/Intent;-><init>()V
    :try_end_d0
    .catchall {:try_start_c4 .. :try_end_d0} :catchall_c1
...
.method public getInEmergency()Z
    ...
    iget-boolean v1, p0, mIsInEmergency:Z
...
.method public getLocationEnabled()Z
    ...
    .prologue
    .line 231
    iget-boolean v0, p0, mIsLocationEnabled:Z
...
.method public getSuplEsEnabled()Z
    ...
    .prologue
    .line 217
    iget-boolean v0, p0, mIsSuplEsEnabled:Z
...
.method public handleNiNotification(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
    ...
    invoke-virtual {p0}, getSuplEsEnabled()Z
    ...
    .line 264
    invoke-direct {p0, p1}, handleNiInEs(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
...
.method public setInEmergency(Z)V
    ...
    .prologue
    .line 244
    iput-boolean p1, p0, mIsInEmergency:Z
...
.method public setSuplEsEnabled(Z)V
    ...
    .prologue
    .line 213
    iput-boolean p1, p0, mIsSuplEsEnabled:Z
...
.method public updateLocationMode()V
    ...
    iput-boolean v0, p0, mIsLocationEnabled:Z
