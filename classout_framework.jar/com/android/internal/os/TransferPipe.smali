...
.method public constructor <init>()V
    ...
    iput-object v0, p0, mFds:[Landroid/os/ParcelFileDescriptor;
...
.method static go(Lcom/android/internal/os/TransferPipe$Caller;Landroid/os/IInterface;Ljava/io/FileDescriptor;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-static/range {v1 .. v7}, go(Lcom/android/internal/os/TransferPipe$Caller;Landroid/os/IInterface;Ljava/io/FileDescriptor;Ljava/lang/String;[Ljava/lang/String;J)V
...
.method static go(Lcom/android/internal/os/TransferPipe$Caller;Landroid/os/IInterface;Ljava/io/FileDescriptor;Ljava/lang/String;[Ljava/lang/String;J)V
    ...
    :try_start_11
    invoke-virtual {v0}, getWriteFd()Landroid/os/ParcelFileDescriptor;
    ...
    .line 92
    invoke-virtual {v0, p2, p5, p6}, go(Ljava/io/FileDescriptor;J)V
    :try_end_1f
    .catchall {:try_start_11 .. :try_end_1f} :catchall_23

    .line 94
    invoke-virtual {v0}, kill()V
...
.method static goDump(Landroid/os/IBinder;Ljava/io/FileDescriptor;[Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, p2, v0, v1}, goDump(Landroid/os/IBinder;Ljava/io/FileDescriptor;[Ljava/lang/String;J)V
...
.method static goDump(Landroid/os/IBinder;Ljava/io/FileDescriptor;[Ljava/lang/String;J)V
    ...
    .line 117
    invoke-virtual {v0, p1, p3, p4}, go(Ljava/io/FileDescriptor;J)V
    :try_end_1b
...
.method closeFd(I)V
    ...
    .prologue
    .line 166
    iget-object v0, p0, mFds:[Landroid/os/ParcelFileDescriptor;
...
.method public go(Ljava/io/FileDescriptor;)V
    ...
    invoke-virtual {p0, p1, v0, v1}, go(Ljava/io/FileDescriptor;J)V
...
.method public go(Ljava/io/FileDescriptor;J)V
    ...
    .line 130
    :try_start_1
    iput-object p1, p0, mOutFd:Ljava/io/FileDescriptor;
    ...
    invoke-virtual {p0, v2}, closeFd(I)V
    ...
    .line 141
    :goto_13
    iget-object v2, p0, mFailure:Ljava/lang/String;

    if-nez v2, :cond_44

    iget-boolean v2, p0, mComplete:Z

    if-nez v2, :cond_44

    .line 142
    iget-wide v2, p0, mEndTime:J
    ...
    iget-object v3, p0, mFailure:Ljava/lang/String;
...
.method public kill()V
    ...
    :try_start_2
    invoke-virtual {p0, v0}, closeFd(I)V
...
.method public run()V
    ...
    .line 190
    :try_start_7
    invoke-virtual {p0}, getReadFd()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v10, p0, mOutFd:Ljava/io/FileDescriptor;
    ...
    iget-object v10, p0, mBufferPrefix:Ljava/lang/String;
    ...
    iput-object v10, p0, mFailure:Ljava/lang/String;
    ...
    :cond_7f
    iget-object v10, p0, mThread:Ljava/lang/Thread;
    ...
    :try_start_89
    iput-boolean v10, p0, mComplete:Z
...
.method public setBufferPrefix(Ljava/lang/String;)V
    ...
    .prologue
    .line 70
    iput-object p1, p0, mBufferPrefix:Ljava/lang/String;
