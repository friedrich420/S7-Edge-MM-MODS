...
.method public constructor <init>()V
    ...
    iput-object v0, p0, scLock:Ljava/lang/Object;

    .line 43
    const/4 v0, 0x0

    iput-boolean v0, p0, isInitiated:Z

    .line 76
    invoke-direct {p0}, pscsPowerup()V
...
.method private connectToRIL()I
    ...
    invoke-virtual {v1, v7}, Ljava/io/DataOutputStream;->writeByte(I)V
    :try_end_41
    .catch Ljava/io/IOException; {:try_start_17 .. :try_end_41} :catch_71
    ...
    .line 195
    .local v4, "response":[B
    invoke-direct {p0}, getTelephonyService()Lcom/android/internal/telephony/ITelephony;
    ...
    invoke-virtual {v7, v8}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
    :try_end_60
    .catch Ljava/lang/Exception; {:try_start_42 .. :try_end_60} :catch_7a
    ...
    invoke-virtual {v1, v7}, Ljava/io/DataOutputStream;->writeByte(I)V
    :try_end_70
    .catch Ljava/io/IOException; {:try_start_69 .. :try_end_70} :catch_71
    ...
    invoke-virtual {v0}, Ljava/io/ByteArrayOutputStream;->close()V
    :try_end_8c
    .catch Ljava/io/IOException; {:try_start_84 .. :try_end_8c} :catch_8d
...
.method private pscsPowerup()V
    ...
    invoke-static {v6}, bytesToHexString([B)Ljava/lang/String;
    ...
    iput-object v7, p0, _atr:[B

    .line 104
    const/4 v7, 0x2

    iget-object v8, p0, _atr:[B
    ...
    iput-boolean v7, p0, isInitiated:Z
    :try_end_79
    ...
    .line 108
    iput-boolean v10, p0, isInitiated:Z
...
.method public connect()I
    ...
    .line 144
    .local v0, "logiCh":I
    iget-boolean v1, p0, isInitiated:Z
    ...
    iput-boolean v1, p0, isInitiated:Z
    ...
    .line 151
    invoke-direct {p0}, connectToRIL()I
    ...
    invoke-direct {p0, v1}, disconnectFromRIL(I)I
...
.method public disconnect(I)I
    ...
    .line 296
    invoke-direct {p0, p1}, disconnectFromRIL(I)I
...
.method public finalize()V
    ...
    .prologue
    .line 123
    invoke-direct {p0}, pcscPowerdown()V
...
.method public transmit(I[B[B)I
    ...
    .line 241
    :cond_8
    invoke-direct {p0, p1, p2, p3}, transmitToRIL(I[B[B)I
