...
.method static constructor <clinit>()V
    ...
    sput-object v0, sStack:Ljava/util/Stack;
...
.method static synthetic access$100(Landroid/os/Messenger;Landroid/os/Message;)Landroid/os/Message;
    ...
    .prologue
    .line 740
    invoke-static {p0, p1}, sendMessageSynchronously(Landroid/os/Messenger;Landroid/os/Message;)Landroid/os/Message;
...
.method private static obtain()Lcom/android/internal/util/AsyncChannel$SyncMessenger;
    ...
    .prologue
    .line 784
    sget-object v2, sStack:Ljava/util/Stack;

    monitor-enter v2

    .line 785
    :try_start_3
    sget-object v1, sStack:Ljava/util/Stack;
    ...
    iput-object v1, v0, mHandlerThread:Landroid/os/HandlerThread;

    .line 788
    iget-object v1, v0, mHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v1, v0, mHandler:Lcom/android/internal/util/AsyncChannel$SyncMessenger$SyncHandler;

    .line 790
    new-instance v1, Landroid/os/Messenger;

    iget-object v3, v0, mHandler:Lcom/android/internal/util/AsyncChannel$SyncMessenger$SyncHandler;

    invoke-direct {v1, v3}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v1, v0, mMessenger:Landroid/os/Messenger;
...
.method private recycle()V
    ...
    .line 803
    :try_start_3
    sget-object v0, sStack:Ljava/util/Stack;
...
.method private static sendMessageSynchronously(Landroid/os/Messenger;Landroid/os/Message;)Landroid/os/Message;
    ...
    .line 814
    invoke-static {}, obtain()Lcom/android/internal/util/AsyncChannel$SyncMessenger;
    ...
    .line 817
    :try_start_9
    iget-object v3, v2, mMessenger:Landroid/os/Messenger;

    iput-object v3, p1, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    .line 818
    iget-object v3, v2, mHandler:Lcom/android/internal/util/AsyncChannel$SyncMessenger$SyncHandler;
