...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v1, p0, mPositionIconAvailable:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, mPositionIconOutput:Landroid/graphics/Rect;
...
.method private positionIcon()V
    ...
    .line 284
    :cond_6
    iget-object v6, p0, mPositionIconOutput:Landroid/graphics/Rect;

    .line 285
    .local v6, "tmpRect":Landroid/graphics/Rect;
    invoke-virtual {p0, v3, v6}, getLineBounds(ILandroid/graphics/Rect;)I

    .line 286
    iget-object v0, p0, mPositionIconAvailable:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, mPositionIconAvailable:Landroid/graphics/Rect;

    iget-object v4, p0, mPositionIconOutput:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, mPositionIconOutput:Landroid/graphics/Rect;
...
.method getTextAppropriateLayoutParams()Lcom/android/internal/view/menu/IconMenuView$LayoutParams;
    ...
    invoke-virtual {p0}, getPaint()Landroid/text/TextPaint;
...
.method public initialize(Lcom/android/internal/view/menu/MenuItemImpl;I)V
    ...
    invoke-virtual {p0, v0, v1}, initialize(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)V
...
.method initialize(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 102
    iget-object v0, p0, mTextAppearanceContext:Landroid/content/Context;

    iget v1, p0, mTextAppearance:I

    invoke-virtual {p0, v0, v1}, setTextAppearance(Landroid/content/Context;I)V

    .line 105
    :cond_13
    invoke-virtual {p0, p1}, setTitle(Ljava/lang/CharSequence;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 244
    invoke-direct {p0}, positionIcon()V
...
.method protected onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    .line 252
    invoke-virtual {p0}, getTextAppropriateLayoutParams()Lcom/android/internal/view/menu/IconMenuView$LayoutParams;
...
.method public performClick()Z
    ...
    .line 129
    :cond_9
    iget-object v2, p0, mItemInvoker:Lcom/android/internal/view/menu/MenuBuilder$ItemInvoker;
...
.method setCaptionMode(Z)V
    ...
    :goto_10
    iput-boolean v1, p0, mShortcutCaptionMode:Z
    ...
    iget-boolean v1, p0, mShortcutCaptionMode:Z

    if-eqz v1, :cond_2a

    .line 167
    iget-object v1, p0, mShortcutCaption:Ljava/lang/String;
    ...
    iput-object v1, p0, mShortcutCaption:Ljava/lang/String;

    .line 171
    :cond_28
    iget-object v0, p0, mShortcutCaption:Ljava/lang/String;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 186
    invoke-virtual {p0, v2, p1, v2, v2}, setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 198
    :cond_1d
    invoke-virtual {p0, v2, v2, v2, v2}, setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method setIconMenuView(Lcom/android/internal/view/menu/IconMenuView;)V
    ...
    .prologue
    .line 225
    iput-object p1, p0, mIconMenuView:Lcom/android/internal/view/menu/IconMenuView;
...
.method public setShortcut(ZC)V
    ...
    .prologue
    .line 302
    iget-boolean v0, p0, mShortcutCaptionMode:Z
    ...
    iput-object v0, p0, mShortcutCaption:Ljava/lang/String;

    .line 308
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, setCaptionMode(Z)V
...
.method public setVisibility(I)V
    ...
    .line 218
    iget-object v0, p0, mIconMenuView:Lcom/android/internal/view/menu/IconMenuView;
