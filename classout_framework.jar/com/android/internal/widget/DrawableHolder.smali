...
.method static constructor <clinit>()V
    ...
    sput-object v0, EASE_OUT_INTERPOLATOR:Landroid/view/animation/DecelerateInterpolator;
...
.method public constructor <init>(Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    .line 48
    invoke-direct {p0, p1, v0, v0}, <init>(Landroid/graphics/drawable/BitmapDrawable;FF)V
...
.method public constructor <init>(Landroid/graphics/drawable/BitmapDrawable;FF)V
    ...
    .line 40
    iput v0, p0, mScaleX:F

    .line 41
    iput v0, p0, mScaleY:F
    ...
    iput-object v0, p0, mNeedToStart:Ljava/util/ArrayList;

    .line 52
    iput-object p1, p0, mDrawable:Landroid/graphics/drawable/BitmapDrawable;
    ...
    .line 55
    iget-object v0, p0, mDrawable:Landroid/graphics/drawable/BitmapDrawable;
    ...
    iget-object v1, p0, mDrawable:Landroid/graphics/drawable/BitmapDrawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/BitmapDrawable;->getIntrinsicWidth()I

    move-result v1

    iget-object v2, p0, mDrawable:Landroid/graphics/drawable/BitmapDrawable;
...
.method private addAnimation(Landroid/animation/ObjectAnimator;Z)Lcom/android/internal/widget/DrawableHolder;
    ...
    .line 117
    iget-object v0, p0, mAnimators:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 118
    :cond_7
    iget-object v0, p0, mNeedToStart:Ljava/util/ArrayList;
...
.method public addAnimTo(JJLjava/lang/String;FZ)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {p0, p5}, removeAnimationFor(Ljava/lang/String;)V
    ...
    .line 78
    sget-object v1, EASE_OUT_INTERPOLATOR:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {v0, v1}, Landroid/animation/ObjectAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    .line 79
    invoke-direct {p0, v0, p7}, addAnimation(Landroid/animation/ObjectAnimator;Z)Lcom/android/internal/widget/DrawableHolder;
...
.method public clearAnimations()V
    ...
    .prologue
    .line 102
    iget-object v2, p0, mAnimators:Ljava/util/ArrayList;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 133
    iget v1, p0, mScaleX:F

    iget v2, p0, mScaleY:F
...
.method public startAnimations(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    .local v1, "i":I
    :goto_1
    iget-object v2, p0, mNeedToStart:Ljava/util/ArrayList;
