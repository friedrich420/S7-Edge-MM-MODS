...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v7, p0, mLineBounds:Landroid/graphics/RectF;
    ...
    iput-object v7, p0, mText:Ljava/lang/StringBuilder;

    .line 73
    const/high16 v7, 0x3f800000    # 1.0f

    iput v7, p0, mSpacingMult:F

    .line 74
    const/4 v7, 0x0

    iput v7, p0, mSpacingAdd:F

    .line 75
    const/4 v7, 0x0

    iput v7, p0, mInnerPaddingX:I
    ...
    iput v7, p0, mShadowOffsetX:F

    .line 125
    iget v7, p0, mShadowOffsetX:F

    iput v7, p0, mShadowOffsetY:F
    ...
    iput-object v7, p0, mTextPaint:Landroid/text/TextPaint;
    ...
    iput-object v7, p0, mPaint:Landroid/graphics/Paint;

    .line 132
    iget-object v7, p0, mPaint:Landroid/graphics/Paint;

    invoke-virtual {v7, v8}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    .line 134
    invoke-virtual {p0, v5}, setText(Ljava/lang/CharSequence;)V

    .line 135
    int-to-float v7, v6

    invoke-virtual {p0, v7}, setTextSize(F)V
...
.method private computeMeasurements(I)Z
    ...
    .line 242
    iget-boolean v0, p0, mHasMeasurements:Z

    if-eqz v0, :cond_a

    iget v0, p0, mLastMeasuredWidth:I
    ...
    .line 256
    :cond_1a
    iput-boolean v7, p0, mHasMeasurements:Z

    .line 257
    iput p1, p0, mLastMeasuredWidth:I

    .line 258
    new-instance v0, Landroid/text/StaticLayout;

    iget-object v1, p0, mText:Ljava/lang/StringBuilder;

    iget-object v2, p0, mTextPaint:Landroid/text/TextPaint;

    iget-object v4, p0, mAlignment:Landroid/text/Layout$Alignment;

    iget v5, p0, mSpacingMult:F

    iget v6, p0, mSpacingAdd:F

    move v3, p1

    invoke-direct/range {v0 .. v7}, Landroid/text/StaticLayout;-><init>(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;FFZ)V

    iput-object v0, p0, mLayout:Landroid/text/StaticLayout;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v11, v0, mLayout:Landroid/text/StaticLayout;
    ...
    iget-object v14, v0, mPaint:Landroid/graphics/Paint;

    .line 303
    .local v14, "paint":Landroid/graphics/Paint;
    move-object/from16 v0, p0

    iget-object v4, v0, mLineBounds:Landroid/graphics/RectF;

    .line 305
    .local v4, "bounds":Landroid/graphics/RectF;
    move-object/from16 v0, p0

    iget v0, v0, mBackgroundColor:I
    ...
    iget v0, v0, mShadowOffsetX:F

    move/from16 v20, v0

    move-object/from16 v0, p0

    iget v0, v0, mShadowOffsetY:F
...
.method public onLayout(ZIIII)V
    ...
    .line 238
    .local v0, "width":I
    invoke-direct {p0, v0}, computeMeasurements(I)Z
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, v4}, computeMeasurements(I)Z
    ...
    .line 222
    iget-object v1, p0, mLayout:Landroid/text/StaticLayout;
    ...
    .line 230
    :cond_2e
    invoke-virtual {p0, v6, v6}, setMeasuredDimension(II)V
...
.method public setAlignment(Landroid/text/Layout$Alignment;)V
    ...
    iput-boolean v0, p0, mHasMeasurements:Z
...
.method public setStyle(I)V
    ...
    :goto_35
    iput v5, p0, mEdgeColor:I

    .line 281
    const/4 v5, 0x0

    iput-boolean v5, p0, mHasMeasurements:Z
    ...
    invoke-virtual {p0, v4}, setTypeface(Landroid/graphics/Typeface;)V
...
.method public setText(Ljava/lang/CharSequence;)V
    ...
    .line 144
    iget-object v0, p0, mText:Ljava/lang/StringBuilder;
    ...
    .line 147
    iput-boolean v1, p0, mHasMeasurements:Z
