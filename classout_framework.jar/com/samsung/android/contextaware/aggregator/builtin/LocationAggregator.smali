...
.method public constructor <init>(ILjava/util/concurrent/CopyOnWriteArrayList;Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/ISensorHubResetObservable;)V
    ...
    iput-boolean v0, p0, mApdrNoti:Z
...
.method private receiveApdrNoti(Landroid/os/Bundle;)V
    ...
    .line 522
    :cond_f
    iput-boolean v2, p0, mApdrNoti:Z
...
.method private requestGpsData(JJ)V
    ...
    iget v11, v0, mPedestrianStatus:I
    ...
    invoke-direct/range {v3 .. v11}, notifyLocationContext(JJ[D[FZI)V
    ...
    invoke-direct/range {v11 .. v22}, setCurLocationforHubApdr(JJDDDF)V
...
.method private sendSleepModeCmdToSensorHub()V
    ...
    invoke-virtual {p0, v9}, getSubCollectionObj(Ljava/lang/String;)Lcom/samsung/android/contextaware/manager/ContextComponent;
    ...
    iput-wide v10, p0, mCurLatitude:D

    .line 270
    const-wide/high16 v10, 0x4060000000000000L    # 128.0

    iput-wide v10, p0, mCurLongitude:D

    .line 271
    const-wide/16 v10, 0x0

    iput-wide v10, p0, mCurAltitude:D

    .line 272
    const/high16 v9, 0x41200000    # 10.0f

    iput v9, p0, mCurAccuracy:F

    .line 274
    iget-wide v10, p0, mCurLatitude:D
    ...
    .line 276
    .local v5, "latBuf":[B
    iget-wide v10, p0, mCurLongitude:D
    ...
    .line 278
    .local v6, "longBuf":[B
    iget-wide v10, p0, mCurAltitude:D
    ...
    iget v9, p0, mUserWantedAccuracy:I
...
.method private setCurLocationforHubApdr(JJDDDF)V
    ...
    .prologue
    .line 624
    iput-wide p1, p0, mCurSysTime:J

    .line 625
    iput-wide p3, p0, mCurTimeStamp:J

    .line 626
    iput-wide p5, p0, mCurLatitude:D

    .line 627
    iput-wide p7, p0, mCurLongitude:D

    .line 628
    iput-wide p9, p0, mCurAltitude:D

    .line 629
    iput p11, p0, mCurAccuracy:F
...
.method private updateApdrData(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 458
    invoke-direct {p0}, isFilterInitialized()Z
    ...
    iput-wide v4, p0, mCurSysTime:J

    .line 463
    iget-wide v4, p0, mCurTimeStamp:J
    ...
    iput-wide v4, p0, mCurTimeStamp:J

    .line 469
    invoke-static {}, Lcom/samsung/android/contextaware/utilbundle/logger/CaLogger;->trace()V

    .line 471
    iget-wide v0, p0, mCurSysTime:J

    .line 472
    .local v0, "systemTime":J
    iget-wide v2, p0, mCurTimeStamp:J

    .line 483
    .local v2, "timeStamp":J
    invoke-direct {p0, v0, v1, v2, v3}, requestGpsData(JJ)V
...
.method private updateRawSatelliteData(Landroid/os/Bundle;)V
    ...
    iget-boolean v3, p0, mApdrNoti:Z
    ...
    .line 373
    invoke-virtual {p0}, notifyApStatus()V

    .line 374
    invoke-direct {p0}, sendSleepModeCmdToSensorHub()V
...
.method public final clear()V
    ...
    .line 205
    iput-wide v2, p0, mCurSysTime:J

    .line 206
    iput-wide v2, p0, mCurTimeStamp:J

    .line 207
    iput-wide v0, p0, mCurLatitude:D

    .line 208
    iput-wide v0, p0, mCurLongitude:D

    .line 209
    iput-wide v0, p0, mCurAltitude:D

    .line 210
    const/4 v0, 0x0

    iput v0, p0, mCurAccuracy:F

    .line 213
    const/4 v0, -0x1

    iput v0, p0, mPedestrianStatus:I
    ...
    iput v0, p0, mUserWantedAccuracy:I
...
.method public final setPropertyValue(ILjava/lang/Object;)Z
    ...
    iget v1, p0, mUserWantedAccuracy:I
...
.method public final updateContext(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 677
    invoke-direct {p0, p2}, updateRawGpsData(Landroid/os/Bundle;)V
    ...
    .line 680
    invoke-direct {p0, p2}, updateRawSatelliteData(Landroid/os/Bundle;)V
    ...
    .line 682
    invoke-direct {p0, p2}, updateRawWpsData(Landroid/os/Bundle;)V
    ...
    .line 685
    invoke-direct {p0, p2}, updateApdrData(Landroid/os/Bundle;)V

    goto :goto_2

    .line 687
    :cond_4a
    invoke-direct {p0, p2}, receiveApdrNoti(Landroid/os/Bundle;)V
