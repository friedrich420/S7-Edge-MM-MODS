...
.method public constructor <init>()V
    ...
    .line 16
    iput-wide v0, p0, mOrgLat:D

    .line 17
    iput-wide v0, p0, mOrgLon:D

    .line 18
    iput-wide v0, p0, mOrgHei:D

    .line 28
    iput-boolean v2, p0, Updated:Z

    .line 29
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Capturedtime:J
    ...
    iput-object v0, p0, filteredVelocity:[D
    ...
    iput-object v0, p0, loc:Landroid/location/Location;
...
.method public constructor <init>(Landroid/location/Location;)V
    ...
    invoke-virtual/range {v1 .. v7}, setOrigin(DDD)V
...
.method public constructor <init>(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)V
    ...
    iget-object v1, p1, loc:Landroid/location/Location;
    ...
    .line 53
    invoke-virtual {p0, p1}, set(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)V
...
.method private CalCoordinate()V
    ...
    .line 176
    .local v3, "orgllh":[D
    iget-object v4, p0, loc:Landroid/location/Location;
    ...
    iput-wide v4, p0, mPosEast:D

    .line 185
    aget-wide v4, v1, v7

    iput-wide v4, p0, mPosNorth:D

    .line 186
    aget-wide v4, v1, v8

    iput-wide v4, p0, mPosUp:D
    ...
    iput-wide v4, p0, mPosECEF_X:D

    .line 190
    aget-wide v4, v0, v7

    iput-wide v4, p0, mPosECEF_Y:D

    .line 191
    aget-wide v4, v0, v8

    iput-wide v4, p0, mPosECEF_Z:D
...
.method public PosPropation(DD)V
    ...
    .prologue
    .line 197
    iget-boolean v7, p0, Updated:Z

    if-eqz v7, :cond_7

    .line 198
    invoke-direct {p0}, CalCoordinate()V
    ...
    iget-wide v8, p0, mPosEast:D

    mul-double v10, v0, p3

    add-double/2addr v8, v10

    iput-wide v8, p0, mPosEast:D

    .line 205
    iget-wide v8, p0, mPosNorth:D

    mul-double v10, v2, p3

    add-double/2addr v8, v10

    iput-wide v8, p0, mPosNorth:D
    ...
    .line 219
    .local v5, "llh":[D
    iget-object v7, p0, loc:Landroid/location/Location;
...
.method public distanceTo(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)D
    ...
    invoke-direct {v1, p1}, <init>(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)V

    .line 275
    .local v1, "lppLoc3":Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;
    invoke-virtual {p0}, getOriginLat()D

    move-result-wide v2

    invoke-virtual {p0}, getOriginLon()D

    move-result-wide v4

    invoke-virtual {p0}, getOriginAltitude()D
    ...
    .line 276
    invoke-virtual {p0}, getPosEastLocal()D

    move-result-wide v2

    invoke-virtual {v1}, getPosEastLocal()D
    ...
    invoke-virtual {p0}, getPosNorthLocal()D

    move-result-wide v4

    invoke-virtual {v1}, getPosNorthLocal()D
...
.method public estimateVelocity(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)V
    ...
    invoke-direct {v3, v0}, <init>(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)V
    ...
    invoke-direct {v0, v1}, <init>(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)V

    .line 286
    .local v24, "lppLoc2":Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;
    invoke-virtual/range {p0 .. p0}, getLatitude()D

    move-result-wide v4

    invoke-virtual/range {p0 .. p0}, getLongitude()D

    move-result-wide v6

    invoke-virtual/range {p0 .. p0}, getAltitude()D

    move-result-wide v8

    invoke-virtual/range {v3 .. v9}, setOrigin(DDD)V
    ...
    invoke-virtual/range {v5 .. v11}, setOrigin(DDD)V

    .line 290
    invoke-virtual {v3}, getTime()J

    move-result-wide v30

    .line 291
    .local v30, "t0_long":J
    invoke-virtual/range {p0 .. p0}, getTime()J

    move-result-wide v34

    .line 292
    .local v34, "t1_long":J
    invoke-virtual/range {v24 .. v24}, getTime()J
    ...
    iget-object v4, v0, loc:Landroid/location/Location;
    ...
    iget-object v4, v0, filteredVelocity:[D
    ...
    :cond_fb
    invoke-virtual/range {v24 .. v24}, getPosEastLocal()D
    ...
    invoke-virtual {v3}, getPosEastLocal()D
    ...
    invoke-virtual/range {v24 .. v24}, getPosNorthLocal()D
    ...
    invoke-virtual {v3}, getPosNorthLocal()D
    ...
    invoke-virtual {v0, v3}, distanceTo(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)D
...
.method public getAccuracy()F
    ...
    .prologue
    .line 255
    iget-object v0, p0, loc:Landroid/location/Location;
...
.method public getFilteredVelocity()[D
    ...
    .prologue
    .line 354
    iget-object v0, p0, filteredVelocity:[D
...
.method public getSystemTime()J
    ...
    .prologue
    .line 105
    iget-wide v0, p0, Capturedtime:J
...
.method public set(Landroid/location/Location;)V
    ...
    .line 115
    invoke-virtual {p0}, setSystemTime()V
...
.method public set(Lcom/samsung/android/contextaware/aggregator/lpp/LppLocation;)V
    ...
    .line 122
    iget-object v1, p0, loc:Landroid/location/Location;

    iget-object v2, p1, loc:Landroid/location/Location;

    invoke-virtual {v1, v2}, Landroid/location/Location;->set(Landroid/location/Location;)V

    .line 123
    invoke-virtual {p1}, getOriginLat()D

    move-result-wide v2

    invoke-virtual {p1}, getOriginLon()D

    move-result-wide v4

    invoke-virtual {p1}, getOriginAltitude()D
    ...
    .line 124
    invoke-virtual {p1}, getSystemTime()J

    move-result-wide v2

    iput-wide v2, p0, Capturedtime:J

    .line 125
    invoke-virtual {p1}, getMovingStatus()I
    ...
    .line 126
    invoke-virtual {p1}, getFilteredVelocity()[D

    move-result-object v0

    .line 127
    .local v0, "filteredV":[D
    iget-object v1, p0, filteredVelocity:[D
...
.method public setOrigin(DDD)V
    ...
    .prologue
    .line 79
    iput-wide p1, p0, mOrgLat:D

    .line 80
    iput-wide p3, p0, mOrgLon:D

    .line 81
    iput-wide p5, p0, mOrgHei:D
...
.method public setPosENU(DDD)V
    ...
    .line 375
    .local v1, "llh":[D
    iget-object v3, p0, loc:Landroid/location/Location;
...
.method public setSystemTime(J)V
    ...
    .prologue
    .line 230
    iget-wide v2, p0, Capturedtime:J
    ...
    iget-wide v4, p0, Capturedtime:J
    ...
    .line 240
    :cond_5e
    iput-wide p1, p0, Capturedtime:J

    .line 241
    iget-object v2, p0, loc:Landroid/location/Location;
