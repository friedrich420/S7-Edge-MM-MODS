...
.method static constructor <clinit>()V
    ...
    sput-object v0, sContextProviderMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method protected constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/ISensorHubResetObservable;I)V
    ...
    .line 63
    invoke-static {p1}, setContext(Landroid/content/Context;)V

    .line 64
    invoke-static {p2}, setLooper(Landroid/os/Looper;)V

    .line 65
    invoke-static {p3}, setAPPowerObservable(Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/ISensorHubResetObservable;)V

    .line 66
    invoke-static {p4}, setVersion(I)V
...
.method private create(Ljava/lang/String;Z)Lcom/samsung/android/contextaware/manager/ContextComponent;
    ...
    .prologue
    .line 113
    invoke-virtual {p0, p1}, existContextProvider(Ljava/lang/String;)Z
    ...
    .line 120
    invoke-virtual {p0, p1}, getValueOfList(Ljava/lang/String;)Lcom/samsung/android/contextaware/creator/IListObjectCreator;
...
.method protected static final getApPowerObservable()Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/ISensorHubResetObservable;
    ...
    .prologue
    .line 257
    sget-object v0, sAPPowerObservable:Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/ISensorHubResetObservable;
...
.method protected static final declared-synchronized getContextProviderMap()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :try_start_3
    sget-object v1, sContextProviderMap:Ljava/util/concurrent/ConcurrentHashMap;
    :try_end_5
...
.method protected static getLooper()Landroid/os/Looper;
    ...
    .prologue
    .line 237
    sget-object v0, sLooper:Landroid/os/Looper;
...
.method protected static final removeObj(Ljava/lang/String;)Z
    ...
    .line 290
    :cond_d
    invoke-static {}, getContextProviderMap()Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static setAPPowerObservable(Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/ISensorHubResetObservable;)V
    ...
    .prologue
    .line 248
    sput-object p0, sAPPowerObservable:Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/ISensorHubResetObservable;
...
.method private static setLooper(Landroid/os/Looper;)V
    ...
    .prologue
    .line 228
    sput-object p0, sLooper:Landroid/os/Looper;
...
.method public create(Ljava/lang/String;)Lcom/samsung/android/contextaware/manager/ContextComponent;
    ...
    invoke-direct {p0, p1, v0}, create(Ljava/lang/String;Z)Lcom/samsung/android/contextaware/manager/ContextComponent;
...
.method public final varargs create(Ljava/lang/String;Z[Ljava/lang/Object;)Lcom/samsung/android/contextaware/manager/ContextComponent;
    ...
    .line 148
    :cond_e
    invoke-direct {p0, p1, p2}, create(Ljava/lang/String;Z)Lcom/samsung/android/contextaware/manager/ContextComponent;
...
.method public varargs create(Ljava/lang/String;[Ljava/lang/Object;)Lcom/samsung/android/contextaware/manager/ContextComponent;
    ...
    invoke-virtual {p0, p1, v0, p2}, create(Ljava/lang/String;Z[Ljava/lang/Object;)Lcom/samsung/android/contextaware/manager/ContextComponent;
