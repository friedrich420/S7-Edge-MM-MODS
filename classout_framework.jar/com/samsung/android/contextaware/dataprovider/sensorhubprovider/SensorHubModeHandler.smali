...
.method private parseDuplicatedMode(I[BI)I
    ...
    invoke-virtual {p0, v8}, getParserKey(I)Ljava/lang/String;
    ...
    :cond_3a
    invoke-direct {p0, p2, v5, v3}, parse([BILjava/lang/String;)I
...
.method protected final isRunning()Z
    ...
    .prologue
    .line 203
    invoke-virtual {p0}, getModeList()Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final parse([BI)I
    ...
    .line 60
    .local v5, "mode":I
    invoke-direct {p0, v5}, isDuplicatedMode(I)Z
    ...
    .line 61
    invoke-direct {p0, v5, p1, v7}, parseDuplicatedMode(I[BI)I
    ...
    .line 67
    invoke-virtual {p0, v5}, getParserKey(I)Ljava/lang/String;
    ...
    .end local v1    # "i":Lcom/samsung/android/contextaware/dataprovider/sensorhubprovider/SensorHubParserProtocol$MODE;
    :cond_49
    invoke-direct {p0, p1, v7, v3}, parse([BILjava/lang/String;)I
