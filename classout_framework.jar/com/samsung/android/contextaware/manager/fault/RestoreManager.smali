...
.method protected constructor <init>(Lcom/samsung/android/contextaware/manager/ContextManager;)V
    ...
    iput-object v0, p0, mRestoreTransaction:Ljava/util/concurrent/ConcurrentHashMap;

    .line 50
    const/4 v0, 0x0

    iput-boolean v0, p0, mIsRestore:Z

    .line 52
    iget-object v0, p0, mRestoreTransaction:Ljava/util/concurrent/ConcurrentHashMap;
...
.method protected final isRestoreEnable()Z
    ...
    .prologue
    .line 78
    iget-boolean v0, p0, mIsRestore:Z
...
.method protected final runRestore(Ljava/lang/String;Lcom/samsung/android/contextaware/manager/ContextAwareService$Listener;ILcom/samsung/android/contextaware/manager/IContextObserver;)V
    ...
    .prologue
    .line 96
    iget-boolean v2, p0, mIsRestore:Z
    ...
    .line 101
    :cond_b
    iget-object v2, p0, mRestoreTransaction:Ljava/util/concurrent/ConcurrentHashMap;
