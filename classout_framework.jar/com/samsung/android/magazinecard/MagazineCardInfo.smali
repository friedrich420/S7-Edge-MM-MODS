...
.method static constructor <clinit>()V
    ...
    .line 33
    sput v2, SECURITY_LEVEL_SECURE_MODE_ONLY:I

    .line 34
    sput v3, SECURITY_LEVEL_NON_SECURE_MODE_ONLY:I

    .line 35
    sget v0, SECURITY_LEVEL_SECURE_MODE_ONLY:I

    sget v1, SECURITY_LEVEL_NON_SECURE_MODE_ONLY:I

    or-int/2addr v0, v1

    sput v0, SECURITY_LEVEL_NORMAL:I

    .line 38
    const/4 v0, 0x0

    sput v0, CATEGORY_NONE:I

    .line 39
    sput v2, CATEGORY_WEATHER:I

    .line 40
    sput v3, CATEGORY_TODAYS_SCHEDULE:I

    .line 41
    const/4 v0, 0x4

    sput v0, CATEGORY_MUSIC_PLAYER:I

    .line 42
    const/16 v0, 0x8

    sput v0, CATEGORY_EMAIL:I

    .line 43
    const/16 v0, 0x10

    sput v0, CATEGORY_NEW_MESSAGE:I

    .line 44
    const/16 v0, 0x20

    sput v0, CATEGORY_MISSED_CALL:I

    .line 45
    const/16 v0, 0x40

    sput v0, CATEGORY_NEWS:I

    .line 46
    const/16 v0, 0x80

    sput v0, CATEGORY_SOCIAL:I

    .line 47
    const/16 v0, 0x100

    sput v0, CATEGORY_HERE_N_NOW:I

    .line 48
    const/16 v0, 0x200

    sput v0, CATEGORY_FAVORITE_APP:I

    .line 49
    const/16 v0, 0x400

    sput v0, CATEGORY_ROAMING:I

    .line 50
    const/16 v0, 0x800

    sput v0, CATEGORY_FLIGHT_MODE:I

    .line 51
    const/16 v0, 0x1000

    sput v0, CATEGORY_TODAY_BIRTHDAY:I
...
.method public constructor <init>()V
    ...
    .line 60
    iput v3, p0, mCardId:I

    .line 61
    sget v0, SECURITY_LEVEL_NORMAL:I

    iput v0, p0, mSecurityLevel:I

    .line 62
    sget v0, CATEGORY_NONE:I

    iput v0, p0, mCategory:I

    .line 63
    iput-object v2, p0, mContentView:Landroid/widget/RemoteViews;

    .line 64
    iput-object v2, p0, mExpandedContentView:Landroid/widget/RemoteViews;

    .line 65
    iput-object v2, p0, mLaunchIntent:Landroid/app/PendingIntent;
...
.method public readFromParcel(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, mExpandedContentView:Landroid/widget/RemoteViews;
    ...
    iput-object v0, p0, mLaunchIntent:Landroid/app/PendingIntent;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 151
    iget-object v0, p0, mExpandedContentView:Landroid/widget/RemoteViews;

    invoke-virtual {p1, v0, p2}, Landroid/os/Parcel;->writeParcelable(Landroid/os/Parcelable;I)V

    .line 152
    iget v0, p0, mSecurityLevel:I
