...
.method public static getInstance()Lcom/samsung/android/penselect/PenSelectionController;
    ...
    .prologue
    .line 46
    sget-object v0, sInstance:Lcom/samsung/android/penselect/PenSelectionController;
    ...
    sput-object v0, sInstance:Lcom/samsung/android/penselect/PenSelectionController;
...
.method private getPenSelectionContents(Landroid/content/Context;Landroid/view/View;Lcom/samsung/android/penselect/PenSelectionController$PenSelectionContents;)Z
    ...
    invoke-direct {p0, p2}, isVisibleView(Landroid/view/View;)Z
    ...
    invoke-direct {p0, p1, v0, p3}, getPenSelectionContents(Landroid/content/Context;Landroid/view/View;Lcom/samsung/android/penselect/PenSelectionController$PenSelectionContents;)Z
...
.method public clearAllPenSelection(Landroid/content/Context;Landroid/view/View;)Z
    ...
    .line 116
    .local v0, "child":Landroid/view/View;
    invoke-virtual {p0, p1, v0}, clearAllPenSelection(Landroid/content/Context;Landroid/view/View;)Z
...
.method public findTargetTextView(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Rect;)Landroid/view/View;
    ...
    invoke-virtual {p0, v6, p3}, checkRectInView(Landroid/view/View;Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, p1, v1, p3}, findTargetTextView(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Rect;)Landroid/view/View;
...
.method public getPenSelectionContents(Landroid/content/Context;Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v0}, getPenSelectionContents(Landroid/content/Context;Landroid/view/View;Lcom/samsung/android/penselect/PenSelectionController$PenSelectionContents;)Z
...
.method public isPenSelectionArea(Landroid/content/Context;Landroid/view/View;II)Z
    ...
    .line 140
    .local v0, "child":Landroid/view/View;
    invoke-virtual {p0, p1, v0, p3, p4}, isPenSelectionArea(Landroid/content/Context;Landroid/view/View;II)Z
