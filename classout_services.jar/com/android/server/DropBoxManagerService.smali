...
.method public constructor <init>(Landroid/content/Context;Ljava/io/File;)V
    ...
    .line 87
    iput-object v2, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;

    .line 88
    iput-object v2, p0, mFilesByTag:Ljava/util/HashMap;

    .line 92
    iput-object v2, p0, mStatFs:Landroid/os/StatFs;

    .line 93
    iput v1, p0, mBlockSize:I

    .line 94
    iput v1, p0, mCachedQuotaBlocks:I

    .line 95
    const-wide/16 v2, 0x0

    iput-wide v2, p0, mCachedQuotaUptimeMillis:J

    .line 97
    iput-boolean v1, p0, mBooted:Z
    ...
    .line 138
    iput-object p2, p0, mDropBoxDir:Ljava/io/File;
...
.method static synthetic access$102(Lcom/android/server/DropBoxManagerService;J)J
    ...
    .prologue
    .line 61
    iput-wide p1, p0, mCachedQuotaUptimeMillis:J
...
.method private declared-synchronized createEntry(Ljava/io/File;Ljava/lang/String;I)J
    ...
    iget-object v2, v0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iget-object v2, v0, mFilesByTag:Ljava/util/HashMap;
    ...
    iget-object v4, v0, mDropBoxDir:Ljava/io/File;
    ...
    invoke-direct {v0, v2}, enrollEntry(Lcom/android/server/DropBoxManagerService$EntryFile;)V
    ...
    iget-object v3, v0, mDropBoxDir:Ljava/io/File;
...
.method private declared-synchronized enrollEntry(Lcom/android/server/DropBoxManagerService$EntryFile;)V
    ...
    :try_start_1
    iget-object v1, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    .line 642
    iget-object v1, p0, mFilesByTag:Ljava/util/HashMap;
...
.method private declared-synchronized init()V
    ...
    :try_start_1
    iget-object v7, p0, mStatFs:Landroid/os/StatFs;

    if-nez v7, :cond_48

    .line 592
    iget-object v7, p0, mDropBoxDir:Ljava/io/File;
    ...
    iget-object v9, p0, mDropBoxDir:Ljava/io/File;
    ...
    iget-object v8, p0, mDropBoxDir:Ljava/io/File;
    ...
    iput-object v7, p0, mStatFs:Landroid/os/StatFs;
    ...
    :cond_48
    :try_start_48
    iget-object v7, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iput-object v7, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iput-object v7, p0, mFilesByTag:Ljava/util/HashMap;
    ...
    .line 628
    :cond_113
    invoke-direct {p0, v2}, enrollEntry(Lcom/android/server/DropBoxManagerService$EntryFile;)V
    :try_end_116
...
.method private declared-synchronized trimToFit()J
    ...
    iget-object v0, v0, mContentResolver:Landroid/content/ContentResolver;
    ...
    iget-object v0, v0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iget-wide v0, v0, mCachedQuotaUptimeMillis:J
    ...
    iget-object v0, v0, mStatFs:Landroid/os/StatFs;

    move-object/from16 v26, v0

    move-object/from16 v0, p0

    iget-object v0, v0, mDropBoxDir:Ljava/io/File;
    ...
    iput v0, v1, mCachedQuotaBlocks:I
    ...
    iput-wide v0, v2, mCachedQuotaUptimeMillis:J
    ...
    iget v0, v0, mCachedQuotaBlocks:I
    ...
    iget-object v0, v0, mFilesByTag:Ljava/util/HashMap;
    ...
    move/from16 v27, v0
    :try_end_1a4
    .catchall {:try_start_1 .. :try_end_1a4} :catchall_21a
    ...
    :try_end_218
    .catchall {:try_start_1ad .. :try_end_218} :catchall_21a
    ...
    iput v0, v1, Lcom/android/server/DropBoxManagerService$FileList;->blocks:I
    :try_end_299
    .catchall {:try_start_21d .. :try_end_299} :catchall_21a
    ...
    invoke-direct {v0, v1}, enrollEntry(Lcom/android/server/DropBoxManagerService$EntryFile;)V
    :try_end_2c8
    .catch Ljava/io/IOException; {:try_start_299 .. :try_end_2c8} :catch_2ca
    .catchall {:try_start_299 .. :try_end_2c8} :catchall_21a
    ...
    :try_end_2d6
    .catchall {:try_start_2cb .. :try_end_2d6} :catchall_21a
...
.method public add(Landroid/os/DropBoxManager$Entry;)V
    ...
    .catchall {:try_start_8 .. :try_end_16} :catchall_1e2
    ...
    :try_end_37
    .catchall {:try_start_17 .. :try_end_37} :catchall_1e2
    ...
    :try_end_3c
    .catch Ljava/io/IOException; {:try_start_39 .. :try_end_3c} :catch_1f6
    ...
    invoke-virtual {v0, v1}, isTagEnabled(Ljava/lang/String;)Z
    :try_end_4f
    .catch Ljava/io/IOException; {:try_start_45 .. :try_end_4f} :catch_16
    .catchall {:try_start_45 .. :try_end_4f} :catchall_1e2
    ...
    invoke-virtual/range {v20 .. v20}, Ljava/io/OutputStream;->close()V
    :try_end_57
    .catch Ljava/io/IOException; {:try_start_54 .. :try_end_57} :catch_1f1
    ...
    :cond_60
    :try_start_60
    invoke-direct/range {p0 .. p0}, trimToFit()J
    ...
    :try_end_c3
    .catch Ljava/io/IOException; {:try_start_60 .. :try_end_c3} :catch_16
    .catchall {:try_start_60 .. :try_end_c3} :catchall_1e2
    ...
    :try_end_e5
    .catch Ljava/io/IOException; {:try_start_c3 .. :try_end_e5} :catch_1d8
    .catchall {:try_start_c3 .. :try_end_e5} :catchall_1fb
    ...
    :try_end_f7
    .catch Ljava/io/IOException; {:try_start_e5 .. :try_end_f7} :catch_205
    .catchall {:try_start_e5 .. :try_end_f7} :catchall_1ff
    ...
    :try_end_16d
    .catch Ljava/io/IOException; {:try_start_fb .. :try_end_16d} :catch_1d8
    .catchall {:try_start_fb .. :try_end_16d} :catchall_1fb
    ...
    invoke-direct {v0, v1, v2, v8}, createEntry(Ljava/io/File;Ljava/lang/String;I)J
    ...
    :try_end_1c0
    .catch Ljava/io/IOException; {:try_start_16f .. :try_end_1c0} :catch_16
    .catchall {:try_start_16f .. :try_end_1c0} :catchall_1e2
    ...
    invoke-virtual/range {v20 .. v20}, Ljava/io/OutputStream;->close()V
    :try_end_1c5
    .catch Ljava/io/IOException; {:try_start_1c2 .. :try_end_1c5} :catch_1f4
    ...
    .catchall {:try_start_1d3 .. :try_end_1d6} :catchall_1fb
    ...
    invoke-virtual/range {v20 .. v20}, Ljava/io/OutputStream;->close()V
    :try_end_1e8
    .catch Ljava/io/IOException; {:try_start_1e5 .. :try_end_1e8} :catch_1f9
...
.method public declared-synchronized dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v4, v0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    iget-object v3, v0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    ...
    :try_end_22d
    .catch Ljava/io/IOException; {:try_start_218 .. :try_end_22d} :catch_367
    .catchall {:try_start_218 .. :try_end_22d} :catchall_360
    ...
    :try_end_23a
    .catch Ljava/io/IOException; {:try_start_22f .. :try_end_23a} :catch_2fa
    .catchall {:try_start_22f .. :try_end_23a} :catchall_321
    ...
    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    :try_end_251
    .catch Ljava/io/IOException; {:try_start_23c .. :try_end_251} :catch_297
    .catchall {:try_start_23c .. :try_end_251} :catchall_363
    ...
    :try_end_25d
    .catch Ljava/io/IOException; {:try_start_25a .. :try_end_25d} :catch_35b
    ...
    :try_end_26b
    .catchall {:try_start_25f .. :try_end_26b} :catchall_69
    ...
    :try_end_296
    .catch Ljava/io/IOException; {:try_start_26e .. :try_end_296} :catch_297
    .catchall {:try_start_26e .. :try_end_296} :catchall_363
    ...
    invoke-static {v3, v4, v15}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_2cb
    .catchall {:try_start_29a .. :try_end_2cb} :catchall_321
    ...
    invoke-virtual {v2}, Landroid/os/DropBoxManager$Entry;->close()V
    :try_end_2d0
    .catchall {:try_start_2cd .. :try_end_2d0} :catchall_69
    ...
    .catchall {:try_start_2d2 .. :try_end_2d5} :catchall_69
    ...
    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    :try_end_320
    .catch Ljava/io/IOException; {:try_start_2dd .. :try_end_320} :catch_2fa
    .catchall {:try_start_2dd .. :try_end_320} :catchall_321
    ...
    invoke-virtual {v2}, Landroid/os/DropBoxManager$Entry;->close()V
    :try_end_327
    .catchall {:try_start_324 .. :try_end_327} :catchall_69
    ...
    invoke-virtual/range {v19 .. v19}, Ljava/io/InputStreamReader;->close()V
    :try_end_32c
    .catch Ljava/io/IOException; {:try_start_329 .. :try_end_32c} :catch_35e
    .catchall {:try_start_329 .. :try_end_32c} :catchall_69
    ...
    invoke-virtual {v0, v3}, Ljava/io/PrintWriter;->write(Ljava/lang/String;)V
    :try_end_359
    .catchall {:try_start_32c .. :try_end_359} :catchall_69
...
.method public declared-synchronized getNextEntry(Ljava/lang/String;J)Landroid/os/DropBoxManager$Entry;
    ...
    :try_start_1c
    iget-object v9, p0, mAllFiles:Lcom/android/server/DropBoxManagerService$FileList;
    :try_end_1e
    ...
    :cond_2d
    iget-object v0, p0, mFilesByTag:Ljava/util/HashMap;
