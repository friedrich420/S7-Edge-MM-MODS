...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 72
    iput-object v4, p0, mUserMgr:Landroid/os/UserManager;
    ...
    iput-object v0, p0, mUserToAppMap:Landroid/util/SparseArray;

    .line 107
    iput-object v4, p0, mPackageHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, mPackageHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, mUserMgr:Landroid/os/UserManager;
    ...
    .line 150
    iget-object v1, p0, mPackageChangeReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$000(Lcom/android/server/HarmonyEASService;I)V
    ...
    .prologue
    .line 60
    invoke-direct {p0, p1}, saveHash(I)V
...
.method private declared-synchronized addHashForPackage(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    :try_start_1
    invoke-direct {p0, p3}, getAppDetailsOfUserId(I)Lcom/android/server/HarmonyEASService$ThirdPartyAppDetails;
    ...
    .line 244
    iget-object v1, p0, mPackageHandler:Landroid/os/Handler;

    iget-object v2, p0, mPackageHandler:Landroid/os/Handler;
...
.method private declared-synchronized addPackageAsUnknown(Ljava/lang/String;I)V
    ...
    :try_start_2
    invoke-direct {p0, p2}, getAppDetailsOfUserId(I)Lcom/android/server/HarmonyEASService$ThirdPartyAppDetails;
    ...
    .line 203
    iget-object v3, p0, mPackageHandler:Landroid/os/Handler;

    iget-object v4, p0, mPackageHandler:Landroid/os/Handler;
...
.method private getAppDetailsOfUserId(I)Lcom/android/server/HarmonyEASService$ThirdPartyAppDetails;
    ...
    .line 490
    :try_start_1
    iget-object v1, p0, mUserToAppMap:Landroid/util/SparseArray;
    ...
    .line 498
    invoke-direct {p0, v0, p1}, loadHashVaues(Lcom/android/server/HarmonyEASService$ThirdPartyAppDetails;I)V
...
.method private loadHashVaues(Lcom/android/server/HarmonyEASService$ThirdPartyAppDetails;I)V
    ...
    :try_end_1a
    .catch Ljava/lang/Exception; {:try_start_11 .. :try_end_1a} :catch_d6
    .catchall {:try_start_11 .. :try_end_1a} :catchall_d4
    ...
    :try_end_21
    .catch Ljava/io/IOException; {:try_start_1e .. :try_end_21} :catch_cf
    ...
    throw v14
    :try_end_5e
    .catch Ljava/lang/Exception; {:try_start_23 .. :try_end_5e} :catch_5e
    .catchall {:try_start_23 .. :try_end_5e} :catchall_b8
    ...
    :try_end_63
    .catchall {:try_start_60 .. :try_end_63} :catchall_d4
    ...
    monitor-enter p0
    :try_end_a8
    .catch Ljava/lang/Exception; {:try_start_6b .. :try_end_a8} :catch_5e
    .catchall {:try_start_6b .. :try_end_a8} :catchall_b8
    ...
    :try_end_b7
    .catch Ljava/lang/Exception; {:try_start_b4 .. :try_end_b7} :catch_5e
    ...
    throw v14
    :try_end_c3
    .catch Ljava/lang/Exception; {:try_start_c2 .. :try_end_c3} :catch_5e
    .catchall {:try_start_c2 .. :try_end_c3} :catchall_b8
...
.method private saveHash(I)V
    ...
    .prologue
    .line 293
    invoke-direct/range {p0 .. p1}, getAppDetailsOfUserId(I)Lcom/android/server/HarmonyEASService$ThirdPartyAppDetails;
    ...
    :try_end_1f
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_1f} :catch_fc
    .catchall {:try_start_10 .. :try_end_1f} :catchall_e5
    ...
    :try_end_24
    .catch Ljava/lang/Exception; {:try_start_1f .. :try_end_24} :catch_fe
    .catchall {:try_start_1f .. :try_end_24} :catchall_f3
    ...
    :try_end_a7
    .catch Ljava/lang/Exception; {:try_start_24 .. :try_end_a7} :catch_a8
    .catchall {:try_start_24 .. :try_end_a7} :catchall_f6
    ...
    :try_end_b1
    .catchall {:try_start_ab .. :try_end_b1} :catchall_e5
    ...
    :try_end_bb
    .catch Ljava/io/IOException; {:try_start_b3 .. :try_end_bb} :catch_fa
    ...
    :try_end_d4
    .catch Ljava/lang/Exception; {:try_start_be .. :try_end_d4} :catch_a8
    .catchall {:try_start_be .. :try_end_d4} :catchall_f6
    ...
    :try_end_de
    .catch Ljava/io/IOException; {:try_start_d6 .. :try_end_de} :catch_e1
...
.method public getThirdPartyApps(I)Ljava/util/List;
    ...
    .prologue
    .line 482
    invoke-direct {p0, p1}, getAppDetailsOfUserId(I)Lcom/android/server/HarmonyEASService$ThirdPartyAppDetails;
...
.method handlePackagesChanged(I)V
    ...
    .line 558
    :try_start_2f
    invoke-virtual {p0, v0, p1}, removeInstallationPackageExtras(Ljava/lang/String;I)V
    ...
    .line 564
    :try_start_3f
    iget-object v6, p0, mPackageHandler:Landroid/os/Handler;

    iget-object v7, p0, mPackageHandler:Landroid/os/Handler;
...
.method declared-synchronized handleUserChanged(I)V
    ...
    :try_start_1
    iget-object v0, p0, mUserToAppMap:Landroid/util/SparseArray;
...
.method public removeInstallationPackage(Ljava/lang/String;I)V
    ...
    .line 440
    iget-object v3, p0, mUserMgr:Landroid/os/UserManager;
    ...
    invoke-virtual {p0, p1, v3}, removeInstallationPackageExtras(Ljava/lang/String;I)V
    ...
    :cond_32
    invoke-virtual {p0, p1, p2}, removeInstallationPackageExtras(Ljava/lang/String;I)V
...
.method public removeInstallationPackageExtras(Ljava/lang/String;I)V
    ...
    iget-object v5, p0, mPackageHandler:Landroid/os/Handler;
...
.method public setInstallationPackageHashValue(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    iget-object v4, p0, mUserMgr:Landroid/os/UserManager;
    ...
    invoke-direct {p0, p1, p2, v4}, addHashForPackage(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    :cond_4b
    invoke-direct {p0, p1, p2, p4}, addHashForPackage(Ljava/lang/String;Ljava/lang/String;I)V
...
.method public setInstallationPackageUnknown(Ljava/lang/String;II)V
    ...
    invoke-direct {p0, p1, v4}, addPackageAsUnknown(Ljava/lang/String;I)V
    ...
    .end local v2    # "userInfo":Landroid/content/pm/UserInfo;
    :cond_4b
    invoke-direct {p0, p1, p3}, addPackageAsUnknown(Ljava/lang/String;I)V
