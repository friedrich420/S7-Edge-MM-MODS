...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, mReceiverLock:Ljava/lang/Object;
    ...
    iput-object v0, p0, mScoreCaches:Ljava/util/Map;
...
.method static synthetic access$100(Lcom/android/server/NetworkScoreService;Ljava/lang/String;)Z
    ...
    .prologue
    .line 56
    invoke-direct {p0, p1}, setScorerInternal(Ljava/lang/String;)Z
...
.method private clearInternal()V
    ...
    .prologue
    .line 252
    invoke-direct {p0}, getScoreCaches()Ljava/util/Set;
...
.method private getScoreCaches()Ljava/util/Set;
    ...
    .prologue
    .line 307
    iget-object v1, p0, mScoreCaches:Ljava/util/Map;
    ...
    iget-object v2, p0, mScoreCaches:Ljava/util/Map;
...
.method private registerPackageReceiverIfNeeded()V
    ...
    iget-object v7, p0, mReceiverLock:Ljava/lang/Object;

    monitor-enter v7

    .line 118
    :try_start_9
    iget-object v0, p0, mReceiver:Lcom/android/server/NetworkScoreService$ScorerChangedReceiver;
    ...
    iget-object v2, p0, mReceiver:Lcom/android/server/NetworkScoreService$ScorerChangedReceiver;
    ...
    iget-object v1, p0, mReceiver:Lcom/android/server/NetworkScoreService$ScorerChangedReceiver;
    ...
    iput-object v0, p0, mReceiver:Lcom/android/server/NetworkScoreService$ScorerChangedReceiver;
    ...
    monitor-exit v7
    :try_end_99
    .catchall {:try_start_9 .. :try_end_99} :catchall_97
...
.method private setScorerInternal(Ljava/lang/String;)Z
    ...
    .local v2, "token":J
    :try_start_4
    invoke-direct {p0}, clearInternal()V
    ...
    .line 239
    invoke-direct {p0}, registerPackageReceiverIfNeeded()V
...
.method public disableScoring()V
    ...
    invoke-direct {p0, v0}, setScorerInternal(Ljava/lang/String;)Z
...
.method public registerNetworkScoreCache(ILandroid/net/INetworkScoreCache;)V
    ...
    .line 269
    :try_start_c
    iget-object v0, p0, mScoreCaches:Ljava/util/Map;
...
.method public updateScores([Landroid/net/ScoredNetwork;)Z
    ...
    iget-object v9, p0, mScoreCaches:Ljava/util/Map;
