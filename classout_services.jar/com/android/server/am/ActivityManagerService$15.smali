...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILcom/android/server/am/ProcessRecord;Ljava/lang/String;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Z)V
    ...
    iput p2, p0, val$origPid:I

    iput-object p3, p0, val$proc:Lcom/android/server/am/ProcessRecord;

    iput-object p4, p0, val$annotation:Ljava/lang/String;

    iput-object p5, p0, val$activity:Lcom/android/server/am/ActivityRecord;

    iput-object p6, p0, val$parent:Lcom/android/server/am/ActivityRecord;

    iput-boolean p7, p0, val$aboveSystem:Z
...
.method public run()V
    ...
    .prologue
    .line 15792
    iget v0, p0, val$origPid:I

    const/4 v1, -0x1

    if-eq v0, v1, :cond_41

    iget-object v0, p0, val$proc:Lcom/android/server/am/ProcessRecord;

    iget v0, v0, Lcom/android/server/am/ProcessRecord;->pid:I

    iget v1, p0, val$origPid:I
    ...
    iget-object v2, p0, val$proc:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v2, p0, val$annotation:Ljava/lang/String;
    ...
    iget-object v1, p0, val$proc:Lcom/android/server/am/ProcessRecord;

    iget-object v2, p0, val$activity:Lcom/android/server/am/ActivityRecord;

    iget-object v3, p0, val$parent:Lcom/android/server/am/ActivityRecord;

    iget-boolean v4, p0, val$aboveSystem:Z

    iget-object v5, p0, val$annotation:Ljava/lang/String;
