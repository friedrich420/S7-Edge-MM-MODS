...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Ljava/util/ArrayList;Ljava/lang/Runnable;)V
    ...
    iput-object p2, p0, val$doneReceivers:Ljava/util/ArrayList;

    iput-object p3, p0, val$goingCallback:Ljava/lang/Runnable;
...
.method public run()V
    ...
    .line 16936
    iget-object v0, p0, val$doneReceivers:Ljava/util/ArrayList;

    # invokes: Lcom/android/server/am/ActivityManagerService;->writeLastDonePreBootReceivers(Ljava/util/ArrayList;)V
    invoke-static {v0}, Lcom/android/server/am/ActivityManagerService;->access$2300(Ljava/util/ArrayList;)V

    .line 16937
    iget-object v0, p0, this$0:Lcom/android/server/am/ActivityManagerService;

    iget-object v1, p0, val$goingCallback:Ljava/lang/Runnable;
