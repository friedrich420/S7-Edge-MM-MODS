...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;IILandroid/os/IBinder;Ljava/lang/String;Landroid/app/ApplicationErrorReport$CrashInfo;)V
    ...
    iput p2, p0, val$callingUid:I

    iput p3, p0, val$callingPid:I

    iput-object p4, p0, val$app:Landroid/os/IBinder;

    iput-object p5, p0, val$tag:Ljava/lang/String;
...
.method public run()V
    ...
    iget v1, p0, val$callingUid:I

    iget v2, p0, val$callingPid:I

    iget-object v3, p0, val$app:Landroid/os/IBinder;

    iget-object v4, p0, val$tag:Ljava/lang/String;

    iget-object v5, p0, val$crashInfo:Landroid/app/ApplicationErrorReport$CrashInfo;
