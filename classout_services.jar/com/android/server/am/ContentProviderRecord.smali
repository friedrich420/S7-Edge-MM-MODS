...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/pm/ProviderInfo;Landroid/content/pm/ApplicationInfo;Landroid/content/ComponentName;Z)V
    ...
    iput-object v0, p0, connections:Ljava/util/ArrayList;
    ...
    .line 62
    iput-object p3, p0, appInfo:Landroid/content/pm/ApplicationInfo;

    .line 63
    iput-object p4, p0, name:Landroid/content/ComponentName;

    .line 64
    iput-boolean p5, p0, singleton:Z
    ...
    iget-object v1, p0, appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iput-boolean v0, p0, noReleaseNeeded:Z
...
.method public constructor <init>(Lcom/android/server/am/ContentProviderRecord;)V
    ...
    .line 85
    iget-object v0, p1, service:Lcom/android/server/am/ActivityManagerService;

    iput-object v0, p0, service:Lcom/android/server/am/ActivityManagerService;
    ...
    .line 88
    iget-object v0, p1, appInfo:Landroid/content/pm/ApplicationInfo;

    iput-object v0, p0, appInfo:Landroid/content/pm/ApplicationInfo;

    .line 89
    iget-object v0, p1, name:Landroid/content/ComponentName;

    iput-object v0, p0, name:Landroid/content/ComponentName;

    .line 90
    iget-boolean v0, p1, singleton:Z

    iput-boolean v0, p0, singleton:Z

    .line 91
    iget-boolean v0, p1, noReleaseNeeded:Z
...
.method static synthetic access$100(Lcom/android/server/am/ContentProviderRecord;Landroid/os/IBinder;)V
    ...
    .prologue
    .line 35
    invoke-direct {p0, p1}, removeExternalProcessHandleInternalLocked(Landroid/os/IBinder;)V
...
.method private removeExternalProcessHandleInternalLocked(Landroid/os/IBinder;)V
    ...
    .prologue
    .line 146
    iget-object v1, p0, externalProcessTokenToHandle:Ljava/util/HashMap;
    ...
    iput-object v1, p0, externalProcessTokenToHandle:Ljava/util/HashMap;
...
.method public addExternalProcessHandleLocked(Landroid/os/IBinder;)V
    ...
    .line 109
    iget v1, p0, externalProcessNoHandleCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, externalProcessNoHandleCount:I
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    .line 165
    iget-object v2, p0, info:Landroid/content/pm/ProviderInfo;
    ...
    iget-object v2, p0, proc:Lcom/android/server/am/ProcessRecord;

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->println(Ljava/lang/Object;)V

    .line 169
    iget-object v2, p0, launchingApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v2, p0, provider:Landroid/content/IContentProvider;

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->println(Ljava/lang/Object;)V

    .line 176
    :cond_5a
    iget-boolean v2, p0, singleton:Z
    ...
    .line 188
    invoke-virtual {p0}, hasExternalProcessHandles()Z
    ...
    .line 190
    iget-object v2, p0, externalProcessTokenToHandle:Ljava/util/HashMap;
    ...
    .line 194
    :cond_da
    iget v2, p0, externalProcessNoHandleCount:I
    ...
    :cond_eb
    :goto_eb
    iget-object v2, p0, connections:Ljava/util/ArrayList;
...
.method public hasConnectionOrHandle()Z
    ...
    .prologue
    .line 159
    iget-object v0, p0, connections:Ljava/util/ArrayList;
...
.method public hasExternalProcessHandles()Z
    ...
    .prologue
    .line 155
    iget-object v0, p0, externalProcessTokenToHandle:Ljava/util/HashMap;

    if-nez v0, :cond_8

    iget v0, p0, externalProcessNoHandleCount:I
...
.method public newHolder(Lcom/android/server/am/ContentProviderConnection;)Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    iget-object v1, p0, info:Landroid/content/pm/ProviderInfo;
...
.method public removeExternalProcessHandleLocked(Landroid/os/IBinder;)Z
    ...
    iget-object v3, p0, externalProcessTokenToHandle:Ljava/util/HashMap;
    ...
    .line 138
    iget v3, p0, externalProcessNoHandleCount:I

    add-int/lit8 v3, v3, -0x1

    iput v3, p0, externalProcessNoHandleCount:I
...
.method public toShortString()Ljava/lang/String;
    ...
    .line 245
    iget-object v1, p0, name:Landroid/content/ComponentName;
