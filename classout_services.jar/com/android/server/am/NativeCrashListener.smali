...
.method consumeNativeCrashData(Ljava/io/FileDescriptor;)V
    ...
    invoke-static {p1, v0, v10, v11}, readExactly(Ljava/io/FileDescriptor;[BII)I
    ...
    invoke-static {v0, v10}, unpackInt([BI)I
    ...
    .line 263
    :goto_66
    iget-object v11, p0, mAm:Lcom/android/server/am/ActivityManagerService;
...
.method public run()V
    ...
    .line 138
    invoke-virtual {p0, v4}, consumeNativeCrashData(Ljava/io/FileDescriptor;)V
    :try_end_46
