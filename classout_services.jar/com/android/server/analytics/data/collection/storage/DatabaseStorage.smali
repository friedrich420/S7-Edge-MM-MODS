...
.method static constructor <clinit>()V
    ...
    sput-object v0, mInstance:Lcom/android/server/analytics/data/collection/storage/DatabaseStorage;
...
.method static synthetic access$100(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
    ...
    .prologue
    .line 51
    invoke-static {p0, p1}, preTableCreate(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
...
.method static synthetic access$200(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
    ...
    .prologue
    .line 51
    invoke-static {p0, p1}, createTable(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
...
.method static synthetic access$300(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
    ...
    .prologue
    .line 51
    invoke-static {p0, p1}, postTableCreate(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
...
.method static synthetic access$400(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
    ...
    .prologue
    .line 51
    invoke-static {p0, p1}, preTableUpdate(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/analytics/data/collection/storage/Table;)V
...
.method static synthetic access$500(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lcom/android/server/analytics/data/collection/storage/Table;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 51
    invoke-static {p0, p1, p2}, getMissingColumns(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lcom/android/server/analytics/data/collection/storage/Table;)Ljava/util/ArrayList;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/android/server/analytics/data/collection/storage/DatabaseStorage;
    ...
    :try_start_3
    sget-object v0, mInstance:Lcom/android/server/analytics/data/collection/storage/DatabaseStorage;
...
.method private static getTableColumns(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Landroid/content/ContentValues;
    ...
    :try_end_41
    .catch Ljava/lang/Exception; {:try_start_1d .. :try_end_41} :catch_92
    .catchall {:try_start_1d .. :try_end_41} :catchall_8a
    ...
    :try_end_4a
    .catch Ljava/lang/Exception; {:try_start_45 .. :try_end_4a} :catch_92
    .catchall {:try_start_45 .. :try_end_4a} :catchall_8a
    ...
    .catchall {:try_start_4b .. :try_end_64} :catchall_8f
    ...
    :try_end_80
    .catchall {:try_start_67 .. :try_end_80} :catchall_8a
...
.method public getValues(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2, p3}, select(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;)Landroid/database/Cursor;
