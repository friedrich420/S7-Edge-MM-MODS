...
.method public constructor <init>(Landroid/content/res/XmlResourceParser;Lcom/android/server/analytics/data/collection/storage/TableCallback;)V
    ...
    .line 66
    iput-object p1, p0, mParser:Landroid/content/res/XmlResourceParser;

    .line 67
    iput-object p2, p0, mCallback:Lcom/android/server/analytics/data/collection/storage/TableCallback;
...
.method public parseXML()V
    ...
    .line 93
    :try_start_0
    iget-object v0, p0, mParser:Landroid/content/res/XmlResourceParser;
    ...
    iget-object v1, p0, mParser:Landroid/content/res/XmlResourceParser;
    ...
    iget-object v2, p0, mParser:Landroid/content/res/XmlResourceParser;
    ...
    iget-object v3, p0, mParser:Landroid/content/res/XmlResourceParser;
    ...
    invoke-direct {p0, v2}, getType(Ljava/lang/String;)Lcom/android/server/analytics/data/collection/storage/Column$DATA_TYPE;
    ...
    invoke-direct {p0, v3}, isPrimaryKey(Ljava/lang/String;)Z

    move-result v3

    iget-object v4, p0, mParser:Landroid/content/res/XmlResourceParser;
    ...
    iget-object v5, p0, mParser:Landroid/content/res/XmlResourceParser;
    ...
    .line 118
    iget-object v0, p0, mCallback:Lcom/android/server/analytics/data/collection/storage/TableCallback;
    ...
    :try_end_be
    .catch Ljava/lang/Exception; {:try_start_a8 .. :try_end_be} :catch_9e
