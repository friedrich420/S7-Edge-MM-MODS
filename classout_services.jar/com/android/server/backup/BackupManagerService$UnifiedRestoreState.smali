...
.method static constructor <clinit>()V
    ...
    sput-object v0, INITIAL:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
    ...
    sput-object v0, RUNNING_QUEUE:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
    ...
    sput-object v0, RESTORE_KEYVALUE:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
    ...
    sput-object v0, RESTORE_FULL:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
    ...
    sput-object v0, RESTORE_FINISHED:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
    ...
    sput-object v0, FINAL:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
    ...
    sget-object v1, INITIAL:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;

    aput-object v1, v0, v3

    sget-object v1, RUNNING_QUEUE:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;

    aput-object v1, v0, v4

    sget-object v1, RESTORE_KEYVALUE:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;

    aput-object v1, v0, v5

    sget-object v1, RESTORE_FULL:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;

    aput-object v1, v0, v6

    sget-object v1, RESTORE_FINISHED:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;

    aput-object v1, v0, v7

    const/4 v1, 0x5

    sget-object v2, FINAL:Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;

    aput-object v2, v0, v1

    sput-object v0, $VALUES:[Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
...
.method public static values()[Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
    ...
    .prologue
    .line 7564
    sget-object v0, $VALUES:[Lcom/android/server/backup/BackupManagerService$UnifiedRestoreState;
