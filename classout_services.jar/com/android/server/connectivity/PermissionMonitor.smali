...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;)V
    ...
    iput-object v0, p0, mUsers:Ljava/util/Set;
    ...
    iput-object v0, p0, mApps:Ljava/util/Map;
    ...
    .line 77
    iput-object p2, p0, mNetd:Landroid/os/INetworkManagementService;
...
.method static synthetic access$200(Lcom/android/server/connectivity/PermissionMonitor;Ljava/lang/String;I)V
    ...
    .prologue
    .line 55
    invoke-direct {p0, p1, p2}, onAppAdded(Ljava/lang/String;I)V
...
.method static synthetic access$300(Lcom/android/server/connectivity/PermissionMonitor;I)V
    ...
    .prologue
    .line 55
    invoke-direct {p0, p1}, onAppRemoved(I)V
...
.method private hasNetworkPermission(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-direct {p0, p1, v0}, hasPermission(Landroid/content/pm/PackageInfo;Ljava/lang/String;)Z
...
.method private hasSystemPermission(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-direct {p0, p1, v1}, hasPermission(Landroid/content/pm/PackageInfo;Ljava/lang/String;)Z
...
.method private declared-synchronized onAppAdded(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0}, hasNetworkPermission(Landroid/content/pm/PackageInfo;)Z

    move-result v3

    .line 238
    .local v3, "isNetwork":Z
    invoke-direct {p0, v0}, hasSystemPermission(Landroid/content/pm/PackageInfo;)Z
    ...
    .line 240
    :cond_3f
    iget-object v6, p0, mApps:Ljava/util/Map;
    ...
    .line 248
    iget-object v6, p0, mUsers:Ljava/util/Set;

    const/4 v7, 0x1

    invoke-direct {p0, v6, v1, v7}, update(Ljava/util/Set;Ljava/util/Map;Z)V
    :try_end_76
...
.method private declared-synchronized onAppRemoved(I)V
    ...
    :cond_1b
    :try_start_1b
    iget-object v1, p0, mApps:Ljava/util/Map;
    ...
    .line 265
    iget-object v1, p0, mUsers:Ljava/util/Set;

    const/4 v2, 0x0

    invoke-direct {p0, v1, v0, v2}, update(Ljava/util/Set;Ljava/util/Map;Z)V
    :try_end_3b
...
.method private declared-synchronized onUserAdded(I)V
    ...
    invoke-direct {p0, v0, v1, v2}, update(Ljava/util/Set;Ljava/util/Map;Z)V
    :try_end_36
...
.method private update(Ljava/util/Set;Ljava/util/Map;Z)V
    ...
    invoke-direct {p0, v5}, toIntArray(Ljava/util/List;)[I
    ...
    invoke-direct {p0, v6}, toIntArray(Ljava/util/List;)[I
...
.method public declared-synchronized startMonitoring()V
    ...
    .line 128
    invoke-direct {p0, v6}, hasNetworkPermission(Landroid/content/pm/PackageInfo;)Z

    move-result v9

    .line 129
    .local v9, "isNetwork":Z
    invoke-direct {p0, v6}, hasSystemPermission(Landroid/content/pm/PackageInfo;)Z
    ...
    .line 132
    :cond_77
    iget-object v0, p0, mApps:Ljava/util/Map;
    ...
    iget-object v0, p0, mUsers:Ljava/util/Set;
