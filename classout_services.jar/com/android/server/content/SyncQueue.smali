...
.method public constructor <init>(Landroid/content/pm/PackageManager;Lcom/android/server/content/SyncStorageEngine;Landroid/content/SyncAdaptersCache;)V
    ...
    iput-object v0, p0, mOperationsMap:Ljava/util/HashMap;

    .line 55
    iput-object p1, p0, mPackageManager:Landroid/content/pm/PackageManager;

    .line 56
    iput-object p2, p0, mSyncStorageEngine:Lcom/android/server/content/SyncStorageEngine;

    .line 57
    iput-object p3, p0, mSyncAdapters:Landroid/content/SyncAdaptersCache;
...
.method private add(Lcom/android/server/content/SyncOperation;Lcom/android/server/content/SyncStorageEngine$PendingOperation;)Z
    ...
    iget-object v5, p0, mOperationsMap:Ljava/util/HashMap;
    ...
    .line 145
    iget-object v5, p0, mSyncStorageEngine:Lcom/android/server/content/SyncStorageEngine;
...
.method public add(Lcom/android/server/content/SyncOperation;)Z
    ...
    invoke-direct {p0, p1, v0}, add(Lcom/android/server/content/SyncOperation;Lcom/android/server/content/SyncStorageEngine$PendingOperation;)Z
...
.method public addPendingOperations(I)V
    ...
    iget-object v4, v0, mSyncAdapters:Landroid/content/SyncAdaptersCache;
    ...
    invoke-direct {v0, v3, v1}, add(Lcom/android/server/content/SyncOperation;Lcom/android/server/content/SyncStorageEngine$PendingOperation;)Z
    ...
    iget-object v4, v0, mPackageManager:Landroid/content/pm/PackageManager;
    ...
    iget-object v15, v0, mSyncStorageEngine:Lcom/android/server/content/SyncStorageEngine;
...
.method public clearBackoffs()V
    ...
    .prologue
    .line 193
    iget-object v2, p0, mOperationsMap:Ljava/util/HashMap;
...
.method public dump(Ljava/lang/StringBuilder;)V
    ...
    .line 260
    iget-object v4, p0, mOperationsMap:Ljava/util/HashMap;
...
.method public getOperations()Ljava/util/Collection;
    ...
    .prologue
    .line 254
    iget-object v0, p0, mOperationsMap:Ljava/util/HashMap;
...
.method public remove(Lcom/android/server/content/SyncOperation;)V
    ...
    iget-object v3, p0, mOperationsMap:Ljava/util/HashMap;
...
.method public removeUserLocked(I)V
    ...
    invoke-virtual {p0, v1}, remove(Lcom/android/server/content/SyncOperation;)V
