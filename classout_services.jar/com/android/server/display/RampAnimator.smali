...
.method private cancelAnimationCallback()V
    ...
    iget-object v2, p0, mAnimationCallback:Ljava/lang/Runnable;
...
.method public animateTo(II)Z
    ...
    .line 64
    iget-boolean v2, p0, mFirstTime:Z
    ...
    .line 70
    iget-object v2, p0, mProperty:Landroid/util/IntProperty;

    iget-object v3, p0, mObject:Ljava/lang/Object;
    ...
    .line 75
    :cond_28
    iget-object v2, p0, mListener:Lcom/android/server/display/RampAnimator$Listener;
    ...
    iget v3, p0, mTargetValue:I

    if-le v2, v3, :cond_4f

    :cond_45
    iget v2, p0, mTargetValue:I

    iget v3, p0, mCurrentValue:I
    ...
    iput-wide v2, p0, mLastFrameTimeNanos:J
