...
.method public constructor <init>(Lcom/android/server/display/WfdBridgeBase;Ljava/net/Socket;Lcom/android/server/display/WfdBridgeBase$WBPMsgHandler;)V
    ...
    iput-object v1, p0, mDevice:Lcom/android/server/display/WfdBridgeBase$BrigePeerDevice;

    .line 126
    const/4 v1, 0x0

    iput v1, p0, mBusyFlag:I

    .line 127
    const/4 v1, 0x1

    iput-boolean v1, p0, mIsLegacyDevice:Z

    .line 128
    const/4 v1, 0x0

    iput v1, p0, mWbpVersion:F
    ...
    .line 134
    iput-object p3, p0, mMsgHandler:Lcom/android/server/display/WfdBridgeBase$WBPMsgHandler;

    .line 135
    iput-object p2, p0, mSocket:Ljava/net/Socket;
    ...
    iput-object v1, p0, mSocReader:Ljava/io/BufferedReader;
    ...
    iput-object v1, p0, mSocWriter:Ljava/io/PrintWriter;
    :try_end_3b
...
.method public closeSocket()V
    ...
    .line 164
    :try_start_7
    iget-object v1, p0, mSocket:Ljava/net/Socket;
    ...
    iput-object v1, p0, mSocket:Ljava/net/Socket;
    :try_end_f
...
.method public run()V
    ...
    .local v4, "readLen":I
    :goto_6
    iget-object v5, p0, mSocket:Ljava/net/Socket;
    ...
    .line 198
    :try_start_12
    iget-object v5, p0, mSocReader:Ljava/io/BufferedReader;
    ...
    :try_end_22
    .catch Ljava/lang/Exception; {:try_start_12 .. :try_end_22} :catch_71
    ...
    .line 203
    iget-object v5, p0, mMsgHandler:Lcom/android/server/display/WfdBridgeBase$WBPMsgHandler;

    new-instance v6, Lcom/android/server/display/WfdBridgeBase$WBPMsg;

    iget-object v7, p0, this$0:Lcom/android/server/display/WfdBridgeBase;
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/display/WfdBridgeBase$WBPMsgHandler;->putMsg(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)I
    :try_end_69
    .catch Ljava/lang/Exception; {:try_start_22 .. :try_end_69} :catch_83
...
.method public send(Ljava/lang/String;)I
    ...
    .line 185
    iget-object v0, p0, mSocWriter:Ljava/io/PrintWriter;
