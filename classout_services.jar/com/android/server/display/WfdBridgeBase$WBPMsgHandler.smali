...
.method public constructor <init>(Lcom/android/server/display/WfdBridgeBase;)V
    ...
    .prologue
    .line 291
    iput-object p1, p0, this$0:Lcom/android/server/display/WfdBridgeBase;
    ...
    iput-object v0, p0, mMsgList:Ljava/util/concurrent/BlockingQueue;
...
.method private parseBridgeCmdInfo(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    :pswitch_5e
    iget-object v4, p0, this$0:Lcom/android/server/display/WfdBridgeBase;
...
.method private parseMsg(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    .line 365
    invoke-direct {p0, p1}, parseResponse(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)Z

    goto :goto_18

    .line 367
    :cond_27
    invoke-direct {p0, p1}, parseRequest(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)Z
...
.method private parseRequest(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)Z
    ...
    .line 378
    invoke-virtual {p0, p1}, send_WBP_GET_PARAM_RES(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    .line 382
    iget-object v6, p0, this$0:Lcom/android/server/display/WfdBridgeBase;
    ...
    :cond_4a
    :goto_4a
    invoke-virtual {p0, p1, v1}, send_WBP_TRIGGER_RES(Lcom/android/server/display/WfdBridgeBase$WBPMsg;I)V
...
.method private parseResponse(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)Z
    ...
    iget-object v8, p0, this$0:Lcom/android/server/display/WfdBridgeBase;
...
.method public destroy()V
    ...
    .prologue
    .line 352
    iget-object v0, p0, mMsgList:Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object v1, p0, this$0:Lcom/android/server/display/WfdBridgeBase;
    ...
    invoke-virtual {p0, v0}, putMsg(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)I
...
.method public putMsg(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)I
    ...
    .line 528
    :try_start_0
    iget-object v1, p0, mMsgList:Ljava/util/concurrent/BlockingQueue;
...
.method public run()V
    ...
    :cond_1
    :goto_1
    iget-object v3, p0, this$0:Lcom/android/server/display/WfdBridgeBase;

    iget-boolean v3, v3, Lcom/android/server/display/WfdBridgeBase;->mSession:Z

    if-eqz v3, :cond_1c

    iget-object v3, p0, mMsgList:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v3, p0, mMsgList:Ljava/util/concurrent/BlockingQueue;
    ...
    .line 311
    invoke-direct {p0, v2}, parseMsg(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    .line 316
    invoke-direct {p0, v2}, parseBridgeCmdInfo(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    .line 321
    invoke-virtual {p0, v2}, send_WBP_GET_PARAM(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    .line 326
    invoke-virtual {p0, v2}, send_WBP_TRIGGER(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    .line 331
    invoke-virtual {p0, v2}, send_busyFlag(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    :try_end_88
...
.method public send_WBP_GET_PARAM_RES(Lcom/android/server/display/WfdBridgeBase$WBPMsg;)V
    ...
    invoke-virtual {p0}, getSupportedDevList()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v2}, triggerMsg(ILcom/android/server/display/WfdBridgeBase$BridgePeer;)I
