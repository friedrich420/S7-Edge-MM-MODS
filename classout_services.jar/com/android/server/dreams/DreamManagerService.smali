...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, mCurrentDreamDozeScreenState:I

    .line 86
    const/4 v0, -0x1

    iput v0, p0, mCurrentDreamDozeScreenBrightness:I
    ...
    iput-object v0, p0, mControllerListener:Lcom/android/server/dreams/DreamController$Listener;
    ...
    iput-object v0, p0, mSystemPropertiesChanged:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, mHandler:Lcom/android/server/dreams/DreamManagerService$DreamHandler;

    .line 92
    new-instance v0, Lcom/android/server/dreams/DreamController;

    iget-object v1, p0, mHandler:Lcom/android/server/dreams/DreamManagerService$DreamHandler;

    iget-object v2, p0, mControllerListener:Lcom/android/server/dreams/DreamController$Listener;
    ...
    iput-object v0, p0, mController:Lcom/android/server/dreams/DreamController;
    ...
    iput-object v0, p0, mDozeWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic access$1000(Lcom/android/server/dreams/DreamManagerService;I)[Landroid/content/ComponentName;
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1}, getDreamComponentsForUser(I)[Landroid/content/ComponentName;
...
.method static synthetic access$1100(Lcom/android/server/dreams/DreamManagerService;I[Landroid/content/ComponentName;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1, p2}, setDreamComponentsForUser(I[Landroid/content/ComponentName;)V
...
.method static synthetic access$1200(Lcom/android/server/dreams/DreamManagerService;I)Landroid/content/ComponentName;
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1}, getDefaultDreamComponentForUser(I)Landroid/content/ComponentName;
...
.method static synthetic access$1300(Lcom/android/server/dreams/DreamManagerService;)Z
    ...
    .prologue
    .line 65
    invoke-direct {p0}, isDreamingInternal()Z
...
.method static synthetic access$1400(Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0}, requestDreamInternal()V
...
.method static synthetic access$1500(Lcom/android/server/dreams/DreamManagerService;Landroid/content/ComponentName;I)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1, p2}, testDreamInternal(Landroid/content/ComponentName;I)V
...
.method static synthetic access$1600(Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0}, requestAwakenInternal()V
...
.method static synthetic access$1700(Lcom/android/server/dreams/DreamManagerService;Landroid/os/IBinder;Z)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1, p2}, finishSelfInternal(Landroid/os/IBinder;Z)V
...
.method static synthetic access$1800(Lcom/android/server/dreams/DreamManagerService;Landroid/os/IBinder;II)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1, p2, p3}, startDozingInternal(Landroid/os/IBinder;II)V
...
.method static synthetic access$1900(Lcom/android/server/dreams/DreamManagerService;Landroid/os/IBinder;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1}, stopDozingInternal(Landroid/os/IBinder;)V
...
.method static synthetic access$2000(Lcom/android/server/dreams/DreamManagerService;Z)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1}, startDreamInternal(Z)V
...
.method static synthetic access$2100(Lcom/android/server/dreams/DreamManagerService;Z)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1}, stopDreamInternal(Z)V
...
.method static synthetic access$2200(Lcom/android/server/dreams/DreamManagerService;)Landroid/content/ComponentName;
    ...
    .prologue
    .line 65
    iget-object v0, p0, mCurrentDreamName:Landroid/content/ComponentName;
...
.method static synthetic access$2300(Lcom/android/server/dreams/DreamManagerService;)Z
    ...
    .prologue
    .line 65
    iget-boolean v0, p0, mCurrentDreamCanDoze:Z
...
.method static synthetic access$2400(Lcom/android/server/dreams/DreamManagerService;)Landroid/content/ComponentName;
    ...
    .prologue
    .line 65
    invoke-direct {p0}, getDozeComponent()Landroid/content/ComponentName;
...
.method static synthetic access$300(Lcom/android/server/dreams/DreamManagerService;Z)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1}, stopDreamLocked(Z)V
...
.method static synthetic access$400(Lcom/android/server/dreams/DreamManagerService;)Lcom/android/server/dreams/DreamController;
    ...
    .prologue
    .line 65
    iget-object v0, p0, mController:Lcom/android/server/dreams/DreamController;
...
.method static synthetic access$500(Lcom/android/server/dreams/DreamManagerService;)Landroid/os/Binder;
    ...
    .prologue
    .line 65
    iget-object v0, p0, mCurrentDreamToken:Landroid/os/Binder;
...
.method static synthetic access$600(Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0}, cleanupDreamLocked()V
...
.method static synthetic access$900(Lcom/android/server/dreams/DreamManagerService;Ljava/lang/String;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0, p1}, checkPermission(Ljava/lang/String;)V
...
.method private chooseDreamForUser(ZI)Landroid/content/ComponentName;
    ...
    .line 252
    invoke-direct {p0, p2}, getDozeComponent(I)Landroid/content/ComponentName;

    move-result-object v0

    .line 253
    .local v0, "dozeComponent":Landroid/content/ComponentName;
    invoke-direct {p0, v0}, validateDream(Landroid/content/ComponentName;)Z
    ...
    .end local v0    # "dozeComponent":Landroid/content/ComponentName;
    :cond_10
    invoke-direct {p0, p2}, getDreamComponentsForUser(I)[Landroid/content/ComponentName;
...
.method private cleanupDreamLocked()V
    ...
    .line 394
    iput-object v0, p0, mCurrentDreamToken:Landroid/os/Binder;

    .line 395
    iput-object v0, p0, mCurrentDreamName:Landroid/content/ComponentName;

    .line 396
    iput-boolean v1, p0, mCurrentDreamIsTest:Z

    .line 397
    iput-boolean v1, p0, mCurrentDreamCanDoze:Z

    .line 398
    iput v1, p0, mCurrentDreamUserId:I

    .line 399
    iput-boolean v1, p0, mCurrentDreamIsWaking:Z

    .line 400
    iget-boolean v0, p0, mCurrentDreamIsDozing:Z

    if-eqz v0, :cond_19

    .line 401
    iput-boolean v1, p0, mCurrentDreamIsDozing:Z

    .line 402
    iget-object v0, p0, mDozeWakeLock:Landroid/os/PowerManager$WakeLock;

    invoke-virtual {v0}, Landroid/os/PowerManager$WakeLock;->release()V

    .line 404
    :cond_19
    iput v1, p0, mCurrentDreamDozeScreenState:I
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget-object v1, p0, mCurrentDreamToken:Landroid/os/Binder;
    ...
    iget-object v1, p0, mCurrentDreamName:Landroid/content/ComponentName;
    ...
    iget v1, p0, mCurrentDreamUserId:I
    ...
    iget-boolean v1, p0, mCurrentDreamIsTest:Z
    ...
    iget-boolean v1, p0, mCurrentDreamCanDoze:Z
    ...
    iget-boolean v1, p0, mCurrentDreamIsDozing:Z
    ...
    iget-boolean v1, p0, mCurrentDreamIsWaking:Z
    ...
    iget v1, p0, mCurrentDreamDozeScreenState:I
    ...
    iget v1, p0, mCurrentDreamDozeScreenBrightness:I
    ...
    .line 138
    iget-object v0, p0, mHandler:Lcom/android/server/dreams/DreamManagerService$DreamHandler;
...
.method private finishSelfInternal(Landroid/os/IBinder;Z)V
    ...
    .line 186
    invoke-direct {p0, p2}, stopDreamLocked(Z)V
...
.method private getDozeComponent()Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v0}, getDozeComponent(I)Landroid/content/ComponentName;
...
.method private getDreamComponentsForUser(I)[Landroid/content/ComponentName;
    ...
    invoke-static {v6}, componentsFromString(Ljava/lang/String;)[Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v1}, validateDream(Landroid/content/ComponentName;)Z
...
.method private isDreamingInternal()Z
    ...
    iget-boolean v0, p0, mCurrentDreamIsTest:Z

    if-nez v0, :cond_12

    iget-boolean v0, p0, mCurrentDreamIsWaking:Z
...
.method private requestAwakenInternal()V
    ...
    .line 169
    invoke-direct {p0, v3}, stopDreamInternal(Z)V
...
.method private setDreamComponentsForUser(I[Landroid/content/ComponentName;)V
    ...
    invoke-static {p2}, componentsToString([Landroid/content/ComponentName;)Ljava/lang/String;
...
.method private startDozingInternal(Landroid/os/IBinder;II)V
    ...
    .line 223
    iput p2, p0, mCurrentDreamDozeScreenState:I

    .line 224
    iput p3, p0, mCurrentDreamDozeScreenBrightness:I
    ...
    iput-boolean v0, p0, mCurrentDreamIsDozing:Z
...
.method private startDreamInternal(Z)V
    ...
    .line 199
    .local v1, "userId":I
    invoke-direct {p0, p1, v1}, chooseDreamForUser(ZI)Landroid/content/ComponentName;
    ...
    :try_start_e
    invoke-direct {p0, v0, v2, p1, v1}, startDreamLocked(Landroid/content/ComponentName;ZZI)V
...
.method private startDreamLocked(Landroid/content/ComponentName;ZZI)V
    ...
    iget v0, p0, mCurrentDreamUserId:I
    ...
    invoke-direct {p0, v0}, stopDreamLocked(Z)V
    ...
    iput-object v2, p0, mCurrentDreamToken:Landroid/os/Binder;

    .line 359
    iput-object p1, p0, mCurrentDreamName:Landroid/content/ComponentName;

    .line 360
    iput-boolean p2, p0, mCurrentDreamIsTest:Z

    .line 361
    iput-boolean p3, p0, mCurrentDreamCanDoze:Z

    .line 362
    iput p4, p0, mCurrentDreamUserId:I

    .line 364
    iget-object v7, p0, mHandler:Lcom/android/server/dreams/DreamManagerService$DreamHandler;
...
.method private stopDreamLocked(Z)V
    ...
    iput-boolean v0, p0, mCurrentDreamIsWaking:Z
...
.method private testDreamInternal(Landroid/content/ComponentName;I)V
    ...
    :try_start_5
    invoke-direct {p0, p1, v0, v2, p2}, startDreamLocked(Landroid/content/ComponentName;ZZI)V
...
.method private validateDream(Landroid/content/ComponentName;)Z
    ...
    .line 261
    :cond_4
    invoke-direct {p0, p1}, getServiceInfo(Landroid/content/ComponentName;)Landroid/content/pm/ServiceInfo;
...
.method public onBootPhase(I)V
    ...
    .line 109
    iget-object v0, p0, mSystemPropertiesChanged:Ljava/lang/Runnable;
    ...
    iget-object v4, p0, mHandler:Lcom/android/server/dreams/DreamManagerService$DreamHandler;
