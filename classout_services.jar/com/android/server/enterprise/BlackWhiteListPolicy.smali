...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, mEffectiveBlacklist:Ljava/util/List;
    ...
    iput-object v0, p0, mEffectiveWhitelist:Ljava/util/List;

    .line 66
    const/4 v0, 0x0

    iput-boolean v0, p0, bUpdateToDB:Z
    ...
    .line 71
    iput-object p2, p0, mTable:Ljava/lang/String;
...
.method private addList(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 350
    :cond_28
    invoke-direct {p0, p1}, removeDuplicates(Ljava/util/List;)V
...
.method private addObjectsToList(ILjava/util/List;Ljava/lang/String;)Z
    ...
    .line 154
    .local v2, "ret":Z
    invoke-direct {p0, p2}, removeDuplicates(Ljava/util/List;)V
    ...
    iget-object v5, p0, mTable:Ljava/lang/String;
    ...
    .end local v3    # "where":Landroid/content/ContentValues;
    :cond_56
    invoke-direct {p0}, updateEffectivePolicy()V
...
.method private clearObjectsFromList(ILjava/lang/String;)Z
    ...
    iget-object v3, p0, mTable:Ljava/lang/String;
...
.method private createEffectiveList(ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, v2, v0}, getAllObjectsFromList(ILjava/lang/String;Ljava/util/List;)V

    .line 254
    invoke-direct {p0, p2, v0}, addList(Ljava/util/List;Ljava/util/List;)V

    .line 255
    const-string/jumbo v2, "white"

    invoke-direct {p0, p1, v2, v1}, getAllObjectsFromList(ILjava/lang/String;Ljava/util/List;)V

    .line 256
    invoke-direct {p0, p3, v1}, addList(Ljava/util/List;Ljava/util/List;)V

    .line 257
    invoke-direct {p0, p2, p3}, subtractList(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, v2, p2}, logList(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {p0, v2, p3}, logList(Ljava/lang/String;Ljava/util/List;)V
...
.method private createEffectiveListAllAdmins(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 286
    .local v4, "uid":I
    invoke-virtual {p0, v4}, isPolicyActive(I)Z
    ...
    invoke-direct {p0, v4, v6, v7}, createEffectiveList(ILjava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, v6}, addList(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, v6, p1}, logList(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {p0, v7, v6, v1}, subtractWhitelistFromOthersBlacklists(ILjava/util/List;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p2, v6}, addList(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, v6, p2}, logList(Ljava/lang/String;Ljava/util/List;)V
...
.method private getAllObjectsFromList(ILjava/lang/String;Ljava/util/List;)V
    ...
    iget-object v1, p0, mTable:Ljava/lang/String;
...
.method private getAllObjectsFromListForAllAdmins(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0, v4, p1, v3}, getAllObjectsFromList(ILjava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {p0, v4}, getPackageNameForUid(I)Ljava/lang/String;
...
.method private removeObjectsFromList(ILjava/util/List;Ljava/lang/String;)Z
    ...
    iget-object v4, p0, mTable:Ljava/lang/String;
...
.method private subtractWhitelistFromOthersBlacklists(ILjava/util/List;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p2, v2}, subtractList(Ljava/util/List;Ljava/util/List;)V
...
.method private updateEffectivePolicy()V
    ...
    .prologue
    .line 309
    iget-object v0, p0, mEffectiveBlacklist:Ljava/util/List;

    iget-object v1, p0, mEffectiveWhitelist:Ljava/util/List;

    invoke-direct {p0, v0, v1}, createEffectiveListAllAdmins(Ljava/util/List;Ljava/util/List;)V
...
.method public addObjectsToBlackList(ILjava/util/List;)Z
    ...
    invoke-direct {p0, p1, p2, v0}, addObjectsToList(ILjava/util/List;Ljava/lang/String;)Z
...
.method public clearObjectsFromBlackList(I)Z
    ...
    invoke-direct {p0, p1, v0}, clearObjectsFromList(ILjava/lang/String;)Z
...
.method public getAllObjectsFromBlackListForAllAdmins()Ljava/util/List;
    ...
    invoke-direct {p0, v0}, getAllObjectsFromListForAllAdmins(Ljava/lang/String;)Ljava/util/List;
...
.method public getEffectiveBlackList()Ljava/util/List;
    ...
    .prologue
    .line 121
    iget-boolean v0, p0, bUpdateToDB:Z
...
.method public getEffectiveWhiteList()Ljava/util/List;
    ...
    .line 117
    :cond_a
    iget-object v0, p0, mEffectiveWhitelist:Ljava/util/List;
...
.method public isObjectAllowed(Ljava/lang/String;)Z
    ...
    .line 129
    invoke-virtual {p0}, getEffectiveWhiteList()Ljava/util/List;

    move-result-object v2

    .line 130
    .local v2, "whitelist":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual {p0}, getEffectiveBlackList()Ljava/util/List;
...
.method public removeObjectsFromBlackList(ILjava/util/List;)Z
    ...
    invoke-direct {p0, p1, p2, v0}, removeObjectsFromList(ILjava/util/List;Ljava/lang/String;)Z
