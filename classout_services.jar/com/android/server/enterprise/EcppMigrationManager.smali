...
.method static constructor <clinit>()V
    ...
    sput-object v0, mInstance:Lcom/android/server/enterprise/EcppMigrationManager;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 58
    iput-object v0, p0, mEcppStorageProvider:Lcom/android/server/enterprise/storage/EcppStorageProvider;
    ...
    iput-object v0, p0, mDPMService:Landroid/app/admin/IDevicePolicyManager;
    ...
    iput-object v0, p0, mPasswordPolicyService:Landroid/app/enterprise/IPasswordPolicy;
...
.method private copyMaximumFailedPasswordsForDisable(ILandroid/app/enterprise/ContextInfo;Landroid/content/ComponentName;)V
    ...
    iget-object v4, p0, mEcppStorageProvider:Lcom/android/server/enterprise/storage/EcppStorageProvider;
    ...
    .line 407
    .local v2, "token":J
    iget-object v4, p0, mPasswordPolicyService:Landroid/app/enterprise/IPasswordPolicy;
...
.method private copyMaximumFailedPasswordsForWipe(IILandroid/content/ComponentName;)V
    ...
    .line 390
    .local v2, "token":J
    iget-object v4, p0, mDPMService:Landroid/app/admin/IDevicePolicyManager;
...
.method private copyMaximumTimeToLockPassword(IILandroid/content/ComponentName;)V
    ...
    iget-object v1, p0, mEcppStorageProvider:Lcom/android/server/enterprise/storage/EcppStorageProvider;
    ...
    .line 424
    .local v4, "token":J
    iget-object v1, p0, mDPMService:Landroid/app/admin/IDevicePolicyManager;
...
.method private copyPasswordVisible(ILandroid/app/enterprise/ContextInfo;)V
    ...
    iget-object v7, p0, mEcppStorageProvider:Lcom/android/server/enterprise/storage/EcppStorageProvider;
    ...
    .line 335
    .local v4, "token":J
    iget-object v7, p0, mPasswordPolicyService:Landroid/app/enterprise/IPasswordPolicy;
...
.method private findContainerData(ILandroid/content/ComponentName;)Z
    ...
    .prologue
    .line 224
    iget-object v0, p0, mEcppStorageProvider:Lcom/android/server/enterprise/storage/EcppStorageProvider;
...
.method static declared-synchronized getInstance(Landroid/content/Context;)Lcom/android/server/enterprise/EcppMigrationManager;
    ...
    :try_start_3
    sget-object v0, mInstance:Lcom/android/server/enterprise/EcppMigrationManager;
...
.method public migrateEcppDB(Landroid/content/ComponentName;IJ)Z
    ...
    :try_start_c
    invoke-direct {p0, v3, p1}, findContainerData(ILandroid/content/ComponentName;)Z
    :try_end_f
    ...
    :cond_1c
    :try_start_1c
    invoke-direct {p0, v3, p2, p1}, copyPasswordMinimumLength(IILandroid/content/ComponentName;)V
    :try_end_1f
    .catch Ljava/lang/Exception; {:try_start_1c .. :try_end_1f} :catch_5b

    .line 134
    :goto_1f
    :try_start_1f
    invoke-direct {p0, v3, p2, p1}, copyPasswordMinimumLetters(IILandroid/content/ComponentName;)V
    :try_end_22
    .catch Ljava/lang/Exception; {:try_start_1f .. :try_end_22} :catch_65

    .line 141
    :goto_22
    :try_start_22
    invoke-direct {p0, v3, p2, p1}, copyPasswordMinimumNonLetter(IILandroid/content/ComponentName;)V
    :try_end_25
    .catch Ljava/lang/Exception; {:try_start_22 .. :try_end_25} :catch_6f

    .line 148
    :goto_25
    :try_start_25
    invoke-direct {p0, v3, p2, p1}, copyPasswordMinimumNumeric(IILandroid/content/ComponentName;)V
    :try_end_28
    .catch Ljava/lang/Exception; {:try_start_25 .. :try_end_28} :catch_79

    .line 155
    :goto_28
    :try_start_28
    invoke-direct {p0, v3, p2, p1}, copyPasswordMinimumSymbols(IILandroid/content/ComponentName;)V
    :try_end_2b
    .catch Ljava/lang/Exception; {:try_start_28 .. :try_end_2b} :catch_83

    .line 162
    :goto_2b
    :try_start_2b
    invoke-direct {p0, v3, p2, p1}, copyPasswordQuality(IILandroid/content/ComponentName;)V
    :try_end_2e
    .catch Ljava/lang/Exception; {:try_start_2b .. :try_end_2e} :catch_8d

    .line 168
    :goto_2e
    :try_start_2e
    invoke-direct {p0, v3, v0}, copyPasswordVisible(ILandroid/app/enterprise/ContextInfo;)V
    :try_end_31
    .catch Ljava/lang/Exception; {:try_start_2e .. :try_end_31} :catch_96

    .line 175
    :goto_31
    :try_start_31
    invoke-direct {p0, v3, p2, p1}, copyPasswordHistoryLength(IILandroid/content/ComponentName;)V
    :try_end_34
    .catch Ljava/lang/NumberFormatException; {:try_start_31 .. :try_end_34} :catch_a0
    .catch Ljava/lang/Exception; {:try_start_31 .. :try_end_34} :catch_aa

    .line 185
    :goto_34
    :try_start_34
    invoke-direct {p0, v3, p2, p1}, copyMaximumFailedPasswordsForWipe(IILandroid/content/ComponentName;)V
    :try_end_37
    .catch Ljava/lang/Exception; {:try_start_34 .. :try_end_37} :catch_b4

    .line 192
    :goto_37
    :try_start_37
    invoke-direct {p0, v3, v0, p1}, copyMaximumFailedPasswordsForDisable(ILandroid/app/enterprise/ContextInfo;Landroid/content/ComponentName;)V
    :try_end_3a
    .catch Ljava/lang/Exception; {:try_start_37 .. :try_end_3a} :catch_bf

    .line 199
    :goto_3a
    :try_start_3a
    invoke-direct {p0, v3, p2, p1}, copyMaximumTimeToLockPassword(IILandroid/content/ComponentName;)V
    :try_end_3d
    .catch Ljava/lang/NumberFormatException; {:try_start_3a .. :try_end_3d} :catch_ca
    .catch Ljava/lang/Exception; {:try_start_3a .. :try_end_3d} :catch_d5

    .line 209
    :goto_3d
    :try_start_3d
    invoke-direct {p0, v3, p2, p1}, copyPasswordExpirationTimeout(IILandroid/content/ComponentName;)V
    :try_end_40
    .catch Ljava/lang/NumberFormatException; {:try_start_3d .. :try_end_40} :catch_e0
    .catch Ljava/lang/Exception; {:try_start_3d .. :try_end_40} :catch_eb
