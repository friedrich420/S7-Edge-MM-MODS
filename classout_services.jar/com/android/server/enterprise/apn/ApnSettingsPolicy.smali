...
.method static constructor <clinit>()V
    ...
    sput v0, AUTH_TYPE_NOTSET:I

    .line 68
    const/4 v0, 0x0

    sput v0, AUTH_TYPE_NONE:I

    .line 70
    const/4 v0, 0x1

    sput v0, AUTH_TYPE_PAP:I

    .line 72
    const/4 v0, 0x2

    sput v0, AUTH_TYPE_CHAP:I

    .line 74
    const/4 v0, 0x3

    sput v0, AUTH_TYPE_PAP_OR_CHAP:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, dunRequired:Z
...
.method private isValidApnId(J)Z
    ...
    invoke-virtual {v0, v3}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
    :try_end_90
    .catch Ljava/lang/Exception; {:try_start_1c .. :try_end_90} :catch_9a
    .catchall {:try_start_1c .. :try_end_90} :catchall_a4
...
.method public declared-synchronized addUpdateApn(Landroid/app/enterprise/ContextInfo;ZLandroid/app/enterprise/ApnSettings;)J
    ...
    :try_start_1
    invoke-direct/range {p0 .. p1}, enforceOwnerOnlyAndApnPermission(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ContextInfo;
    :try_end_4
    .catchall {:try_start_1 .. :try_end_4} :catchall_36e
    ...
    invoke-direct {v0, v1}, validateString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, validateString(Ljava/lang/String;)Ljava/lang/String;
    :try_end_ae
    .catchall {:try_start_11 .. :try_end_ae} :catchall_36e
    ...
    invoke-static/range {v34 .. v35}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_19d
    .catch Ljava/lang/Exception; {:try_start_af .. :try_end_19d} :catch_366
    .catchall {:try_start_af .. :try_end_19d} :catchall_36e
    ...
    invoke-direct {v0, v13}, validateString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v8}, validateString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, setColumnValue(ZLandroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, v3, v9}, setColumnValue(ZLandroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)V
    ...
    if-ge v0, v10, :cond_390

    const/16 v35, 0x4

    move/from16 v0, v35

    if-le v0, v10, :cond_390
    ...
    invoke-direct {v0, v1, v2, v3, v8}, setColumnValue(ZLandroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 300
    const-string/jumbo v34, "current"
    ...
    :try_end_361
    .catch Ljava/lang/Exception; {:try_start_19f .. :try_end_361} :catch_3ad
    .catchall {:try_start_19f .. :try_end_361} :catchall_36e
    ...
    :try_end_36c
    .catchall {:try_start_369 .. :try_end_36c} :catchall_36e
    ...
    invoke-virtual/range {v33 .. v35}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    :try_end_3ab
    .catch Ljava/lang/Exception; {:try_start_371 .. :try_end_3ab} :catch_3ad
    .catchall {:try_start_371 .. :try_end_3ab} :catchall_36e
    ...
    invoke-virtual {v14}, Ljava/lang/Exception;->printStackTrace()V
    :try_end_3b1
    .catchall {:try_start_3ae .. :try_end_3b1} :catchall_36e
    ...
    invoke-static/range {v34 .. v35}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3f6
    .catch Ljava/lang/Exception; {:try_start_3b5 .. :try_end_3f6} :catch_3ad
    .catchall {:try_start_3b5 .. :try_end_3f6} :catchall_36e
...
.method public declared-synchronized deleteApn(Landroid/app/enterprise/ContextInfo;J)Z
    ...
    .local v1, "rowCount":I
    :try_start_3
    invoke-direct {p0, p1}, enforceOwnerOnlyAndApnPermission(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ContextInfo;
    ...
    invoke-static {v4, v5}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_41
    .catch Ljava/lang/Exception; {:try_start_16 .. :try_end_41} :catch_45
    .catchall {:try_start_16 .. :try_end_41} :catchall_4a
...
.method public getApnList(Landroid/app/enterprise/ContextInfo;)Ljava/util/List;
    ...
    invoke-direct/range {p0 .. p0}, getApnListConditionStr()Ljava/lang/String;
    ...
    :try_end_82
    .catch Ljava/lang/Exception; {:try_start_6b .. :try_end_82} :catch_168
    .catchall {:try_start_6b .. :try_end_82} :catchall_172
    ...
    invoke-direct {v0, v2, v12}, getColumnValue(Ljava/lang/String;Landroid/database/Cursor;)Ljava/lang/String;
    ...
    :try_end_15e
    .catch Ljava/lang/Exception; {:try_start_82 .. :try_end_15e} :catch_17c
    .catchall {:try_start_82 .. :try_end_15e} :catchall_179
    ...
    :try_end_16c
    .catchall {:try_start_169 .. :try_end_16c} :catchall_172
...
.method public getApnSettings(Landroid/app/enterprise/ContextInfo;J)Landroid/app/enterprise/ApnSettings;
    ...
    invoke-direct {v0, v2, v10}, getColumnValue(Ljava/lang/String;Landroid/database/Cursor;)Ljava/lang/String;
    ...
    :try_end_103
    .catch Ljava/lang/Exception; {:try_start_15 .. :try_end_103} :catch_112
    .catchall {:try_start_15 .. :try_end_103} :catchall_11c
    ...
    :try_end_116
    .catchall {:try_start_113 .. :try_end_116} :catchall_11c
...
.method public getPreferredApn(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ApnSettings;
    ...
    .line 531
    invoke-virtual {p0, p1, v8, v9}, getApnSettings(Landroid/app/enterprise/ContextInfo;J)Landroid/app/enterprise/ApnSettings;
    :try_end_65
    .catch Ljava/lang/Exception; {:try_start_d .. :try_end_65} :catch_6c
    .catchall {:try_start_d .. :try_end_65} :catchall_8c
    ...
    invoke-static {v0, v1}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_86
    .catchall {:try_start_6d .. :try_end_86} :catchall_8c
...
.method public declared-synchronized setPreferredApn(Landroid/app/enterprise/ContextInfo;J)Z
    ...
    :cond_2a
    :try_start_2a
    invoke-direct {p0, p2, p3}, isValidApnId(J)Z
