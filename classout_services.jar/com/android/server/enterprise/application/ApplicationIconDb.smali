...
.method private insertNewColumns(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1, v2}, isTableExists(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v2}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V
    :try_end_94
    .catch Landroid/database/SQLException; {:try_start_8 .. :try_end_94} :catch_95
...
.method clearChangedApplicationName(I)Ljava/util/ArrayList;
    ...
    const-string/jumbo v8, "imagedata"
    ...
    :try_end_bd
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_7 .. :try_end_bd} :catch_c3
    .catchall {:try_start_7 .. :try_end_bd} :catchall_cd
...
.method deleteApplicationIcon(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0}, getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_6} :catch_d0
    ...
    :try_end_8e
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_8e} :catch_d0
    .catchall {:try_start_10 .. :try_end_8e} :catchall_da
    ...
    :try_end_cb
    .catch Ljava/lang/Exception; {:try_start_9a .. :try_end_cb} :catch_d0
    .catchall {:try_start_9a .. :try_end_cb} :catchall_da
...
.method deleteApplicationName(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0}, getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_6
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_3 .. :try_end_6} :catch_d6
    .catchall {:try_start_3 .. :try_end_6} :catchall_e0
    ...
    invoke-virtual {v2, v7, v6, v8, v9}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_94
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_10 .. :try_end_94} :catch_d6
    .catchall {:try_start_10 .. :try_end_94} :catchall_e0
    ...
    invoke-virtual {v2, v7, v8, v9}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_d1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_a0 .. :try_end_d1} :catch_d6
    .catchall {:try_start_a0 .. :try_end_d1} :catchall_e0
...
.method getApplicationIcon(Ljava/lang/String;I)[B
    ...
    :try_end_7
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_7} :catch_59
    ...
    :try_end_51
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_51} :catch_59
    .catchall {:try_start_10 .. :try_end_51} :catchall_7d
    ...
    :try_end_77
    .catchall {:try_start_5a .. :try_end_77} :catchall_7d
...
.method getApplicationIconChangedMap()Ljava/util/HashMap;
    ...
    .catchall {:try_start_7 .. :try_end_a} :catchall_9a
    ...
    :try_end_6e
    .catch Ljava/lang/Exception; {:try_start_13 .. :try_end_6e} :catch_6f
    .catchall {:try_start_13 .. :try_end_6e} :catchall_9a
    ...
    :try_end_8d
    .catchall {:try_start_70 .. :try_end_8d} :catchall_9a
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/enterprise/log/Log;->i(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_28
    .catch Landroid/database/SQLException; {:try_start_8 .. :try_end_28} :catch_29
    ...
    :cond_35
    invoke-direct {p0, p1}, insertNewColumns(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method updateApplicationIcon(Ljava/lang/String;[BI)Z
    ...
    invoke-virtual {p0}, getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_6} :catch_b6
    .catchall {:try_start_3 .. :try_end_6} :catchall_c0
    ...
    :try_end_81
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_81} :catch_b6
    .catchall {:try_start_10 .. :try_end_81} :catchall_c0
    ...
    :try_end_ad
    .catch Ljava/lang/Exception; {:try_start_8c .. :try_end_ad} :catch_b6
    .catchall {:try_start_8c .. :try_end_ad} :catchall_c0
...
.method updateApplicationName(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0}, getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_7 .. :try_end_a} :catch_cf
    .catchall {:try_start_7 .. :try_end_a} :catchall_d9
    ...
    :try_end_8f
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_14 .. :try_end_8f} :catch_cf
    .catchall {:try_start_14 .. :try_end_8f} :catchall_d9
    ...
    :try_end_c6
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_9b .. :try_end_c6} :catch_cf
    .catchall {:try_start_9b .. :try_end_c6} :catchall_d9
