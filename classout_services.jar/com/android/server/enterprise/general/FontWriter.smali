...
.method public constructor <init>()V
    ...
    .line 68
    iput-object v0, p0, fOut:Ljava/io/FileOutputStream;

    .line 70
    iput-object v0, p0, osw:Ljava/io/OutputStreamWriter;

    .line 72
    iput-object v0, p0, bos:Ljava/io/BufferedOutputStream;
...
.method public copyFontFile(Ljava/io/File;Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    iput-object v12, p0, fOut:Ljava/io/FileOutputStream;

    .line 389
    new-instance v12, Ljava/io/BufferedOutputStream;

    iget-object v13, p0, fOut:Ljava/io/FileOutputStream;

    invoke-direct {v12, v13}, Ljava/io/BufferedOutputStream;-><init>(Ljava/io/OutputStream;)V

    iput-object v12, p0, bos:Ljava/io/BufferedOutputStream;
    ...
    .line 401
    iget-object v12, p0, bos:Ljava/io/BufferedOutputStream;
    ...
    :goto_51
    :try_start_51
    iget-object v12, p0, fOut:Ljava/io/FileOutputStream;
    ...
    :cond_63
    :goto_63
    invoke-virtual {p0, v0}, changeFilePermission(Ljava/lang/String;)V
    ...
    :goto_e5
    :try_start_e5
    iget-object v13, p0, bos:Ljava/io/BufferedOutputStream;
...
.method public copyFontFile1(Ljava/io/File;Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v11}, changeFilePermission(Ljava/lang/String;)V
...
.method public createFontDirectory(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    :try_end_f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_9 .. :try_end_f} :catch_37
    ...
    invoke-direct {p0, v6, v11}, deleteFolder(Ljava/io/File;Ljava/lang/String;)Z
    ...
    throw v11
    :try_end_8f
    .catch Ljava/io/IOException; {:try_start_5f .. :try_end_8f} :catch_8f
    .catch Ljava/lang/InterruptedException; {:try_start_5f .. :try_end_8f} :catch_a0
...
.method public writeLoc(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, p0, fOut:Ljava/io/FileOutputStream;

    .line 118
    new-instance v4, Ljava/io/OutputStreamWriter;

    iget-object v5, p0, fOut:Ljava/io/FileOutputStream;

    invoke-direct {v4, v5}, Ljava/io/OutputStreamWriter;-><init>(Ljava/io/OutputStream;)V

    iput-object v4, p0, osw:Ljava/io/OutputStreamWriter;

    .line 120
    iget-object v4, p0, osw:Ljava/io/OutputStreamWriter;
    ...
    .line 124
    iget-object v4, p0, fOut:Ljava/io/FileOutputStream;
    ...
    .line 137
    :try_start_9e
    iget-object v5, p0, osw:Ljava/io/OutputStreamWriter;
