...
.method static constructor <clinit>()V
    ...
    sput-object v0, tblColumns:[Ljava/lang/String;
...
.method private constructContentValues(Landroid/app/enterprise/lso/LSOItemData;IJ)Landroid/content/ContentValues;
    ...
    .line 574
    .local v2, "error":Z
    sget-object v10, tblColumns:[Ljava/lang/String;
...
.method private getAdminUid(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v1, v2, p1}, getAdminByField(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
...
.method private loadContainerData(Landroid/app/enterprise/lso/LSOItemContainer;Landroid/database/Cursor;)V
    ...
    sget-object v8, tblColumns:[Ljava/lang/String;

    const/4 v9, 0x0

    invoke-virtual {p0, v7, v8, v4, v9}, getCursor(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 465
    invoke-direct {p0, v3, v0}, loadItemData(Landroid/app/enterprise/lso/LSOItemData;Landroid/database/Cursor;)V
...
.method private loadItemData(Landroid/app/enterprise/lso/LSOItemData;Landroid/database/Cursor;)V
    ...
    .end local p1    # "lsoData":Landroid/app/enterprise/lso/LSOItemData;
    invoke-direct {p0, p1, p2}, loadTextData(Landroid/app/enterprise/lso/LSOItemText;Landroid/database/Cursor;)V
    ...
    .end local p1    # "lsoData":Landroid/app/enterprise/lso/LSOItemData;
    invoke-direct {p0, p1, p2}, loadImageData(Landroid/app/enterprise/lso/LSOItemImage;Landroid/database/Cursor;)V
    ...
    .end local p1    # "lsoData":Landroid/app/enterprise/lso/LSOItemData;
    invoke-direct {p0, p1, p2}, loadContainerData(Landroid/app/enterprise/lso/LSOItemContainer;Landroid/database/Cursor;)V
    ...
    .end local p1    # "lsoData":Landroid/app/enterprise/lso/LSOItemData;
    invoke-direct {p0, p1, p2}, loadWidgetData(Landroid/app/enterprise/lso/LSOItemWidget;Landroid/database/Cursor;)V
...
.method private setOverlayData(Landroid/app/enterprise/lso/LSOItemData;IJ)Z
    ...
    .line 538
    :cond_4
    invoke-direct {p0, p1, p2, p3, p4}, constructContentValues(Landroid/app/enterprise/lso/LSOItemData;IJ)Landroid/content/ContentValues;
    ...
    invoke-direct {p0, v5, v0}, insertRecord(Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    invoke-direct {p0, v5, p2, v6, v7}, setOverlayData(Landroid/app/enterprise/lso/LSOItemData;IJ)Z
...
.method private wipeLayerData(I)V
    ...
    invoke-virtual {p0, v2}, remove(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v0, v1}, deleteDataByFields(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
...
.method public getAdminPref()Landroid/app/enterprise/lso/LSOAttributeSet;
    ...
    invoke-virtual {p0, v5, v3, v4, v2}, getCursor(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public getOverlay(I)Landroid/app/enterprise/lso/LSOItemData;
    ...
    sget-object v7, tblColumns:[Ljava/lang/String;

    const/4 v8, 0x0

    invoke-virtual {p0, v6, v7, v3, v8}, getCursor(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .catchall {:try_start_1b .. :try_end_2d} :catchall_7b
    ...
    .catchall {:try_start_33 .. :try_end_40} :catchall_7b
    ...
    :cond_62
    :try_start_62
    invoke-direct {p0, v2, v0}, loadItemData(Landroid/app/enterprise/lso/LSOItemData;Landroid/database/Cursor;)V
    :try_end_65
    .catch Ljava/lang/Exception; {:try_start_62 .. :try_end_65} :catch_6c
    .catchall {:try_start_62 .. :try_end_65} :catchall_7b
    ...
    :try_end_75
    .catchall {:try_start_6d .. :try_end_75} :catchall_7b
...
.method public getOverlayAdminUid()I
    ...
    invoke-direct {p0, v0}, getAdminUid(Ljava/lang/String;)I
...
.method public isEmpty()Z
    ...
    invoke-virtual {p0, v0}, getCount(Ljava/lang/String;)I
...
.method public resetOverlayData(I)V
    ...
    .prologue
    .line 223
    invoke-direct {p0, p1}, wipeLayerData(I)V
    ...
    invoke-direct {p0, v1, v2, v0}, deleteRecord(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)J
...
.method public setOverlayData(JLandroid/app/enterprise/lso/LSOItemData;ILandroid/app/enterprise/lso/LSOAttributeSet;)Z
    ...
    .line 253
    :cond_11
    invoke-virtual {p0}, getOverlayAdminUid()I

    move-result v1

    .line 254
    .local v1, "overlayAdminUID":I
    invoke-direct {p0, p4}, wipeLayerData(I)V

    .line 256
    const-wide/16 v4, 0x0

    invoke-direct {p0, p3, p4, v4, v5}, setOverlayData(Landroid/app/enterprise/lso/LSOItemData;IJ)Z
    ...
    .line 258
    invoke-virtual {p0, v3}, resetOverlayData(I)V
    ...
    invoke-direct {p0, v4, v0}, insertRecord(Ljava/lang/String;Landroid/content/ContentValues;)J
...
.method public setWallpaperData(JLjava/lang/String;)Z
    ...
    .line 284
    .local v1, "result":Z
    invoke-virtual {p0}, resetWallpaperData()V
    ...
    invoke-direct {p0, v2, v0}, insertRecord(Ljava/lang/String;Landroid/content/ContentValues;)J
...
.method public updateAdminPref(Landroid/app/enterprise/lso/LSOAttributeSet;)Z
    ...
    invoke-direct {p0, v4, v0, v3, v2}, updateRecord(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
