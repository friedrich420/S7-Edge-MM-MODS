...
.method constructor <init>(Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;Landroid/content/pm/PersonaState;Landroid/content/pm/PersonaState;)V
    ...
    .prologue
    .line 336
    iput-object p1, p0, this$1:Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;

    iput-object p2, p0, val$previousState:Landroid/content/pm/PersonaState;

    iput-object p3, p0, val$newState:Landroid/content/pm/PersonaState;
...
.method public run()V
    ...
    .line 341
    :try_start_0
    iget-object v2, p0, val$previousState:Landroid/content/pm/PersonaState;
    ...
    iget-object v2, p0, val$newState:Landroid/content/pm/PersonaState;
    ...
    iget-object v4, p0, this$1:Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;

    # getter for: Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;->containerId:I
    invoke-static {v4}, Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;->access$600(Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;)I
    ...
    .line 343
    iget-object v2, p0, this$1:Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;
    ...
    iget-object v3, p0, this$1:Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;
    ...
    # getter for: Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;->containerId:I
    invoke-static {v3}, Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;->access$800(Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;)I
    ...
    # getter for: Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;->containerId:I
    invoke-static {v4}, Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;->access$1000(Lcom/android/server/enterprise/security/SecurityPolicy$PersonaObserver;)I
