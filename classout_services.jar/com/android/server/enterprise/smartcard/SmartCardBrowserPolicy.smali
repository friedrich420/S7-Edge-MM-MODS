...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 77
    iput-object v0, p0, preAuthState:Ljava/util/Map;
...
.method public disableAuthentication(Landroid/app/enterprise/ContextInfo;)Z
    ...
    :try_start_b
    invoke-virtual {p0, p1}, isAuthenticationEnabled(Landroid/app/enterprise/ContextInfo;)Z
    ...
    invoke-direct {p0, v0, v2, v10}, broadcastIntentAsUser(ZII)V
...
.method public enableAuthentication(Landroid/app/enterprise/ContextInfo;)Z
    ...
    .prologue
    .line 108
    invoke-direct/range {p0 .. p1}, enforcePermission(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ContextInfo;
    ...
    .local v10, "ident":J
    :try_start_10
    invoke-virtual/range {p0 .. p1}, isAuthenticationEnabled(Landroid/app/enterprise/ContextInfo;)Z
    ...
    iget-object v2, v0, mPms:Lcom/android/server/pm/PackageManagerService;

    sget-object v3, packageName:Ljava/lang/String;
    ...
    sget-object v5, packageName:Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v4, v1}, broadcastIntentAsUser(ZII)V
    ...
    .catchall {:try_start_10 .. :try_end_c3} :catchall_d6
    ...
    invoke-static {v2, v3}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_d0
    .catchall {:try_start_c8 .. :try_end_d0} :catchall_d6
...
.method public getClientCertificateAlias(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 276
    invoke-direct {p0, v0, v1, p2, p3}, getClientCertificateAliasAsUser(IILjava/lang/String;I)Ljava/lang/String;
...
.method public isAuthenticationEnabled(Landroid/app/enterprise/ContextInfo;)Z
    ...
    invoke-direct {p0, v1, v0}, isAuthenticationEnabledAsUser(II)Z
...
.method public onAdminRemoved(I)V
    ...
    .line 329
    .local v2, "userId":I
    iget-object v5, p0, preAuthState:Ljava/util/Map;
    ...
    :try_start_f
    invoke-direct {p0, v3, v2}, isAuthenticationEnabledAsUser(II)Z

    move-result v0

    .line 331
    .local v0, "curr_auth_state":Z
    iget-object v3, p0, preAuthState:Ljava/util/Map;
    ...
    .line 341
    invoke-direct {p0, v0, v4, v2}, broadcastIntentAsUser(ZII)V
...
.method public onPreAdminRemoval(I)V
    ...
    .line 350
    .local v0, "userId":I
    iget-object v2, p0, preAuthState:Ljava/util/Map;

    monitor-enter v2

    .line 351
    :try_start_c
    iget-object v1, p0, preAuthState:Ljava/util/Map;
    ...
    invoke-direct {p0, v4, v0}, isAuthenticationEnabledAsUser(II)Z
...
.method public setClientCertificateAlias(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;ILjava/lang/String;)Z
    ...
    .line 232
    invoke-direct {p0, v0, v5, p2, p3}, getClientCertificateAliasAsUser(IILjava/lang/String;I)Ljava/lang/String;
    ...
    :try_end_a9
    .catch Ljava/lang/Exception; {:try_start_69 .. :try_end_a9} :catch_ab
