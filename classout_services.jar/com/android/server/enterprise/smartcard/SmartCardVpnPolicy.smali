...
.method private broadcastIntent()V
    ...
    iget v1, p0, mVpnProfiles:I

    .line 267
    .local v1, "vpnProfilesPrev":I
    invoke-direct {p0}, getVpnProfileCount()I

    move-result v2

    iput v2, p0, mVpnProfiles:I

    .line 269
    if-lez v1, :cond_24

    iget v2, p0, mVpnProfiles:I
...
.method private isAuthenticationEnabledAsUser(I)Z
    ...
    invoke-direct {p0, p1, v1}, getVpnProfileCountAsUser(ILjava/lang/String;)I
...
.method public isAuthenticationEnabled()Z
    ...
    .line 185
    .local v1, "userId":I
    invoke-direct {p0, v1}, isAuthenticationEnabledAsUser(I)Z
...
.method public isCredentialRequired(Ljava/lang/String;)Z
    ...
    .line 168
    invoke-direct {p0, v2, p1}, getVpnProfileCountAsUser(ILjava/lang/String;)I
...
.method public onAdminRemoved(I)V
    ...
    invoke-direct {p0, v2, v3}, getVpnProfileCountAsUser(ILjava/lang/String;)I
    ...
    .line 221
    :cond_12
    invoke-direct {p0, v1, v2}, broadcastIntentAsUser(ZI)V
...
.method public requireCredentials(Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, v7, v10}, getVpnProfileCountAsUser(ILjava/lang/String;)I
    ...
    invoke-direct {p0, v10, v7}, broadcastIntentAsUser(ZI)V
