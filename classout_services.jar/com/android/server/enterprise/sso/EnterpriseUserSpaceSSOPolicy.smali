...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, BIND_ACTION_SSO_SERVICE_FOR_KNOX2:Ljava/lang/String;

    .line 93
    iput v1, p0, SSO_BIND_SUCCESS:I

    .line 94
    iput v2, p0, SSO_BIND_FAILURE:I

    .line 95
    iput v1, p0, SSO_BIND_RESULT_FAILURE:I

    .line 96
    iput v2, p0, SSO_BIND_RESULT_SUCCESS:I
...
.method static synthetic access$000(Lcom/android/server/enterprise/sso/EnterpriseUserSpaceSSOPolicy;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 82
    iget-object v0, p0, clientsList:Ljava/util/ArrayList;
...
.method static synthetic access$400(Lcom/android/server/enterprise/sso/EnterpriseUserSpaceSSOPolicy;ILjava/lang/String;)V
    ...
    .prologue
    .line 82
    invoke-direct {p0, p1, p2}, updateClintEntry(ILjava/lang/String;)V
...
.method static synthetic access$900(Lcom/android/server/enterprise/sso/EnterpriseUserSpaceSSOPolicy;IILjava/lang/String;)Z
    ...
    .prologue
    .line 82
    invoke-direct {p0, p1, p2, p3}, bindSSOInterfaces(IILjava/lang/String;)Z
...
.method private enforceEnterpriseSSOPermission(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ContextInfo;
    ...
    .line 183
    invoke-virtual {p0, p1}, getUserId(Landroid/app/enterprise/ContextInfo;)I
    ...
    invoke-direct {p0, v2, v1}, isExistingOrFirstClient(II)Z
...
.method public deleteSSOWhiteListInUserSpace(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Ljava/util/List;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    :try_end_7c
    .catch Ljava/lang/Exception; {:try_start_62 .. :try_end_7c} :catch_7d
    ...
    invoke-direct {p0, v7}, getSSOInterface(I)Lcom/sec/android/service/singlesignon/IEnterpriseSecurityManager2;
    ...
    invoke-virtual {v5, v8, v9}, Landroid/app/enterprise/EnterpriseResponseData;->setStatus(II)V
    :try_end_b9
    .catch Ljava/lang/Exception; {:try_start_86 .. :try_end_b9} :catch_7d
...
.method public forceReauthenticateInUserSpace(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    .local v3, "userId":I
    :try_start_5d
    invoke-direct {p0, v3}, getSSOInterface(I)Lcom/sec/android/service/singlesignon/IEnterpriseSecurityManager2;
...
.method public isSSOReadyInUserSpace(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    const-string/jumbo v7, "inside  isSSOReadyInUserSpace :"
    ...
    invoke-virtual {v2, v4}, Landroid/app/enterprise/EnterpriseResponseData;->setData(Ljava/lang/Object;)V
    :try_end_ad
    .catch Ljava/lang/Exception; {:try_start_a8 .. :try_end_ad} :catch_9f
...
.method public onPreAdminRemoval(I)V
    ...
    invoke-direct {p0, v0}, getSSOInterface(I)Lcom/sec/android/service/singlesignon/IEnterpriseSecurityManager2;
    ...
    invoke-direct {p0, p1, v0, v4}, bindSSOInterfaces(IILjava/lang/String;)Z
    ...
    invoke-virtual {p0, v0, v4}, unenrollInUserSpace(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)Landroid/app/enterprise/EnterpriseResponseData;
...
.method public setCustomerInfoInUserSpace(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    invoke-virtual {v1, v4, v5}, Landroid/app/enterprise/EnterpriseResponseData;->setStatus(II)V
    :try_end_a3
    .catch Ljava/lang/Exception; {:try_start_5d .. :try_end_a3} :catch_a4
...
.method public setupSSOInUserSpace(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    invoke-direct {p0, v8, v7}, isExistingOrFirstClient(II)Z
    ...
    invoke-direct {p0, v8, v7, p2}, bindSSOInterfaces(IILjava/lang/String;)Z
    ...
    iget-object v8, p0, clientsList:Ljava/util/ArrayList;
...
.method public systemReady()V
    ...
    invoke-direct {p0, v0, v6, v4}, bindSSOInterfaces(IILjava/lang/String;)Z
...
.method public unenrollInUserSpace(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    .local v4, "userId":I
    :try_start_6e
    invoke-direct {p0, v4}, getSSOInterface(I)Lcom/sec/android/service/singlesignon/IEnterpriseSecurityManager2;
