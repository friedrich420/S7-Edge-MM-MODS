...
.method static constructor <clinit>()V
    ...
    .line 23
    sput-object v2, sUriMatcher:Landroid/content/UriMatcher;

    .line 25
    sput-object v2, mQuotesPreferencesProjectionMap:Ljava/util/HashMap;

    .line 28
    sput-object v2, mSelfInstance:Lcom/android/server/enterprise/storage/ContainerStorageProvider;
    ...
    sput-object v0, sUriMatcher:Landroid/content/UriMatcher;

    .line 31
    sget-object v0, sUriMatcher:Landroid/content/UriMatcher;
    ...
    sput-object v0, mQuotesPreferencesProjectionMap:Ljava/util/HashMap;

    .line 33
    sget-object v0, mQuotesPreferencesProjectionMap:Ljava/util/HashMap;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 24
    iput-object v0, p0, mDbHelper:Lcom/android/server/enterprise/storage/ContainerStorageHelper;

    .line 26
    iput-object v0, p0, mContext:Landroid/content/Context;

    .line 27
    iput-object v0, p0, mSQLiteDataBaseObj:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 94
    iget-object v0, p0, mDbHelper:Lcom/android/server/enterprise/storage/ContainerStorageHelper;
...
.method private checkIfNullUriMatcher(Landroid/net/Uri;)Z
    ...
    sget-object v4, sUriMatcher:Landroid/content/UriMatcher;
...
.method private getCursorForQuery(Landroid/database/sqlite/SQLiteQueryBuilder;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Landroid/database/Cursor;
    ...
    .prologue
    .line 171
    iget-object v0, p0, mSQLiteDataBaseObj:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 175
    iget-object v1, p0, mSQLiteDataBaseObj:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v2, p0, mSQLiteDataBaseObj:Landroid/database/sqlite/SQLiteDatabase;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/android/server/enterprise/storage/ContainerStorageProvider;
    ...
    :try_start_3
    sget-object v0, mSelfInstance:Lcom/android/server/enterprise/storage/ContainerStorageProvider;
    ...
    sput-object v0, mSelfInstance:Lcom/android/server/enterprise/storage/ContainerStorageProvider;
...
.method private getSQLiteQueryBuilderObj(Landroid/net/Uri;)Landroid/database/sqlite/SQLiteQueryBuilder;
    ...
    invoke-direct {p0, p1}, getTableNameForUri(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {p0, v0, v1}, updateBuilderObj(Landroid/database/sqlite/SQLiteQueryBuilder;Ljava/lang/String;)V
...
.method private declared-synchronized query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_18
    :try_start_18
    invoke-direct {p0, p1}, checkIfNullUriMatcher(Landroid/net/Uri;)Z
    :try_end_1b
    ...
    :cond_21
    :try_start_21
    invoke-direct {p0, p1}, getSQLiteQueryBuilderObj(Landroid/net/Uri;)Landroid/database/sqlite/SQLiteQueryBuilder;
    ...
    .line 163
    invoke-direct/range {v0 .. v6}, getCursorForQuery(Landroid/database/sqlite/SQLiteQueryBuilder;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Landroid/database/Cursor;
    :try_end_2e
...
.method private returnCursorAsPerColumnName([Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 114
    invoke-direct/range {v0 .. v5}, query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public getPackageNames(I)Ljava/util/List;
    ...
    invoke-direct {p0, v2, v5, v4}, returnCursorAsPerColumnName([Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Landroid/database/Cursor;
