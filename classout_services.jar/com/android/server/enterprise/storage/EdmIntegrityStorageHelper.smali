...
.method static constructor <clinit>()V
    ...
    sput-object v1, mInstance:Lcom/android/server/enterprise/storage/EdmIntegrityStorageHelper;
...
.method static declared-synchronized getInstance(Landroid/content/Context;)Lcom/android/server/enterprise/storage/EdmIntegrityStorageHelper;
    ...
    :try_start_3
    sget-object v0, mInstance:Lcom/android/server/enterprise/storage/EdmIntegrityStorageHelper;
    ...
    sput-object v0, mInstance:Lcom/android/server/enterprise/storage/EdmIntegrityStorageHelper;
...
.method public commitFingerPrint(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, v3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V
    :try_end_bc
    .catch Ljava/lang/Exception; {:try_start_14 .. :try_end_bc} :catch_bd
...
.method public final getAdminISAMapFromDB(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_71
    .catch Ljava/lang/Exception; {:try_start_25 .. :try_end_71} :catch_72
    .catchall {:try_start_25 .. :try_end_71} :catchall_95
    ...
    :try_end_88
    .catch Ljava/lang/Exception; {:try_start_85 .. :try_end_88} :catch_72
...
.method public getPackageListfromDB(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    ...
    .catchall {:try_start_2f .. :try_end_63} :catchall_c2
    ...
    :try_end_7d
    .catch Ljava/lang/Exception; {:try_start_78 .. :try_end_7d} :catch_64
    .catchall {:try_start_78 .. :try_end_7d} :catchall_c2
    ...
    :try_end_b2
    .catch Ljava/lang/Exception; {:try_start_7f .. :try_end_b2} :catch_cc
    .catchall {:try_start_7f .. :try_end_b2} :catchall_c9
...
.method public rollbackFingerPrint(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, v3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V
    :try_end_93
    .catch Ljava/lang/Exception; {:try_start_15 .. :try_end_93} :catch_94
...
.method updateFingerPrint(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;)Z
    ...
    const-string/jumbo v18, "fpDirty"
    ...
    const-string/jumbo v17, "fpDirty"
    ...
    :try_end_b3
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_b3} :catch_bc
...
.method writeFingerPrint(Ljava/lang/String;Landroid/content/ContentValues;)Z
    ...
    const-string/jumbo v19, "isaPackageName"
    ...
    const-string/jumbo v19, "fpDirty"
    ...
    .end local v12    # "i$":Ljava/util/Iterator;
    :cond_139
    const-string/jumbo v18, "fpNewRow"
    ...
    :try_end_156
    .catch Ljava/lang/Exception; {:try_start_125 .. :try_end_156} :catch_fd
