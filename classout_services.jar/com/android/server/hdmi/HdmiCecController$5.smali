...
.method constructor <init>(Lcom/android/server/hdmi/HdmiCecController;ILjava/lang/Integer;ILjava/util/List;Ljava/util/List;Lcom/android/server/hdmi/HdmiControlService$DevicePollingCallback;)V
    ...
    iput p2, p0, val$sourceAddress:I

    iput-object p3, p0, val$candidate:Ljava/lang/Integer;

    iput p4, p0, val$retryCount:I

    iput-object p5, p0, val$allocated:Ljava/util/List;

    iput-object p6, p0, val$candidates:Ljava/util/List;

    iput-object p7, p0, val$callback:Lcom/android/server/hdmi/HdmiControlService$DevicePollingCallback;
...
.method public run()V
    ...
    .prologue
    .line 453
    iget-object v0, p0, this$0:Lcom/android/server/hdmi/HdmiCecController;

    iget v1, p0, val$sourceAddress:I

    iget-object v2, p0, val$candidate:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v2

    iget v3, p0, val$retryCount:I
    ...
    .line 454
    iget-object v0, p0, val$allocated:Ljava/util/List;

    iget-object v1, p0, val$candidate:Ljava/lang/Integer;
