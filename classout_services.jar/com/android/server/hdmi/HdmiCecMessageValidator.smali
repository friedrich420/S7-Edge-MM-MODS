...
.method public constructor <init>(Lcom/android/server/hdmi/HdmiControlService;)V
    ...
    iput-object v4, p0, mValidationInfo:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v4, v3, v9}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    .line 72
    const/16 v4, 0x9d

    invoke-direct {p0, v4, v3, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v5, v9}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v3, v10}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v5, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v1, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v1, v7}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v1, v9}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v1, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    .line 112
    invoke-direct {p0, v9, v1, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    .line 113
    invoke-direct {p0, v7, v1, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v1, v11}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v2, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v5, v10}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v0, v7}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v5, v6}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v0, v5}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V

    .line 150
    const/16 v4, 0x64

    invoke-direct {p0, v4, v0, v8}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v2, v11}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    invoke-direct {p0, v4, v0, v9}, addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
...
.method static synthetic access$400(Lcom/android/server/hdmi/HdmiCecMessageValidator;[BI)Z
    ...
    .prologue
    .line 25
    invoke-direct {p0, p1, p2}, isValidPhysicalAddress([BI)Z
...
.method static synthetic access$500(Z)I
    ...
    .prologue
    .line 25
    invoke-static {p0}, toErrorCode(Z)I
...
.method private addValidationInfo(ILcom/android/server/hdmi/HdmiCecMessageValidator$ParameterValidator;I)V
    ...
    .prologue
    .line 190
    iget-object v0, p0, mValidationInfo:Landroid/util/SparseArray;
...
.method isValid(Lcom/android/server/hdmi/HdmiCecMessage;)I
    ...
    .line 195
    .local v2, "opcode":I
    iget-object v4, p0, mValidationInfo:Landroid/util/SparseArray;
