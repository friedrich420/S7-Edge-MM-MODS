...
.method constructor <init>(Lcom/android/server/hdmi/HdmiControlService$BinderService;III)V
    ...
    iput p2, p0, val$oldIndex:I

    iput p3, p0, val$newIndex:I

    iput p4, p0, val$maxIndex:I
...
.method public run()V
    ...
    .line 1439
    :cond_12
    iget v1, p0, val$oldIndex:I

    iget v2, p0, val$newIndex:I

    iget v3, p0, val$oldIndex:I

    sub-int/2addr v2, v3

    iget v3, p0, val$maxIndex:I
