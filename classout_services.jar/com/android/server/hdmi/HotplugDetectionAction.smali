...
.method constructor <init>(Lcom/android/server/hdmi/HdmiCecLocalDevice;)V
    ...
    .line 50
    iput v0, p0, mTimeoutCount:I

    .line 56
    iput v0, p0, mAvrStatusCount:I
...
.method static synthetic access$000(Lcom/android/server/hdmi/HotplugDetectionAction;Ljava/util/List;Z)V
    ...
    .prologue
    .line 36
    invoke-direct {p0, p1, p2}, checkHotplug(Ljava/util/List;Z)V
...
.method private checkHotplug(Ljava/util/List;Z)V
    ...
    invoke-static {v6, p2}, infoListToBitSet(Ljava/util/List;Z)Ljava/util/BitSet;

    move-result-object v2

    .line 152
    .local v2, "currentInfos":Ljava/util/BitSet;
    invoke-static {p1}, addressListToBitSet(Ljava/util/List;)Ljava/util/BitSet;

    move-result-object v4

    .line 155
    .local v4, "polledResult":Ljava/util/BitSet;
    invoke-static {v2, v4}, complement(Ljava/util/BitSet;Ljava/util/BitSet;)Ljava/util/BitSet;
    ...
    .line 161
    iget v6, p0, mAvrStatusCount:I

    add-int/lit8 v6, v6, 0x1

    iput v6, p0, mAvrStatusCount:I
    ...
    .line 169
    invoke-direct {p0, v3}, removeDevice(I)V
    ...
    .line 174
    iput v10, p0, mAvrStatusCount:I

    .line 178
    :cond_83
    invoke-static {v4, v2}, complement(Ljava/util/BitSet;Ljava/util/BitSet;)Ljava/util/BitSet;
    ...
    .line 182
    invoke-direct {p0, v3}, addDevice(I)V
...
.method private mayCancelOneTouchRecord(I)V
    ...
    .line 255
    invoke-virtual {p0, v0}, removeAction(Lcom/android/server/hdmi/HdmiCecFeatureAction;)V
...
.method private pollAllDevices()V
    ...
    invoke-virtual {p0, v0, v1, v2}, pollDevices(Lcom/android/server/hdmi/HdmiControlService$DevicePollingCallback;II)V
...
.method private pollDevices()V
    ...
    .prologue
    .line 115
    iget v0, p0, mTimeoutCount:I

    if-nez v0, :cond_f

    .line 116
    invoke-direct {p0}, pollAllDevices()V
    ...
    .line 119
    invoke-direct {p0}, pollAudioSystem()V
...
.method private removeDevice(I)V
    ...
    .prologue
    .line 223
    invoke-direct {p0, p1}, mayChangeRoutingPath(I)V

    .line 224
    invoke-direct {p0, p1}, mayCancelDeviceSelect(I)V

    .line 225
    invoke-direct {p0, p1}, mayCancelOneTouchRecord(I)V

    .line 226
    invoke-direct {p0, p1}, mayDisableSystemAudioAndARC(I)V
...
.method handleTimerEvent(I)V
    ...
    .line 94
    invoke-direct {p0}, pollDevices()V
