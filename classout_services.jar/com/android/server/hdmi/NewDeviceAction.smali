...
.method constructor <init>(Lcom/android/server/hdmi/HdmiCecLocalDevice;III)V
    ...
    .line 67
    iput p2, p0, mDeviceLogicalAddress:I

    .line 68
    iput p3, p0, mDevicePhysicalAddress:I

    .line 69
    iput p4, p0, mDeviceType:I
...
.method private addDeviceInfo()V
    ...
    iget v2, p0, mDeviceLogicalAddress:I

    iget v3, p0, mDevicePhysicalAddress:I
    ...
    iget v5, p0, mDeviceLogicalAddress:I
    ...
    iget v5, p0, mDevicePhysicalAddress:I
    ...
    .line 173
    iget v1, p0, mDeviceLogicalAddress:I
    ...
    iget v2, p0, mDevicePhysicalAddress:I

    invoke-virtual {p0}, tv()Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;

    move-result-object v3

    iget v4, p0, mDevicePhysicalAddress:I
...
.method private requestOsdName(Z)V
    ...
    .line 84
    iget v0, p0, mDeviceLogicalAddress:I

    const/16 v1, 0x47

    invoke-direct {p0, v0, v1}, mayProcessCommandIfCached(II)Z
...
.method public handleTimerEvent(I)V
    ...
    .line 197
    invoke-direct {p0, v1}, requestOsdName(Z)V

    goto :goto_b

    .line 201
    :cond_1a
    invoke-direct {p0, v2}, requestVendorId(Z)V
    ...
    .line 204
    invoke-direct {p0, v1}, requestVendorId(Z)V

    goto :goto_b

    .line 208
    :cond_2d
    invoke-direct {p0}, addDeviceInfo()V
...
.method isActionOf(Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;)Z
    ...
    iget v0, p0, mDevicePhysicalAddress:I
...
.method public processCommand(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    .line 103
    .local v2, "params":[B
    iget v7, p0, mDeviceLogicalAddress:I
    ...
    iput-object v5, p0, mDisplayName:Ljava/lang/String;
    :try_end_24
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_1b .. :try_end_24} :catch_29

    .line 114
    :goto_24
    invoke-direct {p0, v6}, requestVendorId(Z)V
...
.method public start()Z
    ...
    .line 75
    invoke-direct {p0, v0}, requestOsdName(Z)V
