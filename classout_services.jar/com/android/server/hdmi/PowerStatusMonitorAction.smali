...
.method constructor <init>(Lcom/android/server/hdmi/HdmiCecLocalDevice;)V
    ...
    iput-object v0, p0, mPowerStatus:Landroid/util/SparseIntArray;
...
.method static synthetic access$000(Lcom/android/server/hdmi/PowerStatusMonitorAction;IIZ)V
    ...
    .prologue
    .line 30
    invoke-direct {p0, p1, p2, p3}, updatePowerStatus(IIZ)V
...
.method private handleReportPowerStatus(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    iget-object v5, p0, mPowerStatus:Landroid/util/SparseIntArray;
    ...
    invoke-direct {p0, v2, v0, v4}, updatePowerStatus(IIZ)V
...
.method private handleTimeout()V
    ...
    .local v0, "i":I
    :goto_1
    iget-object v2, p0, mPowerStatus:Landroid/util/SparseIntArray;
    ...
    invoke-direct {p0, v1, v2, v3}, updatePowerStatus(IIZ)V
...
.method private queryPowerStatus()V
    ...
    invoke-direct {p0, v0}, resetPowerStatus(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v4, v5}, sendCommand(Lcom/android/server/hdmi/HdmiCecMessage;Lcom/android/server/hdmi/HdmiControlService$SendMessageCallback;)V
    ...
    invoke-virtual {p0, v6, v4}, addTimer(II)V
...
.method private updatePowerStatus(IIZ)V
    ...
    .line 144
    iget-object v0, p0, mPowerStatus:Landroid/util/SparseIntArray;
...
.method handleTimerEvent(I)V
    ...
    .line 90
    :pswitch_6
    invoke-direct {p0}, queryPowerStatus()V

    goto :goto_5

    .line 93
    :pswitch_a
    invoke-direct {p0}, handleTimeout()V
...
.method processCommand(Lcom/android/server/hdmi/HdmiCecMessage;)Z
    ...
    .line 69
    invoke-direct {p0, p1}, handleReportPowerStatus(Lcom/android/server/hdmi/HdmiCecMessage;)Z
