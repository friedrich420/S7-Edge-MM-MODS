...
.method private constructor <init>(Lcom/android/server/job/StateChangedListener;Landroid/content/Context;)V
    ...
    iput-object v1, p0, mAlarmService:Landroid/app/AlarmManager;
    ...
    iput-object v1, p0, mTrackedJobs:Ljava/util/List;
    ...
    iput-object v1, p0, mAlarmExpiredReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, mDeadlineExpiredAlarmIntent:Landroid/app/PendingIntent;
    ...
    iput-object v1, p0, mNextDelayExpiredAlarmIntent:Landroid/app/PendingIntent;

    .line 77
    iput-wide v6, p0, mNextJobExpiredElapsedMillis:J

    .line 78
    iput-wide v6, p0, mNextDelayExpiredElapsedMillis:J
    ...
    iget-object v2, p0, mAlarmExpiredReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$000(Lcom/android/server/job/controllers/TimeController;)V
    ...
    .prologue
    .line 41
    invoke-direct {p0}, checkExpiredDeadlinesAndResetAlarm()V
...
.method static synthetic access$100(Lcom/android/server/job/controllers/TimeController;)V
    ...
    .prologue
    .line 41
    invoke-direct {p0}, checkExpiredDelaysAndResetAlarm()V
...
.method private declared-synchronized checkExpiredDeadlinesAndResetAlarm()V
    ...
    iget-object v8, p0, mTrackedJobs:Ljava/util/List;
    ...
    .line 165
    iget-object v8, p0, mStateChangedListener:Lcom/android/server/job/StateChangedListener;
    ...
    :cond_3d
    :try_start_3d
    invoke-direct {p0, v4, v5}, setDeadlineExpiredAlarm(J)V
    :try_end_40
...
.method private declared-synchronized checkExpiredDelaysAndResetAlarm()V
    ...
    .line 183
    .local v8, "ready":Z
    iget-object v9, p0, mTrackedJobs:Ljava/util/List;
    ...
    .line 192
    invoke-direct {p0, v1}, canStopTrackingJob(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    .line 205
    iget-object v9, p0, mStateChangedListener:Lcom/android/server/job/StateChangedListener;

    invoke-interface {v9}, Lcom/android/server/job/StateChangedListener;->onControllerStateChanged()V

    .line 207
    :cond_4f
    invoke-direct {p0, v4, v5}, setDelayExpiredAlarm(J)V
    :try_end_52
...
.method public static declared-synchronized get(Lcom/android/server/job/JobSchedulerService;)Lcom/android/server/job/controllers/TimeController;
    ...
    :try_start_3
    sget-object v0, mSingleton:Lcom/android/server/job/controllers/TimeController;
    ...
    sput-object v0, mSingleton:Lcom/android/server/job/controllers/TimeController;
...
.method private maybeUpdateAlarms(JJ)V
    ...
    .prologue
    .line 211
    iget-wide v0, p0, mNextDelayExpiredElapsedMillis:J
    ...
    .line 212
    invoke-direct {p0, p1, p2}, setDelayExpiredAlarm(J)V

    .line 214
    :cond_9
    iget-wide v0, p0, mNextJobExpiredElapsedMillis:J
    ...
    .line 215
    invoke-direct {p0, p3, p4}, setDeadlineExpiredAlarm(J)V
...
.method private setDeadlineExpiredAlarm(J)V
    ...
    .prologue
    .line 236
    invoke-direct {p0, p1, p2}, maybeAdjustAlarmTime(J)J

    move-result-wide p1

    .line 237
    iput-wide p1, p0, mNextJobExpiredElapsedMillis:J

    .line 238
    iget-object v0, p0, mDeadlineExpiredAlarmIntent:Landroid/app/PendingIntent;

    iget-wide v2, p0, mNextJobExpiredElapsedMillis:J

    invoke-direct {p0, v0, v2, v3}, updateAlarmWithPendingIntent(Landroid/app/PendingIntent;J)V
...
.method private setDelayExpiredAlarm(J)V
    ...
    .line 226
    iput-wide p1, p0, mNextDelayExpiredElapsedMillis:J

    .line 227
    iget-object v0, p0, mNextDelayExpiredAlarmIntent:Landroid/app/PendingIntent;

    iget-wide v2, p0, mNextDelayExpiredElapsedMillis:J
...
.method public dumpControllerState(Ljava/io/PrintWriter;)V
    ...
    iget-wide v6, p0, mNextDelayExpiredElapsedMillis:J
    ...
    iget-wide v6, p0, mNextJobExpiredElapsedMillis:J
    ...
    .line 286
    iget-object v4, p0, mTrackedJobs:Ljava/util/List;
...
.method public declared-synchronized maybeStartTrackingJob(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    .line 93
    :cond_12
    invoke-virtual {p0, p1}, maybeStopTrackingJob(Lcom/android/server/job/controllers/JobStatus;)V
    ...
    :cond_57
    invoke-direct {p0, v6, v7, v4, v5}, maybeUpdateAlarms(JJ)V
    :try_end_5a
