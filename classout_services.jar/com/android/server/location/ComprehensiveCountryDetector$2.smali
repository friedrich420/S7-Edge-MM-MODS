...
.method constructor <init>(Lcom/android/server/location/ComprehensiveCountryDetector;Landroid/location/Country;Landroid/location/Country;ZZ)V
    ...
    .prologue
    .line 283
    iput-object p1, p0, this$0:Lcom/android/server/location/ComprehensiveCountryDetector;

    iput-object p2, p0, val$country:Landroid/location/Country;

    iput-object p3, p0, val$detectedCountry:Landroid/location/Country;

    iput-boolean p4, p0, val$notifyChange:Z

    iput-boolean p5, p0, val$startLocationBasedDetection:Z
...
.method public run()V
    ...
    .prologue
    .line 286
    iget-object v0, p0, this$0:Lcom/android/server/location/ComprehensiveCountryDetector;

    iget-object v1, p0, val$country:Landroid/location/Country;

    iget-object v2, p0, val$detectedCountry:Landroid/location/Country;

    iget-boolean v3, p0, val$notifyChange:Z

    iget-boolean v4, p0, val$startLocationBasedDetection:Z
