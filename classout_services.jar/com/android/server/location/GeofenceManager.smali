...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/location/LocationBlacklist;)V
    ...
    iput-object v1, p0, mFences:Ljava/util/List;
    ...
    iput-object v1, p0, mHandler:Lcom/android/server/location/GeofenceManager$GeofenceHandler;

    .line 116
    iput-object p2, p0, mBlacklist:Lcom/android/server/location/LocationBlacklist;
...
.method static synthetic access$000(Lcom/android/server/location/GeofenceManager;)V
    ...
    .prologue
    .line 42
    invoke-direct {p0}, updateFences()V
...
.method private getFreshLocationLocked()Landroid/location/Location;
    ...
    .line 213
    iget-boolean v4, p0, mReceivingLocationUpdates:Z

    if-eqz v4, :cond_1b

    iget-object v0, p0, mLastLocationUpdate:Landroid/location/Location;
    ...
    iget-object v4, p0, mFences:Ljava/util/List;
    ...
    .line 215
    iget-object v4, p0, mLocationManager:Landroid/location/LocationManager;
...
.method private scheduleUpdateFencesLocked()V
    ...
    .line 198
    iget-boolean v0, p0, mPendingUpdate:Z

    if-nez v0, :cond_c

    .line 199
    iput-boolean v1, p0, mPendingUpdate:Z

    .line 200
    iget-object v0, p0, mHandler:Lcom/android/server/location/GeofenceManager$GeofenceHandler;
...
.method private sendIntent(Landroid/app/PendingIntent;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v8, p1}, removeFence(Landroid/location/Geofence;Landroid/app/PendingIntent;)V
...
.method private sendIntentEnter(Landroid/app/PendingIntent;)V
    ...
    .line 354
    invoke-direct {p0, p1, v0}, sendIntent(Landroid/app/PendingIntent;Landroid/content/Intent;)V
...
.method private updateFences()V
    ...
    iput-boolean v0, v1, mPendingUpdate:Z

    .line 248
    invoke-direct/range {p0 .. p0}, removeExpiredFencesLocked()V

    .line 252
    invoke-direct/range {p0 .. p0}, getFreshLocationLocked()Landroid/location/Location;
    ...
    iget-object v0, v0, mFences:Ljava/util/List;
    ...
    iget-boolean v0, v0, mReceivingLocationUpdates:Z
    ...
    iget-wide v0, v0, mLocationUpdateInterval:J
    ...
    iput-boolean v0, v1, mReceivingLocationUpdates:Z

    .line 311
    move-object/from16 v0, p0

    iput-wide v12, v0, mLocationUpdateInterval:J

    .line 312
    move-object/from16 v0, p0

    iput-object v11, v0, mLastLocationUpdate:Landroid/location/Location;
    ...
    iget-object v0, v0, mLocationManager:Landroid/location/LocationManager;

    move-object/from16 v20, v0

    move-object/from16 v0, p0

    iget-object v0, v0, mHandler:Lcom/android/server/location/GeofenceManager$GeofenceHandler;
    ...
    iget-object v0, v0, mLastLocationUpdate:Landroid/location/Location;
    ...
    monitor-exit v21
    :try_end_1f6
    .catchall {:try_start_7e .. :try_end_1f6} :catchall_7b
    ...
    invoke-direct {v0, v10}, sendIntentExit(Landroid/app/PendingIntent;)V
    ...
    iput-wide v0, v2, mLocationUpdateInterval:J
    ...
    iput-object v0, v1, mLastLocationUpdate:Landroid/location/Location;
    ...
    :try_end_23e
    .catchall {:try_start_211 .. :try_end_23e} :catchall_7b
    ...
    invoke-direct {v0, v10}, sendIntentEnter(Landroid/app/PendingIntent;)V
...
.method public addFence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;IILjava/lang/String;)V
    ...
    .line 130
    :try_start_5c
    iget-object v3, p0, mFences:Ljava/util/List;
    ...
    .line 139
    invoke-direct {p0}, scheduleUpdateFencesLocked()V
    ...
    monitor-exit v4
    :try_end_92
    .catchall {:try_start_5c .. :try_end_92} :catchall_90
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    .line 416
    iget-object v2, p0, mFences:Ljava/util/List;
...
.method public onLocationChanged(Landroid/location/Location;)V
    ...
    .line 383
    :try_start_3
    iget-boolean v0, p0, mReceivingLocationUpdates:Z

    if-eqz v0, :cond_9

    .line 384
    iput-object p1, p0, mLastLocationUpdate:Landroid/location/Location;
    ...
    :try_start_19
    iput-boolean v0, p0, mPendingUpdate:Z
...
.method public removeFence(Landroid/location/Geofence;Landroid/app/PendingIntent;)V
    ...
    monitor-exit v3
    :try_end_5d
    .catchall {:try_start_4d .. :try_end_5d} :catchall_4a
