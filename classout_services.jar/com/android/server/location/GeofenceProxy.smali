...
.method private constructor <init>(Landroid/content/Context;IIILandroid/os/Handler;Landroid/location/IGpsGeofenceHardware;Landroid/location/IFusedGeofenceHardware;)V
    ...
    iput-object v1, p0, mRunnable:Ljava/lang/Runnable;
    ...
    iget-object v8, p0, mRunnable:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, mServiceWatcher:Lcom/android/server/ServiceWatcher;

    .line 86
    move-object/from16 v0, p6

    iput-object v0, p0, mGpsGeofenceHardware:Landroid/location/IGpsGeofenceHardware;

    .line 87
    move-object/from16 v0, p7

    iput-object v0, p0, mFusedGeofenceHardware:Landroid/location/IFusedGeofenceHardware;

    .line 88
    invoke-direct {p0}, bindHardwareGeofence()V
...
.method static synthetic access$200(Lcom/android/server/location/GeofenceProxy;)Landroid/hardware/location/IGeofenceHardware;
    ...
    .prologue
    .line 38
    iget-object v0, p0, mGeofenceHardware:Landroid/hardware/location/IGeofenceHardware;
...
.method static synthetic access$202(Lcom/android/server/location/GeofenceProxy;Landroid/hardware/location/IGeofenceHardware;)Landroid/hardware/location/IGeofenceHardware;
    ...
    .prologue
    .line 38
    iput-object p1, p0, mGeofenceHardware:Landroid/hardware/location/IGeofenceHardware;
...
.method static synthetic access$300(Lcom/android/server/location/GeofenceProxy;)V
    ...
    .prologue
    .line 38
    invoke-direct {p0}, setGeofenceHardwareInProviderLocked()V
...
.method static synthetic access$400(Lcom/android/server/location/GeofenceProxy;)V
    ...
    .prologue
    .line 38
    invoke-direct {p0}, setGpsGeofenceLocked()V
...
.method static synthetic access$500(Lcom/android/server/location/GeofenceProxy;)V
    ...
    .prologue
    .line 38
    invoke-direct {p0}, setFusedGeofenceLocked()V
...
.method public static createAndBind(Landroid/content/Context;IIILandroid/os/Handler;Landroid/location/IGpsGeofenceHardware;Landroid/location/IFusedGeofenceHardware;)Lcom/android/server/location/GeofenceProxy;
    ...
    invoke-direct/range {v0 .. v7}, <init>(Landroid/content/Context;IIILandroid/os/Handler;Landroid/location/IGpsGeofenceHardware;Landroid/location/IFusedGeofenceHardware;)V

    .line 72
    .local v0, "proxy":Lcom/android/server/location/GeofenceProxy;
    invoke-direct {v0}, bindGeofenceProvider()Z
...
.method private setFusedGeofenceLocked()V
    ...
    .line 142
    :try_start_0
    iget-object v1, p0, mGeofenceHardware:Landroid/hardware/location/IGeofenceHardware;

    iget-object v2, p0, mFusedGeofenceHardware:Landroid/location/IFusedGeofenceHardware;
...
.method private setGeofenceHardwareInProviderLocked()V
    ...
    .line 120
    :try_start_0
    iget-object v2, p0, mServiceWatcher:Lcom/android/server/ServiceWatcher;
    ...
    .line 123
    iget-object v2, p0, mGeofenceHardware:Landroid/hardware/location/IGeofenceHardware;
...
.method private setGpsGeofenceLocked()V
    ...
    .line 132
    :try_start_0
    iget-object v1, p0, mGpsGeofenceHardware:Landroid/location/IGpsGeofenceHardware;
    ...
    iget-object v2, p0, mGpsGeofenceHardware:Landroid/location/IGpsGeofenceHardware;
