...
.method private constructor <init>()V
    ...
    iput-wide v0, p0, mInitialElapsedTimeMs:J

    .line 108
    const/4 v0, 0x0

    iput v0, p0, mNumActiveRequests:I

    .line 109
    iput-wide v2, p0, mTotalDurationMs:J

    .line 110
    const-wide v0, 0x7fffffffffffffffL

    iput-wide v0, p0, mFastestIntervalMs:J

    .line 111
    iput-wide v2, p0, mSlowestIntervalMs:J
...
.method static synthetic access$100(Lcom/android/server/location/LocationRequestStatistics$PackageStatistics;J)V
    ...
    .prologue
    .line 92
    invoke-direct {p0, p1, p2}, startRequesting(J)V
...
.method static synthetic access$200(Lcom/android/server/location/LocationRequestStatistics$PackageStatistics;)V
    ...
    .prologue
    .line 92
    invoke-direct {p0}, stopRequesting()V
...
.method private startRequesting(J)V
    ...
    .prologue
    .line 115
    iget v0, p0, mNumActiveRequests:I
    ...
    iput-wide v0, p0, mLastActivitationElapsedTimeMs:J

    .line 119
    :cond_a
    iget-wide v0, p0, mFastestIntervalMs:J
    ...
    .line 120
    iput-wide p1, p0, mFastestIntervalMs:J

    .line 123
    :cond_12
    iget-wide v0, p0, mSlowestIntervalMs:J
    ...
    .line 124
    iput-wide p1, p0, mSlowestIntervalMs:J
...
.method private stopRequesting()V
    ...
    .prologue
    .line 131
    iget v2, p0, mNumActiveRequests:I
    ...
    iput v2, p0, mNumActiveRequests:I
    ...
    iget-wide v4, p0, mLastActivitationElapsedTimeMs:J

    sub-long v0, v2, v4

    .line 141
    .local v0, "lastDurationMs":J
    iget-wide v2, p0, mTotalDurationMs:J
...
.method public getDurationMs()J
    ...
    .prologue
    .line 149
    iget-wide v0, p0, mTotalDurationMs:J
...
.method public getTimeSinceFirstRequestMs()J
    ...
    iget-wide v2, p0, mInitialElapsedTimeMs:J
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v2, p0, mFastestIntervalMs:J

    iget-wide v4, p0, mSlowestIntervalMs:J
    ...
    invoke-virtual {p0}, getDurationMs()J
    ...
    invoke-virtual {p0}, getTimeSinceFirstRequestMs()J
    ...
    iget-wide v2, p0, mSlowestIntervalMs:J
