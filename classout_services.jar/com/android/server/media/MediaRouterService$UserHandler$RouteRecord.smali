...
.method public constructor <init>(Lcom/android/server/media/MediaRouterService$UserHandler$ProviderRecord;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1214
    iput-object p1, p0, mProviderRecord:Lcom/android/server/media/MediaRouterService$UserHandler$ProviderRecord;

    .line 1215
    iput-object p2, p0, mDescriptorId:Ljava/lang/String;
    ...
    iput-object v0, p0, mMutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v2, p0, mMutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
    ...
    iget-object v2, p0, mDescriptorId:Ljava/lang/String;
    ...
    iget-object v2, p0, mDescriptor:Landroid/media/RemoteDisplayState$RemoteDisplayInfo;
...
.method public getDescriptorId()Ljava/lang/String;
    ...
    .prologue
    .line 1228
    iget-object v0, p0, mDescriptorId:Ljava/lang/String;
...
.method public getInfo()Landroid/media/MediaRouterClientState$RouteInfo;
    ...
    .prologue
    .line 1236
    iget-object v0, p0, mImmutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
    ...
    iget-object v1, p0, mMutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
    ...
    iput-object v0, p0, mImmutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
...
.method public getProvider()Lcom/android/server/media/RemoteDisplayProviderProxy;
    ...
    .prologue
    .line 1220
    iget-object v0, p0, mProviderRecord:Lcom/android/server/media/MediaRouterService$UserHandler$ProviderRecord;
...
.method public getStatus()I
    ...
    .prologue
    .line 1251
    iget-object v0, p0, mMutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
...
.method public isValid()Z
    ...
    .prologue
    .line 1243
    iget-object v0, p0, mDescriptor:Landroid/media/RemoteDisplayState$RemoteDisplayInfo;
...
.method public updateDescriptor(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)Z
    ...
    .line 1256
    .local v0, "changed":Z
    iget-object v12, p0, mDescriptor:Landroid/media/RemoteDisplayState$RemoteDisplayInfo;

    if-eq v12, p1, :cond_b6

    .line 1257
    iput-object p1, p0, mDescriptor:Landroid/media/RemoteDisplayState$RemoteDisplayInfo;

    .line 1258
    if-eqz p1, :cond_b6

    .line 1259
    invoke-static {p1}, computeName(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)Ljava/lang/String;

    move-result-object v3

    .line 1260
    .local v3, "name":Ljava/lang/String;
    iget-object v12, p0, mMutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
    ...
    .line 1264
    :cond_1c
    invoke-static {p1}, computeDescription(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)Ljava/lang/String;
    ...
    .line 1269
    :cond_2f
    invoke-static {p1}, computeSupportedTypes(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    .line 1274
    :cond_3e
    invoke-static {p1}, computeEnabled(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)Z
    ...
    .line 1279
    :cond_4d
    invoke-static {p1}, computeStatusCode(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    .line 1284
    :cond_5c
    invoke-static {p1}, computePlaybackType(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    .line 1289
    :cond_6b
    invoke-static {p1}, computePlaybackStream(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    .line 1294
    :cond_7a
    invoke-static {p1}, computeVolume(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    .line 1299
    :cond_89
    invoke-static {p1}, computeVolumeMax(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    .line 1304
    :cond_98
    invoke-static {p1}, computeVolumeHandling(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    .line 1309
    :cond_a7
    invoke-static {p1}, computePresentationDisplayId(Landroid/media/RemoteDisplayState$RemoteDisplayInfo;)I
    ...
    iput-object v12, p0, mImmutableInfo:Landroid/media/MediaRouterClientState$RouteInfo;
