...
.method public constructor <init>(Lcom/android/server/media/MediaRouterService;Lcom/android/server/media/MediaRouterService$UserRecord;)V
    ...
    iput-object v0, p0, mProviderRecords:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, mTempClients:Ljava/util/ArrayList;

    .line 646
    const/4 v0, 0x0

    iput v0, p0, mDiscoveryMode:I

    .line 648
    const/4 v0, -0x1

    iput v0, p0, mConnectionPhase:I

    .line 655
    iput-object p1, p0, mService:Lcom/android/server/media/MediaRouterService;

    .line 656
    iput-object p2, p0, mUserRecord:Lcom/android/server/media/MediaRouterService$UserRecord;
    ...
    iget-object v2, p0, mUserRecord:Lcom/android/server/media/MediaRouterService$UserRecord;
    ...
    iput-object v0, p0, mWatcher:Lcom/android/server/media/RemoteDisplayProviderWatcher;
...
.method private checkGloballySelectedRouteState()V
    ...
    .line 877
    iget-object v1, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    iput v1, p0, mConnectionPhase:I

    .line 879
    invoke-direct {p0, v4}, updateConnectionTimeout(I)V
    ...
    .line 886
    :cond_1e
    invoke-direct {p0, v2}, updateConnectionTimeout(I)V

    goto :goto_d

    .line 891
    :cond_22
    iget v0, p0, mConnectionPhase:I
    ...
    invoke-static {v1}, getConnectionPhase(I)I
    ...
    iget v1, p0, mConnectionPhase:I

    if-ge v1, v2, :cond_3a

    .line 894
    invoke-direct {p0, v3}, updateConnectionTimeout(I)V
    ...
    iget-object v3, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    invoke-direct {p0, v1}, updateConnectionTimeout(I)V
...
.method private connectionTimedOut()V
    ...
    .prologue
    .line 951
    iget v0, p0, mConnectionTimeoutReason:I

    if-eqz v0, :cond_8

    iget-object v0, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    iput v0, p0, mConnectionTimeoutReason:I

    .line 980
    invoke-direct {p0}, unselectGloballySelectedRoute()V
    ...
    iget-object v2, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    iget-wide v4, p0, mConnectionTimeoutStartTime:J
...
.method private findProviderRecord(Lcom/android/server/media/RemoteDisplayProviderProxy;)I
    ...
    .prologue
    .line 1041
    iget-object v3, p0, mProviderRecords:Ljava/util/ArrayList;
...
.method private scheduleUpdateClientState()V
    ...
    .prologue
    .line 984
    iget-boolean v0, p0, mClientStateUpdateScheduled:Z
    ...
    iput-boolean v0, p0, mClientStateUpdateScheduled:Z
...
.method private selectRoute(Ljava/lang/String;)V
    ...
    .line 778
    :cond_12
    invoke-direct {p0, p1}, findRouteRecord(Ljava/lang/String;)Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    .line 783
    iput-object v0, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;

    .line 784
    invoke-direct {p0}, checkGloballySelectedRouteState()V
    ...
    .line 787
    invoke-direct {p0}, scheduleUpdateClientState()V
...
.method private start()V
    ...
    .line 730
    iget-object v0, p0, mWatcher:Lcom/android/server/media/RemoteDisplayProviderWatcher;
...
.method private unselectGloballySelectedRoute()V
    ...
    .line 804
    iput-object v3, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
...
.method private updateClientState()V
    ...
    iput-boolean v6, p0, mClientStateUpdateScheduled:Z

    .line 993
    iget-object v6, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    .line 999
    iget-object v6, p0, mProviderRecords:Ljava/util/ArrayList;
    ...
    :cond_3f
    :try_start_3f
    iget-object v6, p0, mService:Lcom/android/server/media/MediaRouterService;
    ...
    .line 1015
    :try_start_46
    iget-object v6, p0, mUserRecord:Lcom/android/server/media/MediaRouterService$UserRecord;
    ...
    .line 1021
    iget-object v8, p0, mTempClients:Ljava/util/ArrayList;
    ...
    .line 1026
    :try_start_6e
    iget-object v6, p0, mTempClients:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, mTempClients:Ljava/util/ArrayList;
...
.method private updateConnectionTimeout(I)V
    ...
    .line 929
    :cond_d
    iput p1, p0, mConnectionTimeoutReason:I
    ...
    iput-wide v0, p0, mConnectionTimeoutStartTime:J
    ...
    .line 936
    :pswitch_19
    invoke-virtual {p0, v2}, sendEmptyMessage(I)Z
...
.method private updateDiscoveryRequest()V
    ...
    :goto_2f
    iget v6, p0, mDiscoveryMode:I

    if-eq v6, v4, :cond_59

    .line 766
    iput v4, p0, mDiscoveryMode:I
...
.method private updateProvider(Lcom/android/server/media/RemoteDisplayProviderProxy;Landroid/media/RemoteDisplayState;)V
    ...
    .prologue
    .line 860
    invoke-direct {p0, p1}, findProviderRecord(Lcom/android/server/media/RemoteDisplayProviderProxy;)I
    ...
    .line 862
    iget-object v2, p0, mProviderRecords:Ljava/util/ArrayList;
...
.method public addProvider(Lcom/android/server/media/RemoteDisplayProviderProxy;)V
    ...
    iget-object v1, p0, mProviderRecords:Ljava/util/ArrayList;
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v4, p0, mGloballySelectedRouteRecord:Lcom/android/server/media/MediaRouterService$UserHandler$RouteRecord;
    ...
    iget v4, p0, mConnectionTimeoutReason:I
    ...
    iget v3, p0, mConnectionTimeoutReason:I

    if-eqz v3, :cond_fd

    iget-wide v6, p0, mConnectionTimeoutStartTime:J
    ...
    .line 715
    iget-object v3, p0, mWatcher:Lcom/android/server/media/RemoteDisplayProviderWatcher;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 665
    :pswitch_6
    invoke-direct {p0}, start()V

    goto :goto_5

    .line 669
    :pswitch_a
    invoke-direct {p0}, stop()V

    goto :goto_5

    .line 673
    :pswitch_e
    invoke-direct {p0}, updateDiscoveryRequest()V
    ...
    invoke-direct {p0, v0}, selectRoute(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, unselectRoute(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v1}, requestSetVolume(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0, v1}, requestUpdateVolume(Ljava/lang/String;I)V

    goto :goto_5

    .line 693
    :pswitch_36
    invoke-direct {p0}, updateClientState()V

    goto :goto_5

    .line 697
    :pswitch_3a
    invoke-direct {p0}, connectionTimedOut()V
...
.method public onDisplayStateChanged(Lcom/android/server/media/RemoteDisplayProviderProxy;Landroid/media/RemoteDisplayState;)V
    ...
    .prologue
    .line 855
    invoke-direct {p0, p1, p2}, updateProvider(Lcom/android/server/media/RemoteDisplayProviderProxy;Landroid/media/RemoteDisplayState;)V
