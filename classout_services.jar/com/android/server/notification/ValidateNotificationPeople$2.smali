...
.method constructor <init>(Lcom/android/server/notification/ValidateNotificationPeople;Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;Ljava/util/concurrent/Semaphore;)V
    ...
    .prologue
    .line 164
    iput-object p1, p0, this$0:Lcom/android/server/notification/ValidateNotificationPeople;

    iput-object p2, p0, val$prr:Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;

    iput-object p3, p0, val$s:Ljava/util/concurrent/Semaphore;
...
.method public run()V
    ...
    .prologue
    .line 167
    iget-object v0, p0, val$prr:Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;

    invoke-virtual {v0}, Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;->work()V

    .line 168
    iget-object v0, p0, val$s:Ljava/util/concurrent/Semaphore;
