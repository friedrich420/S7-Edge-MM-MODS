...
.method public constructor <init>(Lcom/android/server/pm/LauncherAppsService;Landroid/content/Context;)V
    ...
    .line 86
    iput-object p1, p0, this$0:Lcom/android/server/pm/LauncherAppsService;

    invoke-direct {p0}, Landroid/content/pm/ILauncherApps$Stub;-><init>()V

    .line 79
    iput-object v2, p0, mPersona:Landroid/os/PersonaManager;
    ...
    iput-object v1, p0, mListeners:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$PackageCallbackList;
    ...
    iput-object v1, p0, mPackageMonitor:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$MyPackageMonitor;
    ...
    iput-object v1, p0, mPersona:Landroid/os/PersonaManager;
...
.method static synthetic access$300(Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;)Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$PackageCallbackList;
    ...
    .prologue
    .line 72
    iget-object v0, p0, mListeners:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$PackageCallbackList;
...
.method private startWatchingPackageBroadcasts()V
    ...
    .prologue
    .line 141
    iget-object v0, p0, mPackageMonitor:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$MyPackageMonitor;
...
.method public addOnAppsChangedListener(Landroid/content/pm/IOnAppsChangedListener;)V
    ...
    .prologue
    .line 104
    iget-object v1, p0, mListeners:Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl$PackageCallbackList;
    ...
    .line 112
    invoke-direct {p0}, startWatchingPackageBroadcasts()V
...
.method checkCallbackCount()V
    ...
    .line 160
    invoke-direct {p0}, stopWatchingPackageBroadcasts()V
...
.method public getLauncherActivities(Ljava/lang/String;Landroid/os/UserHandle;)Ljava/util/List;
    ...
    invoke-direct {p0, p2, v4}, ensureInUserProfiles(Landroid/os/UserHandle;Ljava/lang/String;)V

    .line 205
    invoke-direct {p0, p2}, isUserEnabled(Landroid/os/UserHandle;)Z
...
.method public isActivityEnabled(Landroid/content/ComponentName;Landroid/os/UserHandle;)Z
    ...
    invoke-direct {p0, p2, v5}, ensureInUserProfiles(Landroid/os/UserHandle;Ljava/lang/String;)V
...
.method public resolveActivity(Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-direct {p0, p2, v1}, ensureInUserProfiles(Landroid/os/UserHandle;Ljava/lang/String;)V
...
.method public showAppDetailsAsUser(Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, p4, v4}, ensureInUserProfiles(Landroid/os/UserHandle;Ljava/lang/String;)V

    .line 327
    invoke-direct {p0, p4}, isUserEnabled(Landroid/os/UserHandle;)Z
...
.method public startActivityAsUser(Landroid/content/ComponentName;Landroid/graphics/Rect;Landroid/os/Bundle;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, v0, v11}, ensureInUserProfiles(Landroid/os/UserHandle;Ljava/lang/String;)V

    .line 279
    move-object/from16 v0, p4

    invoke-direct {p0, v0}, isUserEnabled(Landroid/os/UserHandle;)Z
    ...
    :cond_8d
    :try_start_8d
    iget-object v11, p0, mPm:Landroid/content/pm/PackageManager;
