...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;ZZ)V
    ...
    iput-boolean p2, p0, val$mediaStatus:Z

    iput-boolean p3, p0, val$reportStatus:Z
...
.method public run()V
    ...
    iget-boolean v1, p0, val$mediaStatus:Z

    iget-boolean v2, p0, val$reportStatus:Z

    const/4 v3, 0x1

    # invokes: Lcom/android/server/pm/PackageManagerService;->updateExternalMediaStatusInner(ZZZ)V
    invoke-static {v0, v1, v2, v3}, Lcom/android/server/pm/PackageManagerService;->access$6700(Lcom/android/server/pm/PackageManagerService;ZZZ)V
