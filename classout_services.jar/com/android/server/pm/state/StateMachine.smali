...
.method public constructor <init>(Lcom/android/server/pm/PersonaManagerService;ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, states:Ljava/util/Map;
    ...
    iput-object v0, p0, attributes:Ljava/util/Set;

    .line 32
    iput-object p1, p0, pms:Lcom/android/server/pm/PersonaManagerService;
    ...
    iput-object v0, p0, currentState:Lcom/android/server/pm/state/StateMachine$StateWrapper;

    .line 36
    iget-object v0, p0, states:Ljava/util/Map;

    iget-object v1, p0, currentState:Lcom/android/server/pm/state/StateMachine$StateWrapper;
    ...
    iput-object v0, p0, previousState:Lcom/android/server/pm/state/StateMachine$StateWrapper;

    .line 43
    iget-object v0, p0, states:Ljava/util/Map;

    iget-object v1, p0, previousState:Lcom/android/server/pm/state/StateMachine$StateWrapper;
    ...
    .line 49
    :cond_35
    iget-object v0, p0, currentState:Lcom/android/server/pm/state/StateMachine$StateWrapper;
    ...
    invoke-virtual {p0, v0, v1}, log(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic access$500(Lcom/android/server/pm/state/StateMachine;Ljava/lang/Object;)Z
    ...
    .prologue
    .line 16
    invoke-direct {p0, p1}, stateExists(Ljava/lang/Object;)Z
...
.method private getTriggerExceptions(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Set;
    ...
    iget-object v2, p0, states:Ljava/util/Map;
...
.method public addState(Ljava/lang/Object;)Lcom/android/server/pm/state/StateMachine$StateWrapper;
    ...
    .local p0, "this":Lcom/android/server/pm/state/StateMachine;, "Lcom/android/server/pm/state/StateMachine<TS;TT;TA;>;"
    .local p1, "state":Ljava/lang/Object;, "TS;"
    iget-object v1, p0, states:Ljava/util/Map;
...
.method public fireEvent(Ljava/lang/Object;Z)Ljava/lang/Object;
    ...
    iget-object v5, p0, currentState:Lcom/android/server/pm/state/StateMachine$StateWrapper;
    ...
    invoke-direct {p0, v5, p1}, getTriggerExceptions(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Set;
    ...
    iget-object v5, p0, attributes:Ljava/util/Set;
    ...
    invoke-virtual {p0, v5, v6}, log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 145
    :cond_73
    invoke-direct {p0, v4}, stateExists(Ljava/lang/Object;)Z
    ...
    iput-object v5, p0, previousState:Lcom/android/server/pm/state/StateMachine$StateWrapper;

    .line 150
    iget-object v5, p0, states:Ljava/util/Map;
    ...
    iput-object v5, p0, currentState:Lcom/android/server/pm/state/StateMachine$StateWrapper;

    .line 151
    iget-object v5, p0, pms:Lcom/android/server/pm/PersonaManagerService;

    iget v6, p0, personaId:I
    ...
    iget-object v7, p0, currentState:Lcom/android/server/pm/state/StateMachine$StateWrapper;
...
.method public getPreviousState()Ljava/lang/Object;
    ...
    .line 98
    .local p0, "this":Lcom/android/server/pm/state/StateMachine;, "Lcom/android/server/pm/state/StateMachine<TS;TT;TA;>;"
    iget-object v0, p0, previousState:Lcom/android/server/pm/state/StateMachine$StateWrapper;
...
.method public instanceOf(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, p2}, stateExists(Ljava/lang/Object;)Z
...
.method public isAttribute(Landroid/content/pm/PersonaAttribute;)Z
    ...
    .line 170
    .local p0, "this":Lcom/android/server/pm/state/StateMachine;, "Lcom/android/server/pm/state/StateMachine<TS;TT;TA;>;"
    iget-object v0, p0, attributes:Ljava/util/Set;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, getState()Ljava/lang/Object;
