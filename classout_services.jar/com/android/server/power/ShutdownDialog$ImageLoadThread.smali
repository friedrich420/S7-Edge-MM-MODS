...
.method private constructor <init>(Lcom/android/server/power/ShutdownDialog;)V
    ...
    iput-boolean v0, p0, coverOpen:Z

    .line 472
    const/4 v0, 0x0

    iput-boolean v0, p0, coverStateDirty:Z
    ...
    iput-object v0, p0, mCoverListener:Lcom/samsung/android/cover/CoverManager$StateListener;
...
.method static synthetic access$1800(Lcom/android/server/power/ShutdownDialog$ImageLoadThread;)Z
    .registers 2
    .param p0, "x0"    # Lcom/android/server/power/ShutdownDialog$ImageLoadThread;

    .prologue
    .line 470
    iget-boolean v0, p0, coverOpen:Z
...
.method static synthetic access$1802(Lcom/android/server/power/ShutdownDialog$ImageLoadThread;Z)Z
    ...
    .prologue
    .line 470
    iput-boolean p1, p0, coverOpen:Z

    return p1
.end method

.method static synthetic access$1902(Lcom/android/server/power/ShutdownDialog$ImageLoadThread;Z)Z
    .registers 2
    .param p0, "x0"    # Lcom/android/server/power/ShutdownDialog$ImageLoadThread;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 470
    iput-boolean p1, p0, coverStateDirty:Z
...
.method private chooseQmg(Lcom/android/server/power/LibQmg;Lcom/android/server/power/LibQmg;Lcom/android/server/power/LibQmg;)Lcom/android/server/power/LibQmg;
    ...
    iput-boolean v3, p0, coverStateDirty:Z
...
.method private frameLoadLoop(Lcom/android/server/power/LibQmg;Lcom/android/server/power/LibQmg;)V
    ...
    .line 529
    invoke-direct {p0, v2, p1, p2}, chooseQmg(Lcom/android/server/power/LibQmg;Lcom/android/server/power/LibQmg;Lcom/android/server/power/LibQmg;)Lcom/android/server/power/LibQmg;
    ...
    .line 533
    iget-object v3, p0, this$0:Lcom/android/server/power/ShutdownDialog;
    ...
    iget-boolean v3, p0, coverStateDirty:Z
    ...
    iget-object v4, p0, this$0:Lcom/android/server/power/ShutdownDialog;
    ...
    :try_end_3d
    .catch Ljava/io/IOException; {:try_start_2c .. :try_end_3d} :catch_98
    ...
    iget-object v5, p0, this$0:Lcom/android/server/power/ShutdownDialog;
    ...
    :try_end_7e
    .catchall {:try_start_60 .. :try_end_7e} :catchall_ab
    ...
    .catchall {:try_start_81 .. :try_end_8c} :catchall_ab
    ...
    monitor-exit v4
    :try_end_8d
    .catchall {:try_start_8c .. :try_end_8d} :catchall_ab
    ...
    monitor-exit v4
    :try_end_ad
    .catchall {:try_start_a3 .. :try_end_ad} :catchall_ab
...
.method public run()V
    ...
    invoke-static {v4, v0}, Lcom/android/server/power/ShutdownDialog;->access$2000(Lcom/android/server/power/ShutdownDialog;Lcom/samsung/android/cover/CoverManager;)Z

    move-result v4

    iput-boolean v4, p0, coverOpen:Z

    .line 490
    iget-object v4, p0, mCoverListener:Lcom/samsung/android/cover/CoverManager$StateListener;
    ...
    iget-object v6, p0, this$0:Lcom/android/server/power/ShutdownDialog;
    ...
    invoke-static {v4}, Lcom/android/server/power/ShutdownDialog;->access$2100(Lcom/android/server/power/ShutdownDialog;)Ljava/util/List;
    ...
    invoke-direct {p0, v3, v1}, frameLoadLoop(Lcom/android/server/power/LibQmg;Lcom/android/server/power/LibQmg;)V
    ...
    invoke-static {v4}, Lcom/android/server/power/ShutdownDialog;->access$2200(Lcom/android/server/power/ShutdownDialog;)Z
    ...
    invoke-static {v4, v5}, Lcom/android/server/power/ShutdownDialog;->access$2300(Lcom/android/server/power/ShutdownDialog;Ljava/lang/String;)Z
