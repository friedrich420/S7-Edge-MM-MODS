...
.method constructor <init>(Lcom/android/server/print/PrintManagerService;Landroid/content/Context;)V
    ...
    .prologue
    .line 110
    iput-object p1, p0, this$0:Lcom/android/server/print/PrintManagerService;
...
.method static synthetic access$000(Lcom/android/server/print/PrintManagerService$PrintManagerImpl;I)V
    ...
    .prologue
    .line 94
    invoke-direct {p0, p1}, handleUserStarted(I)V
...
.method static synthetic access$100(Lcom/android/server/print/PrintManagerService$PrintManagerImpl;I)V
    ...
    .prologue
    .line 94
    invoke-direct {p0, p1}, handleUserStopped(I)V
...
.method static synthetic access$300(Lcom/android/server/print/PrintManagerService$PrintManagerImpl;I)Lcom/android/server/print/UserState;
    ...
    .prologue
    .line 94
    invoke-direct {p0, p1}, getOrCreateUserStateLocked(I)Lcom/android/server/print/UserState;
...
.method static synthetic access$600(Lcom/android/server/print/PrintManagerService$PrintManagerImpl;Landroid/content/ComponentName;Ljava/lang/String;I)V
    ...
    .prologue
    .line 94
    invoke-direct {p0, p1, p2, p3}, showEnableInstalledPrintServiceNotification(Landroid/content/ComponentName;Ljava/lang/String;I)V
...
.method private showEnableInstalledPrintServiceNotification(Landroid/content/ComponentName;Ljava/lang/String;I)V
    ...
    :try_end_37
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_27 .. :try_end_37} :catch_c6
...
.method public addPrintJobStateChangeListener(Landroid/print/IPrintJobStateChangeListener;II)V
    ...
    .prologue
    .line 403
    invoke-direct {p0, p3}, resolveCallingUserEnforcingPermissions(I)I
    ...
    .line 408
    :try_start_7
    invoke-direct {p0, v3}, resolveCallingProfileParentLocked(I)I
    ...
    .line 411
    :cond_13
    invoke-direct {p0, p2}, resolveCallingAppEnforcingPermissions(I)I

    move-result v2

    .line 412
    .local v2, "resolvedAppId":I
    invoke-direct {p0, v3}, getOrCreateUserStateLocked(I)Lcom/android/server/print/UserState;
...
.method public createPrinterDiscoverySession(Landroid/print/IPrinterDiscoveryObserver;I)V
    ...
    .prologue
    .line 267
    invoke-direct {p0, p2}, resolveCallingUserEnforcingPermissions(I)I
    ...
    .line 271
    :try_start_7
    invoke-direct {p0, v2}, resolveCallingProfileParentLocked(I)I
    ...
    .line 274
    :cond_13
    invoke-direct {p0, v2}, getOrCreateUserStateLocked(I)Lcom/android/server/print/UserState;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {}, Landroid/os/Binder;->clearCallingIdentity()J
    :try_end_39
    .catchall {:try_start_36 .. :try_end_39} :catchall_60
    ...
    :try_end_58
    .catchall {:try_start_3a .. :try_end_58} :catchall_63
    ...
    throw v5
    :try_end_68
    .catchall {:try_start_64 .. :try_end_68} :catchall_60
.end method
...
.method public getEnabledPrintServices(I)Ljava/util/List;
    ...
    .prologue
    .line 228
    invoke-direct {p0, p1}, resolveCallingUserEnforcingPermissions(I)I
...
.method public getPrintJobInfo(Landroid/print/PrintJobId;II)Landroid/print/PrintJobInfo;
    ...
    monitor-exit v6
    :try_end_1d
    .catchall {:try_start_7 .. :try_end_1d} :catchall_29
...
.method public getPrintJobInfos(II)Ljava/util/List;
    ...
    .line 152
    :cond_14
    invoke-direct {p0, p1}, resolveCallingAppEnforcingPermissions(I)I
...
.method public print(Ljava/lang/String;Landroid/print/IPrintDocumentAdapter;Landroid/print/PrintAttributes;Ljava/lang/String;II)Landroid/os/Bundle;
    ...
    .prologue
    .line 120
    invoke-direct {p0, p6}, resolveCallingUserEnforcingPermissions(I)I
    ...
    .line 126
    :try_start_7
    invoke-direct {p0, v8}, resolveCallingProfileParentLocked(I)I
    ...
    .line 129
    :cond_14
    invoke-direct {p0, p5}, resolveCallingAppEnforcingPermissions(I)I

    move-result v5

    .line 130
    .local v5, "resolvedAppId":I
    invoke-direct {p0, p4}, resolveCallingPackageNameEnforcingSecurity(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .line 131
    .local v4, "resolvedPackageName":Ljava/lang/String;
    invoke-direct {p0, v8}, getOrCreateUserStateLocked(I)Lcom/android/server/print/UserState;
