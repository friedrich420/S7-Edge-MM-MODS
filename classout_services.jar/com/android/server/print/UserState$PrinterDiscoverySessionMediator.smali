...
.method public constructor <init>(Lcom/android/server/print/UserState;Landroid/content/Context;)V
    ...
    iput-object v1, p0, mPrinters:Landroid/util/ArrayMap;
    ...
    iput-object v1, p0, mDiscoveryObservers:Landroid/os/RemoteCallbackList;
    ...
    iput-object v1, p0, mStartedPrinterDiscoveryTokens:Ljava/util/List;
    ...
    iput-object v1, p0, mStateTrackedPrinters:Ljava/util/List;
...
.method static synthetic access$1000(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Landroid/print/IPrinterDiscoveryObserver;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1, p2}, handlePrintersRemoved(Landroid/print/IPrinterDiscoveryObserver;Ljava/util/List;)V
...
.method static synthetic access$1100(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1}, handleDispatchPrintersAdded(Ljava/util/List;)V
...
.method static synthetic access$1200(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1}, handleDispatchPrintersRemoved(Ljava/util/List;)V
...
.method static synthetic access$1300(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1}, handleDispatchCreatePrinterDiscoverySession(Ljava/util/List;)V
...
.method static synthetic access$1400(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1}, handleDispatchDestroyPrinterDiscoverySession(Ljava/util/List;)V
...
.method static synthetic access$1500(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Ljava/util/List;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1, p2}, handleDispatchStartPrinterDiscovery(Ljava/util/List;Ljava/util/List;)V
...
.method static synthetic access$1600(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1}, handleDispatchStopPrinterDiscovery(Ljava/util/List;)V
...
.method static synthetic access$1700(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Lcom/android/server/print/RemotePrintService;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1, p2}, handleValidatePrinters(Lcom/android/server/print/RemotePrintService;Ljava/util/List;)V
...
.method static synthetic access$1800(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Lcom/android/server/print/RemotePrintService;Landroid/print/PrinterId;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1, p2}, handleStartPrinterStateTracking(Lcom/android/server/print/RemotePrintService;Landroid/print/PrinterId;)V
...
.method static synthetic access$1900(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Lcom/android/server/print/RemotePrintService;Landroid/print/PrinterId;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1, p2}, handleStopPrinterStateTracking(Lcom/android/server/print/RemotePrintService;Landroid/print/PrinterId;)V
...
.method static synthetic access$900(Lcom/android/server/print/UserState$PrinterDiscoverySessionMediator;Landroid/print/IPrinterDiscoveryObserver;Ljava/util/List;)V
    ...
    .prologue
    .line 950
    invoke-direct {p0, p1, p2}, handlePrintersAdded(Landroid/print/IPrinterDiscoveryObserver;Ljava/util/List;)V
...
.method private handleDispatchDestroyPrinterDiscoverySession(Ljava/util/List;)V
    ...
    .end local v1    # "service":Lcom/android/server/print/RemotePrintService;
    :cond_13
    invoke-virtual {p0}, onDestroyed()V
...
.method private handleDispatchPrintersAdded(Ljava/util/List;)V
    ...
    iget-object v3, p0, mDiscoveryObservers:Landroid/os/RemoteCallbackList;
    ...
    invoke-direct {p0, v1, p1}, handlePrintersAdded(Landroid/print/IPrinterDiscoveryObserver;Ljava/util/List;)V
...
.method private handleDispatchPrintersRemoved(Ljava/util/List;)V
    ...
    .line 1363
    .local v1, "observer":Landroid/print/IPrinterDiscoveryObserver;
    invoke-direct {p0, v1, p1}, handlePrintersRemoved(Landroid/print/IPrinterDiscoveryObserver;Ljava/util/List;)V
...
.method private removePrintersForServiceLocked(Landroid/content/ComponentName;)V
    ...
    .prologue
    .line 1324
    iget-object v5, p0, mPrinters:Landroid/util/ArrayMap;
...
.method public addObserverLocked(Landroid/print/IPrinterDiscoveryObserver;)V
    ...
    .prologue
    .line 985
    iget-object v2, p0, mDiscoveryObservers:Landroid/os/RemoteCallbackList;

    invoke-virtual {v2, p1}, Landroid/os/RemoteCallbackList;->register(Landroid/os/IInterface;)Z

    .line 988
    iget-object v2, p0, mPrinters:Landroid/util/ArrayMap;
...
.method public destroyLocked()V
    ...
    .prologue
    .line 1159
    iget-boolean v6, p0, mIsDestroyed:Z
    ...
    iput-boolean v6, p0, mIsDestroyed:Z

    .line 1165
    iget-object v6, p0, mStateTrackedPrinters:Ljava/util/List;
    ...
    iget-object v6, p0, this$0:Lcom/android/server/print/UserState;
    ...
    :cond_28
    iget-object v6, p0, mStartedPrinterDiscoveryTokens:Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, stopPrinterDiscoveryLocked(Landroid/print/IPrinterDiscoveryObserver;)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-object v10, p0, this$0:Lcom/android/server/print/UserState;
    ...
    const-string/jumbo v10, "printDiscoveryInProgress="

    invoke-virtual {v9, v10}, Ljava/io/PrintWriter;->append(Ljava/lang/CharSequence;)Ljava/io/PrintWriter;

    move-result-object v10

    iget-object v9, p0, mStartedPrinterDiscoveryTokens:Ljava/util/List;
    ...
    const-string/jumbo v10, "printer discovery observers:"
    ...
    .line 1291
    iget-object v9, p0, mDiscoveryObservers:Landroid/os/RemoteCallbackList;
    ...
    .line 1307
    iget-object v9, p0, mStateTrackedPrinters:Ljava/util/List;
    ...
    const-string/jumbo v10, "printers:"
    ...
    .line 1314
    iget-object v9, p0, mPrinters:Landroid/util/ArrayMap;
...
.method public onPrintersAddedLocked(Ljava/util/List;)V
    ...
    iget-boolean v5, p0, mIsDestroyed:Z
...
.method public onPrintersRemovedLocked(Ljava/util/List;)V
    ...
    iget-boolean v4, p0, mIsDestroyed:Z
    ...
    iget-object v4, p0, mPrinters:Landroid/util/ArrayMap;
...
.method public onServiceAddedLocked(Lcom/android/server/print/RemotePrintService;)V
    ...
    .line 1261
    iget-object v4, p0, mStartedPrinterDiscoveryTokens:Ljava/util/List;
    ...
    .line 1267
    :cond_28
    iget-object v4, p0, mStateTrackedPrinters:Ljava/util/List;
...
.method public onServiceDiedLocked(Lcom/android/server/print/RemotePrintService;)V
    ...
    invoke-direct {p0, v0}, removePrintersForServiceLocked(Landroid/content/ComponentName;)V
...
.method public onServiceRemovedLocked(Lcom/android/server/print/RemotePrintService;)V
    ...
    .prologue
    .line 1236
    iget-boolean v1, p0, mIsDestroyed:Z
...
.method public removeObserverLocked(Landroid/print/IPrinterDiscoveryObserver;)V
    ...
    .prologue
    .line 1000
    iget-object v0, p0, mDiscoveryObservers:Landroid/os/RemoteCallbackList;
    ...
    .line 1003
    invoke-virtual {p0}, destroyLocked()V
...
.method public final startPrinterDiscoveryLocked(Landroid/print/IPrinterDiscoveryObserver;Ljava/util/List;)V
    ...
    .line 1022
    iget-object v3, p0, this$0:Lcom/android/server/print/UserState;
...
.method public final startPrinterStateTrackingLocked(Landroid/print/PrinterId;)V
    ...
    .prologue
    .line 1098
    iget-boolean v3, p0, mIsDestroyed:Z
    ...
    .line 1103
    :cond_c
    iget-object v3, p0, mStartedPrinterDiscoveryTokens:Ljava/util/List;
    ...
    .line 1106
    iget-object v3, p0, mStateTrackedPrinters:Ljava/util/List;
...
.method public final stopPrinterDiscoveryLocked(Landroid/print/IPrinterDiscoveryObserver;)V
    ...
    .line 1047
    :cond_c
    iget-object v1, p0, mStartedPrinterDiscoveryTokens:Ljava/util/List;
    ...
    iget-object v1, p0, this$0:Lcom/android/server/print/UserState;
...
.method public final stopPrinterStateTrackingLocked(Landroid/print/PrinterId;)V
    ...
    .prologue
    .line 1128
    iget-boolean v2, p0, mIsDestroyed:Z
    ...
    .line 1133
    :cond_c
    iget-object v2, p0, mStartedPrinterDiscoveryTokens:Ljava/util/List;
    ...
    .line 1137
    iget-object v2, p0, mStateTrackedPrinters:Ljava/util/List;
    ...
    .line 1141
    iget-object v2, p0, this$0:Lcom/android/server/print/UserState;
...
.method public validatePrintersLocked(Ljava/util/List;)V
    ...
    .line 1062
    .local p1, "printerIds":Ljava/util/List;, "Ljava/util/List<Landroid/print/PrinterId;>;"
    iget-boolean v7, p0, mIsDestroyed:Z
    ...
    .end local v2    # "printerId":Landroid/print/PrinterId;
    :cond_4f
    iget-object v7, p0, this$0:Lcom/android/server/print/UserState;
