...
.method static constructor <clinit>()V
    ...
    sput-object v0, GOOGLE_SEARCH_COMPONENT_NAME:Ljava/lang/String;

    .line 74
    const-string v0, "com.google.android.providers.enhancedgooglesearch/.Launcher"

    sput-object v0, ENHANCED_GOOGLE_SEARCH_COMPONENT_NAME:Ljava/lang/String;
    ...
    sput-object v0, GLOBAL_SEARCH_RANKER:Ljava/util/Comparator;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 61
    iput-object v0, p0, mSearchablesMap:Ljava/util/HashMap;

    .line 62
    iput-object v0, p0, mSearchablesList:Ljava/util/ArrayList;

    .line 63
    iput-object v0, p0, mSearchablesInGlobalSearchList:Ljava/util/ArrayList;

    .line 65
    iput-object v0, p0, mSearchablesInInsightSearchList:Ljava/util/ArrayList;

    .line 69
    iput-object v0, p0, mCurrentGlobalSearchActivity:Landroid/content/ComponentName;

    .line 70
    iput-object v0, p0, mWebSearchActivity:Landroid/content/ComponentName;
...
.method static synthetic access$000(Landroid/content/pm/ResolveInfo;)Z
    ...
    .prologue
    .line 49
    invoke-static {p0}, isSystemApp(Landroid/content/pm/ResolveInfo;)Z
...
.method private findGlobalSearchActivities()Ljava/util/List;
    ...
    invoke-direct {p0, v1, v2}, queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
    ...
    .line 309
    sget-object v2, GLOBAL_SEARCH_RANKER:Ljava/util/Comparator;
...
.method private findGlobalSearchActivity(Ljava/util/List;)Landroid/content/ComponentName;
    ...
    invoke-direct {p0}, getGlobalSearchProviderSetting()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, isInstalled(Landroid/content/ComponentName;)Z
    ...
    :cond_17
    invoke-direct {p0, p1}, getDefaultGlobalSearchProvider(Ljava/util/List;)Landroid/content/ComponentName;
...
.method private findWebSearchActivity(Landroid/content/ComponentName;)Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v2, v4}, queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
...
.method public buildSearchableList()V
    ...
    invoke-direct {v0, v13, v1}, queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
    ...
    invoke-direct {v0, v1, v2}, queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
    ...
    invoke-direct {v0, v11, v1}, queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
    ...
    .local v8, "ii":I
    :goto_8a
    if-ge v8, v5, :cond_155

    .line 247
    move/from16 v0, v25

    if-ge v8, v0, :cond_101
    ...
    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    :try_end_14f
    .catchall {:try_start_23 .. :try_end_14f} :catchall_150
    ...
    :cond_155
    :try_start_155
    invoke-direct/range {p0 .. p0}, findGlobalSearchActivities()Ljava/util/List;
    ...
    invoke-direct {v0, v14}, findGlobalSearchActivity(Ljava/util/List;)Landroid/content/ComponentName;
    ...
    invoke-direct {v0, v15}, findWebSearchActivity(Landroid/content/ComponentName;)Landroid/content/ComponentName;
    ...
    monitor-enter p0
    :try_end_166
    .catchall {:try_start_155 .. :try_end_166} :catchall_150
    ...
    iput-object v0, v1, mSearchablesMap:Ljava/util/HashMap;
    ...
    iput-object v0, v1, mSearchablesList:Ljava/util/ArrayList;
    ...
    iput-object v0, v1, mSearchablesInGlobalSearchList:Ljava/util/ArrayList;
    ...
    iput-object v0, v1, mSearchablesInInsightSearchList:Ljava/util/ArrayList;

    .line 284
    move-object/from16 v0, p0

    iput-object v14, v0, mGlobalSearchActivities:Ljava/util/List;

    .line 285
    move-object/from16 v0, p0

    iput-object v15, v0, mCurrentGlobalSearchActivity:Landroid/content/ComponentName;
    ...
    iput-object v0, v1, mWebSearchActivity:Landroid/content/ComponentName;

    .line 287
    monitor-exit p0
    :try_end_18d
    .catchall {:try_start_166 .. :try_end_18d} :catchall_191
    ...
    throw v30
    :try_end_194
    .catchall {:try_start_193 .. :try_end_194} :catchall_150
.end method
...
.method dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 490
    :try_start_6
    iget-object v2, p0, mSearchablesList:Ljava/util/ArrayList;
...
.method public declared-synchronized getGlobalSearchActivities()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mGlobalSearchActivities:Ljava/util/List;
...
.method public declared-synchronized getGlobalSearchActivity()Landroid/content/ComponentName;
    ...
    :try_start_1
    iget-object v0, p0, mCurrentGlobalSearchActivity:Landroid/content/ComponentName;
    :try_end_3
...
.method public getSearchableInfo(Landroid/content/ComponentName;)Landroid/app/SearchableInfo;
    ...
    .line 123
    :try_start_2
    iget-object v8, p0, mSearchablesMap:Ljava/util/HashMap;
...
.method public declared-synchronized getSearchablesInGlobalSearchList()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mSearchablesInGlobalSearchList:Ljava/util/ArrayList;
...
.method public declared-synchronized getSearchablesInInsightSearchList(Z)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mSearchablesInInsightSearchList:Ljava/util/ArrayList;
...
.method public declared-synchronized getSearchablesList()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, mSearchablesList:Ljava/util/ArrayList;
...
.method public declared-synchronized getWebSearchActivity()Landroid/content/ComponentName;
    ...
    :try_start_1
    iget-object v0, p0, mWebSearchActivity:Landroid/content/ComponentName;
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_5
