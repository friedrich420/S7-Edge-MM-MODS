...
.method private constructor <init>(Lcom/android/server/twilight/TwilightService;)V
    ...
    .prologue
    .line 181
    iput-object p1, p0, this$0:Lcom/android/server/twilight/TwilightService;
    ...
    iput-wide v0, p0, mLastNetworkRegisterTime:J
    ...
    iput-object v0, p0, mTwilightCalculator:Lcom/android/server/TwilightCalculator;
...
.method synthetic constructor <init>(Lcom/android/server/twilight/TwilightService;Lcom/android/server/twilight/TwilightService$1;)V
    ...
    .prologue
    .line 181
    invoke-direct {p0, p1}, <init>(Lcom/android/server/twilight/TwilightService;)V
...
.method private retrieveLocation()V
    ...
    iget-object v6, p0, this$0:Lcom/android/server/twilight/TwilightService;
    ...
    :cond_7e
    invoke-direct {p0, v4}, setLocation(Landroid/location/Location;)V
...
.method private setLocation(Landroid/location/Location;)V
    ...
    .line 360
    invoke-direct {p0}, updateTwilightState()V
...
.method private updateTwilightState()V
    ...
    iget-object v3, v0, mLocation:Landroid/location/Location;
    ...
    iget-object v3, v0, this$0:Lcom/android/server/twilight/TwilightService;
    ...
    iget-object v3, v0, mTwilightCalculator:Lcom/android/server/TwilightCalculator;
    ...
    iget-object v6, v0, mLocation:Landroid/location/Location;
    ...
    iget-object v8, v0, mLocation:Landroid/location/Location;
    ...
    iget-object v4, v0, mLocation:Landroid/location/Location;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, p0, mLocation:Landroid/location/Location;
    ...
    .line 235
    :cond_27
    invoke-direct {p0, v9}, setLocation(Landroid/location/Location;)V
    ...
    :pswitch_2d
    iget-boolean v0, p0, mNetworkListenerEnabled:Z

    if-eqz v0, :cond_5

    .line 246
    iget-wide v0, p0, mLastNetworkRegisterTime:J
    ...
    iput-boolean v0, p0, mNetworkListenerEnabled:Z

    .line 256
    iget-object v0, p0, this$0:Lcom/android/server/twilight/TwilightService;

    iget-object v0, v0, Lcom/android/server/twilight/TwilightService;->mLocationManager:Landroid/location/LocationManager;

    iget-object v1, p0, this$0:Lcom/android/server/twilight/TwilightService;
    ...
    :try_end_59
    .catch Ljava/lang/Exception; {:try_start_4f .. :try_end_59} :catch_d9
    ...
    iget-object v5, p0, this$0:Lcom/android/server/twilight/TwilightService;
    ...
    .line 277
    iget-boolean v0, p0, mDidFirstInit:Z
    ...
    iput-boolean v0, p0, mDidFirstInit:Z
    ...
    .line 280
    invoke-direct {p0}, retrieveLocation()V
    ...
    invoke-virtual {v0, v1}, Landroid/location/LocationManager;->isProviderEnabled(Ljava/lang/String;)Z
    :try_end_95
    .catch Ljava/lang/Exception; {:try_start_8b .. :try_end_95} :catch_dd
    ...
    :goto_96
    iget-boolean v0, p0, mPassiveListenerEnabled:Z
    ...
    iput-boolean v0, p0, mPassiveListenerEnabled:Z
    ...
    .line 304
    :cond_bc
    iget-wide v0, p0, mLastUpdateInterval:J
    ...
    iput-wide v0, p0, mLastUpdateInterval:J
    ...
    iget-wide v2, p0, mLastUpdateInterval:J
...
.method public processNewLocation(Landroid/location/Location;)V
    ...
    invoke-virtual {p0, v1, p1}, obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
