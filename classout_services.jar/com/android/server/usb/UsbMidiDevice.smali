...
.method private constructor <init>(III)V
    ...
    iput-object v2, p0, mCallback:Landroid/media/midi/MidiDeviceServer$Callback;

    .line 150
    iput p1, p0, mAlsaCard:I

    .line 151
    iput p2, p0, mAlsaDevice:I

    .line 152
    iput p3, p0, mSubdeviceCount:I
    ...
    iput-object v2, p0, mInputPortReceivers:[Lcom/android/server/usb/UsbMidiDevice$InputReceiverProxy;
    ...
    .line 158
    iget-object v2, p0, mInputPortReceivers:[Lcom/android/server/usb/UsbMidiDevice$InputReceiverProxy;
...
.method static synthetic access$300(Lcom/android/server/usb/UsbMidiDevice;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0}, closeLocked()V
...
.method static synthetic access$500(Lcom/android/server/usb/UsbMidiDevice;)[Landroid/system/StructPollfd;
    ...
    .prologue
    .line 44
    iget-object v0, p0, mPollFDs:[Landroid/system/StructPollfd;
...
.method static synthetic access$600(Lcom/android/server/usb/UsbMidiDevice;)[Ljava/io/FileInputStream;
    ...
    .prologue
    .line 44
    iget-object v0, p0, mInputStreams:[Ljava/io/FileInputStream;
...
.method private closeLocked()V
    ...
    .local v0, "i":I
    :goto_2
    iget-object v1, p0, mEventSchedulers:[Lcom/android/internal/midi/MidiEventScheduler;
    ...
    .line 311
    iget-object v1, p0, mInputPortReceivers:[Lcom/android/server/usb/UsbMidiDevice$InputReceiverProxy;
    ...
    .line 314
    :cond_18
    iput-object v2, p0, mEventSchedulers:[Lcom/android/internal/midi/MidiEventScheduler;

    .line 316
    const/4 v0, 0x0

    :goto_1b
    iget-object v1, p0, mInputStreams:[Ljava/io/FileInputStream;
    ...
    .line 319
    :cond_2a
    iput-object v2, p0, mInputStreams:[Ljava/io/FileInputStream;

    .line 321
    const/4 v0, 0x0

    :goto_2d
    iget-object v1, p0, mOutputStreams:[Ljava/io/FileOutputStream;
    ...
    .line 324
    :cond_3c
    iput-object v2, p0, mOutputStreams:[Ljava/io/FileOutputStream;

    .line 327
    iget-object v1, p0, mFileDescriptors:[Ljava/io/FileDescriptor;

    invoke-direct {p0, v1}, nativeClose([Ljava/io/FileDescriptor;)V

    .line 328
    iput-object v2, p0, mFileDescriptors:[Ljava/io/FileDescriptor;
...
.method public static create(Landroid/content/Context;Landroid/os/Bundle;II)Lcom/android/server/usb/UsbMidiDevice;
    ...
    .line 134
    invoke-static {p2, p3}, nativeGetSubdeviceCount(II)I
    ...
    const-string/jumbo v4, "nativeGetSubdeviceCount failed"
    ...
    invoke-direct {v0, p2, p3, v1}, <init>(III)V

    .line 141
    .local v0, "midiDevice":Lcom/android/server/usb/UsbMidiDevice;
    invoke-direct {v0, p0, p1}, register(Landroid/content/Context;Landroid/os/Bundle;)Z
    ...
    const-string/jumbo v4, "createDeviceServer failed"
...
.method private openLocked()Z
    ...
    .prologue
    .line 164
    iget v0, p0, mAlsaCard:I

    iget v1, p0, mAlsaDevice:I

    iget v2, p0, mSubdeviceCount:I

    invoke-direct {p0, v0, v1, v2}, nativeOpen(III)[Ljava/io/FileDescriptor;
    ...
    .line 170
    :cond_16
    iput-object v7, p0, mFileDescriptors:[Ljava/io/FileDescriptor;
    ...
    iput-object v0, p0, mPollFDs:[Landroid/system/StructPollfd;

    .line 177
    new-array v0, v9, [Ljava/io/FileInputStream;

    iput-object v0, p0, mInputStreams:[Ljava/io/FileInputStream;
    ...
    iput-object v0, p0, mOutputStreams:[Ljava/io/FileOutputStream;

    .line 188
    new-array v0, v10, [Lcom/android/internal/midi/MidiEventScheduler;

    iput-object v0, p0, mEventSchedulers:[Lcom/android/internal/midi/MidiEventScheduler;
    ...
    .line 190
    iget-object v0, p0, mOutputStreams:[Ljava/io/FileOutputStream;
    ...
    iget-object v0, p0, mEventSchedulers:[Lcom/android/internal/midi/MidiEventScheduler;

    aput-object v14, v0, v8

    .line 194
    iget-object v0, p0, mInputPortReceivers:[Lcom/android/server/usb/UsbMidiDevice$InputReceiverProxy;
    ...
    :cond_72
    iget-object v0, p0, mServer:Landroid/media/midi/MidiDeviceServer;
...
.method private register(Landroid/content/Context;Landroid/os/Bundle;)Z
    ...
    iget-object v7, p0, mCallback:Landroid/media/midi/MidiDeviceServer$Callback;
    ...
    iput-object v1, p0, mServer:Landroid/media/midi/MidiDeviceServer;

    .line 289
    iget-object v1, p0, mServer:Landroid/media/midi/MidiDeviceServer;
