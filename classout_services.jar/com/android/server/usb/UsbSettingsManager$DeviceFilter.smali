...
.method public constructor <init>(IIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 159
    iput p4, p0, mSubclass:I

    .line 160
    iput p5, p0, mProtocol:I

    .line 161
    iput-object p6, p0, mManufacturerName:Ljava/lang/String;

    .line 162
    iput-object p7, p0, mProductName:Ljava/lang/String;

    .line 163
    iput-object p8, p0, mSerialNumber:Ljava/lang/String;
...
.method public constructor <init>(Landroid/hardware/usb/UsbDevice;)V
    ...
    iput-object v0, p0, mManufacturerName:Ljava/lang/String;
    ...
    iput-object v0, p0, mSerialNumber:Ljava/lang/String;
...
.method public static read(Lorg/xmlpull/v1/XmlPullParser;)Lcom/android/server/usb/UsbSettingsManager$DeviceFilter;
    ...
    invoke-direct/range {v1 .. v9}, <init>(IIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v4, p0, mSubclass:I

    if-eq v4, v5, :cond_17

    iget v4, p0, mProtocol:I
    ...
    iget v4, v1, mVendorId:I

    iget v5, p0, mVendorId:I

    if-ne v4, v5, :cond_3e

    iget v4, v1, mProductId:I

    iget v5, p0, mProductId:I
    ...
    iget v4, v1, mSubclass:I

    iget v5, p0, mSubclass:I

    if-ne v4, v5, :cond_3e

    iget v4, v1, mProtocol:I

    iget v5, p0, mProtocol:I
    ...
    .line 329
    :cond_40
    iget-object v4, v1, mManufacturerName:Ljava/lang/String;

    if-eqz v4, :cond_48

    iget-object v4, p0, mManufacturerName:Ljava/lang/String;
    ...
    :cond_50
    iget-object v4, v1, mProductName:Ljava/lang/String;

    if-eqz v4, :cond_58

    iget-object v4, p0, mProductName:Ljava/lang/String;
    ...
    :cond_60
    iget-object v4, v1, mSerialNumber:Ljava/lang/String;

    if-eqz v4, :cond_68

    iget-object v4, p0, mSerialNumber:Ljava/lang/String;
    ...
    iget-object v5, v1, mManufacturerName:Ljava/lang/String;
    ...
    iget-object v5, v1, mProductName:Ljava/lang/String;
    ...
    iget-object v5, v1, mSerialNumber:Ljava/lang/String;
...
.method public hashCode()I
    ...
    iget v2, p0, mSubclass:I

    shl-int/lit8 v2, v2, 0x8

    or-int/2addr v1, v2

    iget v2, p0, mProtocol:I
...
.method public matches(Landroid/hardware/usb/UsbDevice;)Z
    ...
    iget v6, p0, mProductId:I

    if-ne v5, v6, :cond_f

    .line 270
    :cond_1c
    iget-object v5, p0, mManufacturerName:Ljava/lang/String;
    ...
    .line 271
    :cond_26
    iget-object v5, p0, mProductName:Ljava/lang/String;
    ...
    .line 272
    :cond_30
    iget-object v5, p0, mSerialNumber:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v6, v7}, matches(III)Z
...
.method public matches(Lcom/android/server/usb/UsbSettingsManager$DeviceFilter;)Z
    ...
    .line 296
    iget v1, p0, mVendorId:I

    if-eq v1, v3, :cond_d

    iget v1, p1, mVendorId:I

    iget v2, p0, mVendorId:I
    ...
    iget v1, p1, mProductId:I

    iget v2, p0, mProductId:I

    if-ne v1, v2, :cond_c

    .line 298
    :cond_17
    iget-object v1, p1, mManufacturerName:Ljava/lang/String;

    if-eqz v1, :cond_1f

    iget-object v1, p0, mManufacturerName:Ljava/lang/String;

    if-eqz v1, :cond_c

    .line 299
    :cond_1f
    iget-object v1, p1, mProductName:Ljava/lang/String;

    if-eqz v1, :cond_27

    iget-object v1, p0, mProductName:Ljava/lang/String;

    if-eqz v1, :cond_c

    .line 300
    :cond_27
    iget-object v1, p1, mSerialNumber:Ljava/lang/String;

    if-eqz v1, :cond_2f

    iget-object v1, p0, mSerialNumber:Ljava/lang/String;
    ...
    iget-object v2, p1, mManufacturerName:Ljava/lang/String;
    ...
    iget-object v2, p1, mProductName:Ljava/lang/String;
    ...
    iget-object v2, p1, mSerialNumber:Ljava/lang/String;
    ...
    iget v1, p1, mSubclass:I

    iget v2, p1, mProtocol:I

    invoke-direct {p0, v0, v1, v2}, matches(III)Z
...
.method public write(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    .line 249
    :cond_57
    iget-object v0, p0, mManufacturerName:Ljava/lang/String;
    ...
    .line 252
    :cond_63
    iget-object v0, p0, mProductName:Ljava/lang/String;
    ...
    .line 255
    :cond_6f
    iget-object v0, p0, mSerialNumber:Ljava/lang/String;
