...
.method constructor <init>([Lcom/android/server/wm/WindowManagerService;Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZ)V
    ...
    .prologue
    .line 1605
    iput-object p1, p0, val$holder:[Lcom/android/server/wm/WindowManagerService;

    iput-object p2, p0, val$context:Landroid/content/Context;

    iput-object p3, p0, val$im:Lcom/android/server/input/InputManagerService;

    iput-boolean p4, p0, val$haveInputMethods:Z

    iput-boolean p5, p0, val$showBootMsgs:Z

    iput-boolean p6, p0, val$onlyCore:Z
...
.method public run()V
    ...
    .prologue
    .line 1608
    iget-object v7, p0, val$holder:[Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v2, p0, val$im:Lcom/android/server/input/InputManagerService;

    iget-boolean v3, p0, val$haveInputMethods:Z

    iget-boolean v4, p0, val$showBootMsgs:Z

    iget-boolean v5, p0, val$onlyCore:Z
