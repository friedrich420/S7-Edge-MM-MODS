...
.method private checkIfShortcutExist(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v1, v2}, getIntentForShortcut(Ljava/lang/String;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :try_end_60
    .catch Ljava/lang/IllegalStateException; {:try_start_39 .. :try_end_60} :catch_61
    ...
    const-string/jumbo v6, "cursor for package: "
    ...
    invoke-static {v5}, Lcom/samsung/appdisabler/Utils;->LogW(Ljava/lang/String;)V
    :try_end_87
    .catch Ljava/lang/IllegalStateException; {:try_start_68 .. :try_end_87} :catch_61
...
.method public addShortcut(Ljava/lang/String;)V
    ...
    .line 50
    :cond_13
    invoke-direct {p0, p1}, checkIfShortcutExist(Ljava/lang/String;)Z
    ...
    :try_end_3b
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_38 .. :try_end_3b} :catch_80
    ...
    invoke-direct {p0, p1, v7}, getIntentForShortcut(Ljava/lang/String;Landroid/content/Intent;)Ljava/lang/String;
    ...
    const-string/jumbo v9, "icon not found for: "
    ...
    .restart local v3    # "icon":Landroid/graphics/drawable/Drawable;
    :cond_a9
    const-string/jumbo v8, "make bitmap"
...
.method public uninstallShort(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v1}, getIntentForShortcut(Ljava/lang/String;Landroid/content/Intent;)Ljava/lang/String;
